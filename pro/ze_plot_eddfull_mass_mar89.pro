...
vcrit1_v2=SQRT(0.0000000667*mass*1.989E+33/(r_at_v2*6.96*10000000000.))/100000. ;ignoring departures from spherical symmetry (MM2000,A&A361,159)
...
b=6.48
sun = '!D!9n!3!N'
device,filename='/Users/jgroh/temp/output_gammafull_mass_mar89.eps',/encapsulated,/color,bit=8,xsize=a,ysize=b,/inches
...
;xrange=[10^1.55,10^2.25],yrange=[10^1.6000/10.,10^2.4000/10.],xtickformat='(A1)',$
;ytitle=TEXTOIDL('T!deff!N [10!U4!N K]'),/nodata,charsize=cs,XMARGIN=[10,5],YMARGIN=[1.0,0.5];,POSITION=[0.11,0.10,0.959,0.49]
;plots,mass,teff/10.^4,color=fsc_color('black'),noclip=0,psym=2
;;oploterror,alog10(mass),teff/10.^4,errteff/10.^4,psym=2,color=fsc_color('black'),ERRCOLOR=fsc_color('black')
;
;plot,mass,gammafull,xstyle=1,ystyle=1,charthick=ct,$
;xrange=[10^1.55,10^2.25],yrange=[10^(-0.7),10^0.08],xtickformat='(A1)',$
;ytitle=TEXTOIDL('\Gamma '),/nodata,charsize=cs,XMARGIN=[10,5],YMARGIN=[1.5,-1.0];,POSITION=[0.11,0.10,0.959,0.49]
;plots,mass,gammafull,color=fsc_color('black'),noclip=0,psym=2,thick=ct
;plots,xfit,10^yfit2,color=fsc_color('black'),noclip=0,linestyle=2,thick=ct
;;plotting gamma propto M^-1 line 
;;plots,alog10(xfit),result[0]+1.008+alog10(xfit)*minus1,color=fsc_color('white'),noclip=0,thick=1,linestyle=3
...
;plots,xfit2,10^yfit4,color=fsc_color('black'),noclip=0,thick=ct,linestyle=3
;xyouts,10^1.65,-0.5,'1985-1990', charsize=1.7,charthick=ct
;xyouts,10^2.05,-0.17,TEXTOIDL('\Gamma \propto M^{-0.37 \pm 0.02}'), charsize=1.5,charthick=ct
;xyouts,10^2.05,-0.43,TEXTOIDL('\Gamma \propto M^{-0.96 \pm 0.09}'), charsize=1.5,charthick=ct
;
;plot,mass,omegagamma,xstyle=1,ystyle=1,ylog=1,xlog=1,xtitle=TEXTOIDL('log (M/M')+sun+')',charthick=ct,$
;xrange=[10^1.55,10^2.25],yrange=[10^(-0.7),10^0.08],$
;ytitle=TEXTOIDL('\Omega\Gamma '),/nodata,charsize=cs,XMARGIN=[10,5],YMARGIN=[3.5,-1.5]
;plots,mass,omegagamma,color=fsc_color('black'),noclip=0,psym=5,thick=ct
;for i=2, 4 do begin 
;plots,mass[i],omegagammavel2[i],color=fsc_color('black'),noclip=0,psym=6,thick=ct
;endfor
;;plotting up arrows for gammaomega > 1.
;plots,[alog10(mass[0])-0.005,alog10(mass[0])+0.005],[0.0,0.0],linestyle=0
;plotsym,2,thick=ct

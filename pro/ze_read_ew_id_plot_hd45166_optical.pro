...
ewdata='/home/groh/ze_models/HD45166/106_copy/ewdata_fin_106copy'  
...
if (lambdac[l] gt 3070) and (lambdac[l] lt 8890) and (abs(ew[l]) gt 0.1) then begin
pos=strpos(strtrim(sob[l],1),'(')
sobc[l]=strmid(sob[l],2,pos+2)
if ((sobc[l] ne '  FeV') && (sobc[l] ne '  FeVI')) then begin ;
;print,l,lambdac[l],ew[l],sob[l]
endif
if (sobc[l] eq '  OIV') then begin
print,l,lambdac[l],ew[l];,sob[l]
endif
;print,l,lambdac[l],ew[l];,sob[l]
endif
...
;;making psplots
;set_plot,'ps'
;device,filename='/home/groh/espectros/hd45166/output_opt.eps',/encapsulated,/color,bit=8,xsize=6.48,ysize=8.48,/inches
;!p.multi=[0, 1, 3, 0, 0]
;

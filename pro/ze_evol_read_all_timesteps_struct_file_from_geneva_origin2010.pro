PRO ZE_EVOL_READ_ALL_TIMESTEPS_STRUCT_FILE_FROM_GENEVA_ORIGIN2010,modelstr,timesteps_available,$     
...
;this version does not save array_data_struct_file
;array_data_struct_file=dblarr(ncolumns_all,nbshell_all,ntimesteps)
array_nbshell=dblarr(ntimesteps)
...
array_logptot=dblarr(nbshell_all,ntimesteps)
...
array_nabla_ad=dblarr(nbshell_all,ntimesteps)
...
array_logprad=dblarr(nbshell_all,ntimesteps)
array_logpgas=dblarr(nbshell_all,ntimesteps)
array_prad_over_ptot=dblarr(nbshell_all,ntimesteps)
array_pgas_over_ptot=dblarr(nbshell_all,ntimesteps)
array_logpturb=dblarr(nbshell_all,ntimesteps)
array_ledd=dblarr(nbshell_all,ntimesteps)
array_gammafull_rad=dblarr(nbshell_all,ntimesteps)
array_gammafull_tot=dblarr(nbshell_all,ntimesteps)
array_nablarad=dblarr(nbshell_all,ntimesteps)
array_ebind=dblarr(nbshell_all,ntimesteps)
array_Mstar=dblarr(nbshell_all,ntimesteps)
array_Mext=dblarr(nbshell_all,ntimesteps)
...
for i=0, n_elements(timesteps_available) -1d0 DO BEGIN
  ...
  print,struct_file
  ZE_EVOL_READ_STRUCT_FILE_FROM_GENEVA_ORIGIN2010,modeldir,modelstr,timestep,data_struct_file,header_struct_file,modnb,age,mtot,nbshell,deltat,ncolumns,/compress
  ...
  ZE_EVOL_OBTAIN_VARIABLE_FROM_STRUCT_FILE,'logP',data_struct_file,logptot,index_varnamex_struct_file,return_valx
...
;array_data_struct_file[0:ncolumns-1,0:nbshell-1,i]=data_struct_file
array_nbshell[i]=nbshell
...
array_logptot[0:nbshell-1,i]=logptot
...
;remove 0s at the end corresponding to shells that do not exist in all models
shellmax=MAX(array_nbshell)
print,shellmax

;array_data_struct_file=array_data_struct_file[*,0:shellmax-1,*]
array_n=array_n[0:shellmax-1,*]
array_logr=array_logr[0:shellmax-1,*]
array_Mint=array_Mint[0:shellmax-1,*]
array_logT=array_logT[0:shellmax-1,*]
array_logrho=array_logrho[0:shellmax-1,*]
array_logptot=array_logptot[0:shellmax-1,*]
array_cv=array_cv[0:shellmax-1,*]
array_dlnP_over_dlnrho_T=array_dlnP_over_dlnrho_T[0:shellmax-1,*]
array_nabla_e=array_nabla_e[0:shellmax-1,*]
array_nabla_ad=array_nabla_ad[0:shellmax-1,*]
array_Lrad=array_lrad[0:shellmax-1,*]
array_ltot=array_ltot[0:shellmax-1,*]
array_logkappa=array_logkappa[0:shellmax-1,*]
array_X_H1=array_x_h1[0:shellmax-1,*]
array_X_He4=array_x_he4[0:shellmax-1,*]
array_mu=array_mu[0:shellmax-1,*]
array_epsilon=array_epsilon[0:shellmax-1,*]
array_logprad=array_logprad[0:shellmax-1,*]
array_logpgas=array_logpgas[0:shellmax-1,*]
array_prad_over_ptot=array_prad_over_ptot[0:shellmax-1,*]
array_pgas_over_ptot=array_pgas_over_ptot[0:shellmax-1,*]
array_logpturb=array_logpturb[0:shellmax-1,*]
array_ledd=array_ledd[0:shellmax-1,*]
array_gammafull_rad=array_gammafull_rad[0:shellmax-1,*]
array_gammafull_tot=array_gammafull_tot[0:shellmax-1,*]
array_nablarad=array_nablarad[0:shellmax-1,*]
IF N_elements(ebind) GT 2 THEN array_ebind=array_ebind[0:shellmax-1,*]
array_Mstar=array_Mstar[0:shellmax-1,*]
array_Mext=array_Mext[0:shellmax-1,*]
undefine,data_struct_file

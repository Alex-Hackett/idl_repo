...
pro line_norm_event,event
	...
	'WRITE': begin
		...
		'Write.Postscript File': begin
			...
			oplot,xnorm,fnorm,color=fsc_color('red'),thick=2
			oplot,xn,yn,color=fsc_color('green'),symsize=1,psym=2,thick=2
			device,/close
...
;;		 '-adobe-helvetica-bold-r-normal--14-140-75-75-p-82-iso8859-1'
	...
	exit = widget_button(menu,value='EXIT',uvalue='EXIT',ACCELERATOR = 'Ctrl+1')

...
;factor=0.54 ;40   ;factor to zoom out of the image              ;BEST for ETA Car image is factor=0.54 for p=p-21, pix=1027 (DO NOT CHANGE THAT! INTENSIVE TESTS WERE MADE!)
factor=8.2;                                                      ;BEST for ETA Car vis is factor=8.2 for p=p-21, pix=1027 (DO NOT CHANGE THAT! INTENSIVE TESTS WERE MADE!)
pix=1027.
...
!P.Color = fsc_color('black')
IF KEYWORD_SET(vel) THEN BEGIN
title='Visibility at velocity '+vel_str+' km s!E-1!N, i=41!Eo!N, PA='+pa_str+'!Eo '
ENDIF ELSE BEGIN
title='Visibility at wavelength '+lambda_str+' Angstrom, i=41!Eo!N, PA='+pa_str+'!Eo '
ENDELSE
...
IF KEYWORD_SET(vel) THEN BEGIN
title='Phase at velocity '+vel_str+' km s!E-1!N, i=41!Eo!N, PA='+pa_str+'!Eo '
ENDIF ELSE BEGIN
title='Phase at wavelength '+lambda_str+' Angstrom, i=41!Eo!N, PA='+pa_str+'!Eo '
ENDELSE
...
!P.Color = fsc_color('black')
IF KEYWORD_SET(vel) THEN BEGIN
title='Visibility at velocity '+vel_str+' km s!E-1!N, i=0!Eo!N, PA='+pa_str+'!Eo '
ENDIF ELSE BEGIN
title='Visibility at wavelength '+lambda_str+' Angstrom, i=0!Eo!N, PA='+pa_str+'!Eo '
ENDELSE
...
IF KEYWORD_SET(vel) THEN BEGIN
title='Phase at velocity '+vel_str+' km s!E-1!N, i=0!Eo!N, PA='+pa_str+'!Eo '
ENDIF ELSE BEGIN
title='Phase at wavelength '+lambda_str+' Angstrom, i=0!Eo!N, PA='+pa_str+'!Eo '
ENDELSE
...
;filename_ipdata_txt='/Users/jgroh/ze_models/2D_models/etacar/mod111_john/b/OBS_DELTA_IP_DATA'             ;has the flux data (i.e. I(p)p^2
...
pa=53.          ;position angle in degrees; by definition PA=0 towards N, and increase eastwards.
;pa=227
...
lambda_fin=21750    ;initial lambda to do calculations 21720
;filterwidth=200 ;in Angstroms
;lambda_ini=lambda0-filterwidth/2
;lambda_fin=lambda0+filterwidth/2

lambda_sampling=5.5     ;sampling in Angstrom ; use 1
...
specfile='/Users/jgroh/espectros/etacar/etacar_john_mod111_full_flam.txt'
...
;;img = PSF_GAUSSIAN( Npixel=1027, FWHM=[5,5], /NORMAL,/DOUBLE )
...
filename='/Users/jgroh/data/amber/Etacar_P74/BRG/AVG/EtaCar.MR.04-12.BrG.AVG.CP'
...
filename='/Users/jgroh/data/amber/Etacar_P74/BRG/AVG/EtaCar.MR.04-12.BrG.AVG.VIS.BL12'
ZE_READ_AMBER_DATA_FROM_DRIEBE,filename,data=vis12_2004dec26
filename='/Users/jgroh/data/amber/Etacar_P74/BRG/AVG/EtaCar.MR.04-12.BrG.AVG.VIS.BL23'
ZE_READ_AMBER_DATA_FROM_DRIEBE,filename,data=vis23_2004dec26
filename='/Users/jgroh/data/amber/Etacar_P74/BRG/AVG/EtaCar.MR.04-12.BrG.AVG.VIS.BL31'
ZE_READ_AMBER_DATA_FROM_DRIEBE,filename,data=vis31_2004dec26
...
plot,lambda_vector,vis_triplet_wavelength_cnvl[0,*],noclip=0
plots,lambda_vector,vis_triplet_wavelength_cnvl[1,*],noclip=0
plots,lambda_vector,vis_triplet_wavelength_cnvl[2,*],noclip=0
;plots,vis12_2004dec26.field1[2,*]*10000.,vis12_2004dec26.field1[3,*],color=FSC_COLOR('red'),noclip=0
;plots,vis23_2004dec26.field1[2,*]*10000.,vis23_2004dec26.field1[3,*],color=FSC_COLOR('green'),noclip=0
;plots,vis31_2004dec26.field1[2,*]*10000.,vis31_2004dec26.field1[3,*],color=FSC_COLOR('blue'),noclip=0
...
;keywords.filename='/Users/jgroh/temp/img_truecolor.eps'
;
;set_plot,'ps'

;PRO ZE_ETACAR_CMFGEN_MODEL_CUT_JOHN_COMPARE_MODELS_DENSITY_CONTRAST_CAVITY_DP1_NOWALL
close,/all
...
model2='cut_v4_var_DP1_nowall'  
sufix2='3d2em3'
extra_label2=TEXTOIDL(',b=3.2e^{-3}')
filename2='OBSFRAME1'
...
model3='cut_v4_var_DP1_nowall'   ;b,c,o,r,t,u,v don't cover the UV range
sufix3='1e0'
extra_label3=TEXTOIDL(',b=1.0e^{0}')
filename3='OBSFRAME1'
...
device,filename='/Users/jgroh/temp/etc_cmfgen_mod111_plus_cavity_compare_models_uv_'+model1+'_'+sufix1+'_'+filename1+'_i'+inc_str1+model2+'_'+sufix2+'_'+filename2+'_i'+inc_str2+'_nowall.eps',/encapsulated,/color,bit=8,xsize=8.48,ysize=3.48,/inches
...
device,filename='/Users/jgroh/temp/etc_cmfgen_mod111_plus_cavity_compare_models_halpha_emiss_'+model1+'_'+sufix1+'_'+filename1+'_i'+inc_str1+model2+'_'+sufix2+'_'+filename2+'_i'+inc_str2+'_nowall.eps',/encapsulated,/color,bit=8,xsize=8.48,ysize=3.48,/inches
...
device,filename='/Users/jgroh/temp/etc_cmfgen_mod111_plus_cavity_compare_models_halpha_abs_'+model1+'_'+sufix1+'_'+filename1+'_i'+inc_str1+model2+'_'+sufix2+'_'+filename2+'_i'+inc_str2+'_nowall.eps',/encapsulated,/color,bit=8,xsize=8.48,ysize=3.48,/inches
colorm=fsc_color('blue')
!X.thick=3.7
!Y.thick=3.7
!p.charthick=3.5

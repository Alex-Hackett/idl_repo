;PRO ZE_ETACAR_CMFGEN_MODEL_CUT_JOHN_COMPARE_MODELS_DENSITY_CONTRAST_WALL_DP3
close,/all
...
model1='cut_v4_var_wall_density'   
sufix1='falpha10_dalpha3d6'
extra_label1=TEXTOIDL(',falpha10_dalpha3d6')
filename1='OBSFRAME1'
...
model2='cut_v4_var_wall_density'  
sufix2='falpha5_dalpha3d6'
extra_label2=TEXTOIDL(',falpha5_dalpha3d6')
filename2='OBSFRAME1'
...
model3='cut_v4_var_wall_density'   ;b,c,o,r,t,u,v don't cover the UV range
sufix3='falpha2d5_dalpha3d6'
extra_label3=TEXTOIDL(',falpha2d5_dalpha3d6')
filename3='OBSFRAME1'
...
model4='cut_v4_var_wall_density'   ;b,c,o,r,t,u,v don't cover the UV range
sufix4='falpha1_dalpha3d6'
extra_label4=TEXTOIDL(',falpha1_dalpha3d6')
filename4='OBSFRAME1'
...
model5='cut_v4_var_wall_density'   ;b,c,o,r,t,u,v don't cover the UV range
sufix5='falpha3d76_dalpha7d2'
extra_label5=TEXTOIDL(',falpha3d76_dalpha7d2')
filename5='OBSFRAME1'
...
model6='cut_v4_var_wall_density'   ;b,c,o,r,t,u,v don't cover the UV range
sufix6='falpha2d5_dalpha10d8'
extra_label6=TEXTOIDL(',falpha2d5_dalpha10d8')
filename6='OBSFRAME1'
...
device,filename='/Users/jgroh/temp/etc_cmfgen_mod111_plus_cavity_compare_models_uv_density_contrast_wall_'+model1+'_'+sufix1+'_'+filename1+'_i'+inc_str1+model2+'_'+sufix2+'_'+filename2+'_i'+inc_str2+'.eps',/encapsulated,/color,bit=8,xsize=8.48,ysize=3.48,/inches
...
device,filename='/Users/jgroh/temp/etc_cmfgen_mod111_plus_cavity_compare_models_halpha_emiss_density_contrast_wall_'+model1+'_'+sufix1+'_'+filename1+'_i'+inc_str1+model2+'_'+sufix2+'_'+filename2+'_i'+inc_str2+'.eps',/encapsulated,/color,bit=8,xsize=8.48,ysize=3.48,/inches
...
device,filename='/Users/jgroh/temp/etc_cmfgen_mod111_plus_cavity_compare_models_halpha_abs_density_contrast_wall_'+model1+'_'+sufix1+'_'+filename1+'_i'+inc_str1+model2+'_'+sufix2+'_'+filename2+'_i'+inc_str2+'.eps',/encapsulated,/color,bit=8,xsize=8.48,ysize=3.48,/inches
colorm=fsc_color('blue')
!X.thick=3.7
!Y.thick=3.7
!p.charthick=3.5

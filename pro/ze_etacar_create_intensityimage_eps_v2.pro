PRO ZE_ETACAR_CREATE_INTENSITYIMAGE_EPS_V2,pa,rstar,dist,lambda_val,lambda0,lambda,np,ndelta1,nos,ipdelta,p,delta1_vec,x,y,model,model2d,sufix,dstr,inc_str,circ_GridSpace_mas,$
...
xyouts,0.08,0.970,'V-band image, '+TEXTOIDL('W=')+w_str+', i='+inc_str+'!Eo!N, PA='+pa_str+'!Eo ',/NORMAL,charsize=3.0,color=fsc_color('black')

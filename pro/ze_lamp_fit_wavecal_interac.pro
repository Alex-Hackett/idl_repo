...
pro line_norm_event,event
  common lamp_fit_line_common,info,xarray,yarray,lamparray,rsave,gsave,bsave,xn,yn,xnorm,fnorm
...
replot_spline:
  wset,info.plot1_id
  device,copy=[0,0,950,450,0,0,info.pixid]
  yfit=poly_fit(xn,lamparray,info.degree,yfit=fit)
  xarray=xn
  yarray=lamparray - fit
  yn=yarray
  line_norm_plot,info,xarray,yarray,xn,yn
...
pro ze_lamp_fit_wavecal_interac,line_centroids,lampline_ids,xnodes,ynodes,xcen,ycen,tharlineid, $

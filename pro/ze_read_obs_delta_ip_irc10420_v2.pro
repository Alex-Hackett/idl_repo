...
pix=1027.                                                          ; BEST 1027 
circ_GridSpace_mas=0.01
mas_to_rstar=(214.08*dist)/(rstar/6.96)
circ_gridSpace = [circ_GridSpace_mas*mas_to_rstar,circ_GridSpace_mas*mas_to_rstar] ; space in x and y directions TESTING
factor=circ_GridSpace_mas*mas_to_rstar*(pix-1.)/(2.*max(X2))
...
dir='/Users/jgroh/ze_models/2D_models/irc10420/'
model='19'
...
;save,lobs,fobsheln,lambda_vector,totalfluxfimsysn,FILENAME='/Users/jgroh/espectros/irc10420/irc10420_variables_spec_'+model+model2d+sufix+'_d'+dstr+'.sav'
END

;PRO ZE_ETACAR_CRIRES_PLOT_SCOM_2008MAY05_V1,scoma,swmpa,cal2070
...
xnodes_spec_Ext=0
ynodes_spec_ext=0
gratdet='2008may_'+strcompress(string(grat_angle, format='(I04)'))+'_'+strcompress(string(det, format='(I01)'))
...
lampfile='/Users/jgroh/espectros/thar_kerber_cut_vac.txt'
flatfile=dirgencalib+'/proc/FLAT/CR_PFLT_080504A_1090.4nm.fits'
row=255
lambda0=1.08333
;restore,'/Users/jgroh/espectros/etc_poly_wavecal_'+gratdet+'_line_auto_lamp_2d.sav'
    END

...
plots,lambdanoabs,1.5*fluxnoabsescd,color=fsc_color('red'),linestyle=1,noclip=0,clip=[x1l,0,x1u,6.0e-13]
plots,lambdamod,1.5*fluxmodescd,color=fsc_color('purple'),noclip=0,clip=[x1l,0,x1u,6.0e-13]
for l=0, i-1 do begin
...
plots,lambdanoabs-0.07,1.0*fluxnoabsescd,color=fsc_color('red'),linestyle=1, noclip=0,clip=[x2l,0,x2u,1.7e-12]
plots,lambdamod-0.07,1.0*fluxmodescd,color=fsc_color('purple'), noclip=0,clip=[x2l,0,x2u,1.7e-12]
for l=0, i-1 do begin
...
plots,lambdanoabs-0.07,1.00*fluxnoabsescd,color=fsc_color('red'),linestyle=1, noclip=0,clip=[x3l,0,x3u,4.5e-12]
plots,lambdamod-0.07,1.00*fluxmodescd,color=fsc_color('purple'), noclip=0,clip=[x3l,0,x3u,4.5e-12]
for l=0, i-1 do begin

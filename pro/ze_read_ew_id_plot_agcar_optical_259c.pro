...
;defines model file
model='/home/groh/espectros/agcar/259_narv2.txt'  
...
sobc[l]=strmid(sob[l],4,pos)
if ((sobc[l] ne 'NII') && (sobc[l] ne 'HI')) then begin ;colocando apenas um traco nas transicoes do FeV,normal para os outros.
xyouts,lambdac[l]+6,max2-0.9,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90
endif
if (sobc[l] eq 'NII') then begin
...
;3rd panel
max3=2.1
plot,lambdafuse,(fluxfuse+0.1),xstyle=1,ystyle=1,xrange=[x3l,x3u],yrange=[0.7,max3],xtitle='wavelength (Angstrom)', ytitle='Normalized Flux',/nodata,charsize=2
plots,lambdafuse,fluxfuse+0.05,color=fsc_color('black'), noclip=0,clip=[x3l,0.7,x3u,max3]

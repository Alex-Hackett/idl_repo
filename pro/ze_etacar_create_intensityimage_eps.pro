PRO ZE_ETACAR_CREATE_INTENSITYIMAGE_EPS,pa,rstar,dist,lambda_val,lambda0,lambda,np,ndelta1,nos,ipdelta,p,delta1_vec,x,y,model,model2d,sufix,dstr,inc_str,circ_GridSpace_mas,$
circ_griddedData=circ_griddedData,circxvector=circxvector,circyvector=circyvector,norm=norm
...
circxvector=circxvector,circyvector=circyvector,circ_griddedData=circ_griddedData,norm=key_norm

PRO ZE_EVOL_PLOT_WG_FILE_V2,wgfile,data_wgfile_cut,xstr,ystr,xtitle,ytitle,$
...
IF (n_elements(data_wgfile_cut) LT 1) THEN BEGIN
        ...
        ENDIF ELSE BEGIN
          print,'Please type y or n next time. Exiting.'
          RETURN
        ENDELSE
ENDIF
...
ZE_EVOL_PLOT_XY_GENERAL_EPS_V2,x,y,xstr,ystr,label,z1=z,labelz=zstr,x2=x,y2=eta_star,rebin=rebin,xreverse=xreverse,_EXTRA=extra

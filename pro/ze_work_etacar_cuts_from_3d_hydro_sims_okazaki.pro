;PRO ZE_WORK_ETACAR_CUTS_FROM_3D_HYDRO_SIMS_OKAZAKI

working_dir='/Users/jgroh/papers_in_preparation_groh/etacar_10830_aa/'
model_dir='1D_Data_i=60_w=243/'
model_dir='1D_Data/'
...
ZE_READ_DATA_FROM_TOM_V2,all_filenames[0],l_over_a_for_primt,rho_primt,rho_sect,l_over_a_for_dent,rho_los_i60w243t,vel_los_i60w243t,rho_los_i0w243t,vel_los_i0w243t,rho_los_i41w243t,vel_los_i41w243t,rho_los_i41w270t,vel_los_i41w270t,headert

nlines=n_elements(vel_los_i60w243t)
l_over_a_for_prim=dblarr(nlines,nphases)
rho_prim=l_over_a_for_prim & rho_sec=rho_prim & l_over_a_for_den=rho_prim & rho_los_i60w243=rho_prim &vel_los_i60w243=rho_prim &rho_los_i0w243=rho_prim &vel_los_i0w243=rho_prim &rho_los_i41w243=rho_prim &vel_los_i41w243=rho_prim &rho_los_i41w270=rho_prim &vel_los_i41w270=rho_prim
header=strarr(nphases)

FOR I=0, nphases-1 DO BEGIN
ZE_READ_DATA_FROM_TOM_V2,all_filenames[i],l_over_a_for_primt,rho_primt,rho_sect,l_over_a_for_dent,rho_los_i60w243t,vel_los_i60w243t,rho_los_i0w243t,vel_los_i0w243t,rho_los_i41w243t,vel_los_i41w243t,rho_los_i41w270t,vel_los_i41w270t,headert
...
rho_los_i0w243[*,i]=rho_los_i0w243t
vel_los_i0w243[*,i]=vel_los_i0w243t
...
0: BEGIN
rho_los=rho_los_i0w243
vel_los=vel_los_i0w243
orient_str='i90_w243'
...
FOR J=0, 4 do l_over_a_for_den_i[*,j]=indgen(npts)*1.D
...
;extrapolate
linterp,l_over_a_john,vel_second_john,REFORM(l_over_a_for_den[*,0]),vel_Second_john_i_upto10
...
LOADCT,0
plot,vmin_start_vec,column_density_0,xrange=[-500,-3000],yrange=[1e18,1e25],/ylog,/NODATA ,COLOR=FSC_COLOR('black'), $
...
;, title=title
plots,l_over_a_for_den[*,0],rho_los[*,0],color=fsc_color('black'),noclip=0
plots,l_over_a_for_den[*,1],rho_los[*,1],color=fsc_color('red'),noclip=0
plots,l_over_a_for_den[*,2],rho_los[*,2],color=fsc_color('blue'),noclip=0
plots,l_over_a_for_den[*,3],rho_los[*,3],color=fsc_color('green'),noclip=0
plots,l_over_a_for_den[*,4],rho_los[*,4],color=fsc_color('orange'),noclip=0
...
;, title=title
plots,l_over_a_for_den[*,0],vel_los[*,0],color=fsc_color('black'),noclip=0
plots,l_over_a_for_den[*,1],vel_los[*,1],color=fsc_color('red'),noclip=0
plots,l_over_a_for_den[*,2],vel_los[*,2],color=fsc_color('blue'),noclip=0
plots,l_over_a_for_den[*,3],vel_los[*,3],color=fsc_color('green'),noclip=0
plots,l_over_a_for_den[*,4],vel_los[*,4],color=fsc_color('orange'),noclip=0
plots,l_over_a_for_den[*,4],vel_Second_john_i_upto10,color=fsc_color('purple'),noclip=0,linestyle=2

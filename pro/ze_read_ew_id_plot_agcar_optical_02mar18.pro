...
ZE_READ_SPECTRA_COL_VEC,obsdir+'agc02jul04_36a92n.txt',lambdafuse,fluxfuse,nrec
ZE_READ_SPECTRA_COL_VEC,obsdir+'agc02mar17.txt',l02mar,f02mar,nrec
ZE_READ_SPECTRA_COL_VEC,obsdir+'279_narv2.txt',lambdamod,fluxmod,nrec   ;best fits so far!
...
plots,lambdamod,fluxmod,color=fsc_color('red',!d.table_size-10), noclip=0,clip=[x1l,0,x1u,12],linestyle=2
...
;making psplots
set_plot,'ps'
device,filename='/Users/jgroh/temp/output_opt_2002jul.eps',/encapsulated,/color,bit=8,xsize=8.48,ysize=6.48,/inches
;!X.OMARGIN=[10,5]
!p.multi=[0, 1, 5, 0, 0]
...
plots,l02mar,f02mar*1.05,color=fsc_color('black'),noclip=0,clip=[x1l,0,x1u,13]
plots,lambdamod,fluxmod,color=fsc_color('red',!d.table_size-10), noclip=0,clip=[x1l,0,x1u,13],linestyle=2,thick=3.5
...
plots,lambdamod,fluxmod,color=fsc_color('red',!d.table_size-10), noclip=0,clip=[x1bl,0,x1bu,13],linestyle=2,thick=1.5
for l=0, i-1 do begin
...
plots,lambdamod2,fluxmod2,color=fsc_color('red'), noclip=0,clip=[x2l,0,x2u,7],linestyle=2,thick=1.5
for l=0, i-1 do begin
...
plots,lambdamod2,fluxmod2,color=fsc_color('red'), noclip=0,clip=[x2bl,0,x2bu,7],linestyle=2,thick=1.5
for l=0, i-1 do begin
...
plots,lambdamod,fluxmodvsys,color=fsc_color('red'), noclip=0,clip=[4855,0,4870,13],linestyle=2,thick=1.5
...
plots,lambdamod,fluxmod,color=fsc_color('red'), noclip=0,clip=[x3l,0,x3u,12],linestyle=2,thick=1.5
for l=0, i-1 do begin
...
plots,lambdamod,fluxmod,color=fsc_color('red'), noclip=0,clip=[x3cl,0.3,x3cu,12],linestyle=2,thick=1.5
for l=0, i-1 do begin
...
plots,lambdafuse,fluxfuse*1.03,color=fsc_color('black'),noclip=0,clip=[x4l,0.5,x4u,7]
plots,lambdamod,fluxmod,color=fsc_color('red'), noclip=0,clip=[x4l,0.5,x4u,7],linestyle=2,thick=1.5
for l=0, i-1 do begin
...
plots,lambdamod,fluxmod,color=fsc_color('red'), noclip=0,clip=[x4bl,0.3,x4bu,9],linestyle=2,thick=1.5
...
plots,l02mar,f02mar,color=fsc_color('black'),noclip=0,clip=[x4cl,0.8,x4cu,7]
plots,lambdamod2,fluxmod2,color=fsc_color('red'), noclip=0,clip=[x4cl,0.8,x4cu,7],linestyle=2,thick=1.5
for l=0, i-1 do begin
...
plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[6550,6575],yrange=[-5,60],$
...
plots,lambdamod,fluxmodvsys,color=fsc_color('red'), noclip=0,clip=[6550,0,6575,80],linestyle=2,thick=1.5
...
plots,lambdamod,fluxmod,color=fsc_color('red'), noclip=0,clip=[x5bl,0,x5bu,7],linestyle=2,thick=1.5
...
plots,lambdamod,fluxmod,color=fsc_color('red'), noclip=0,clip=[x5dl,0.5,x5du,7],linestyle=2,thick=1.5
...
plots,lambdafuse,fluxfuse,color=fsc_color('black'),noclip=0,clip=[x5cl,0.5,x5cu,7]
plots,lambdamod,fluxmod,color=fsc_color('red'), noclip=0,clip=[x5cl,0.5,x5cu,7],linestyle=2,thick=1.5
for l=0, i-1 do begin

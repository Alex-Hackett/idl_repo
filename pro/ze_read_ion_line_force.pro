...
hydro='/aux/pc20117a/jgroh/cmfgen_models/agcar/354/HYDRO'
...
;declare arrays
r=dblarr(ND) & v=r & error=r & vdvdr=r & rhodpdr=r & gtot=r & grad=r & gelec=r & gamma=r & gradreq=r &depth=r
...
grot=grad & grad_over_gradreq=grad
...
XCHARSIZE=2,YCHARSIZE=2,xrange=[x0cmin,x0cmax],yrange=[0.4,2],XMARGIN=[15,6],YMARGIN=[8,4],/YNOZERO,/nodata
...
data=read_ascii(ion_line_force, DATA_START=5, MISSING_VALUE=0., header=header)
close,2

...
set_plot,'ps'
DEVICE,filename='/.aux_mnt/pc20074a/undomiel/HARPSinter/reductionHARPS/EX_FILM/Ha_RT.ps',/ENCAPSULATED,/CMYK
FORMAT='(F3.1)'
...
;set_plot,'ps'
DEVICE,filename='/.aux_mnt/pc20074a/undomiel/HARPSinter/reductionHARPS/EX_FILM/Ha_SC.ps',/ENCAPSULATED,/CMYK
FORMAT='(F3.1)'
...
;set_plot,'ps'
DEVICE,filename='/.aux_mnt/pc20074a/undomiel/HARPSinter/reductionHARPS/EX_FILM/Ha_YS.ps',/ENCAPSULATED,/CMYK
FORMAT='(F3.1)'
...
set_plot,'ps'
DEVICE,filename='/.aux_mnt/pc20074a/undomiel/HARPSinter/reductionHARPS/EX_FILM/Ha_BD.ps',/ENCAPSULATED,/CMYK
FORMAT='(F3.1)'
...
;set_plot,'ps'
DEVICE,filename='/.aux_mnt/pc20074a/undomiel/HARPSinter/reductionHARPS/EX_FILM/Ha_ZG.ps',/ENCAPSULATED,/CMYK
FORMAT='(F3.1)'
...
;set_plot,'ps'
DEVICE,filename='/.aux_mnt/pc20074a/undomiel/HARPSinter/reductionHARPS/EX_FILM/Ha_RZV.ps',/ENCAPSULATED,/CMYK
FORMAT='(F3.1)'
...
;set_plot,'ps'
DEVICE,filename='/.aux_mnt/pc20074a/undomiel/HARPSinter/reductionHARPS/EX_FILM/Ha_LC.ps',/ENCAPSULATED,/CMYK
FORMAT='(F3.1)'
...
;set_plot,'ps'
DEVICE,filename='/.aux_mnt/pc20074a/undomiel/HARPSinter/reductionHARPS/EX_FILM/Ha_RSP.ps',/ENCAPSULATED,/CMYK
FORMAT='(F3.1)'
...
;set_plot,'ps'
DEVICE,filename='/.aux_mnt/pc20074a/undomiel/HARPSinter/reductionHARPS/EX_FILM/Hb_LC.ps',/ENCAPSULATED,/CMYK
FORMAT='(F3.1)'
...
;set_plot,'ps'
DEVICE,filename='/.aux_mnt/pc20074a/undomiel/HARPSinter/reductionHARPS/EX_FILM/Ha_RZV_maxflux.ps',/ENCAPSULATED,/CMYK
FORMAT='(F3.1)'
...
;set_plot,'ps'
DEVICE,filename='/.aux_mnt/pc20074a/undomiel/HARPSinter/reductionHARPS/EX_FILM/Ha_LC_maxflux.ps',/ENCAPSULATED,/CMYK
FORMAT='(F3.1)'
!P.CHARSIZE=1.5
PLOT, xvector1,yvector1, xrange=[velocityM,velocityP], yrange=[0,2],xtitle='velocity (km/s)', ytitle='phase' ,position=p1,/NODATA
TVscale,image1/MAX(image1),position=p1,minvalue=0.2,maxvalue=1.0
...
;set_plot,'ps'
DEVICE,filename='/.aux_mnt/pc20074a/undomiel/HARPSinter/reductionHARPS/EX_FILM/Ha_RSP_maxflux.ps',/ENCAPSULATED,/CMYK
FORMAT='(F3.1)'
!P.CHARSIZE=1.5
PLOT, xvector1,yvector1, xrange=[velocityM,velocityP], yrange=[0,2],xtitle='velocity (km/s)', ytitle='phase' ,position=p1,/NODATA
TVscale,image1/MAX(image1),position=p1,minvalue=0.2,maxvalue=1.0

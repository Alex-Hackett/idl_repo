PRO ZE_ETACAR_CREATE_INTENSITYIMAGE_CONTINUUM_EPS,pa,rstar,dist,lambda_val,lambda0,lambda,np,ndelta1,nos,ipdelta,p,delta1_vec,x,y,model,model2d,sufix,dstr,inc_str,circ_GridSpace_mas,$
...
LOADCT,13,/SILENT
colorbar, COLOR=fsc_color('black'),DIVISIONS=5,TICKNAMES=colorbar_ticknames_str, CHARSIZE=1.5,CHARTHICK=8,$
...
xyouts,0.04,0.035,TEXTOIDL('I [cgs]'),/NORMAL,color=fsc_color('black'),charsize=3.5,charthick=12

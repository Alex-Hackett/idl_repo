;restore,'/Users/jgroh/espectros/etc_2070_det3_allvar.sav'
...
!P.CHARSIZE=0
!P.CHARTHICK=0
dirsci='/Users/jgroh/data/eso_vlt/crires/Etacar/386D-0808A/502565/sci_proc/'
dirsciraw='/Users/jgroh/data/eso_vlt/crires/Etacar/386D-0808A/502565/sci_raw/'
dircal='/Users/jgroh/data/eso_vlt/crires/Etacar/386D-0808A/502563/cal_proc/'
dirgencalib='/Users/jgroh/data/eso_vlt/crires/Etacar/386D-0808A/GEN_CALIB/raw/ARC/'
dircriresrun='/Users/jgroh/data/eso_vlt/crires/Etacar/386D-0808A/'
dirgencalib=dircriresrun+'GEN_CALIB/' ;for all grats and dets
noffset=38


;feb data not processed from archive
dirsciraw='/Users/jgroh/data/eso_vlt/crires/Etacar/386D-0808A_2011Feb13/'
noffset=16 ;for p86

dirsciraw='/Users/jgroh/data/eso_vlt/crires/Etacar/387D_0807/fe2/'
noffset=92 ;for p87 
listfile=dirsciraw+'list2'

dirsciraw='/Users/jgroh/data/eso_vlt/crires/Etacar/387D_0807/he1/'
noffset=56 ;for p87 
listfile=dirsciraw+'list'

;dirsciraw='/Users/jgroh/data/eso_vlt/crires/Etacar/387D_0807/pabeta/'
;noffset=43 ;for p87 
;listfile=dirsciraw+'list'
...
pos=20.
scoma=dirsciraw+list[pos]


;scoma=dirsciraw+'CRIRE.2010-12-22T07:06:13.005.fits'
;scoma=dirsciraw+'CRIRE.2010-12-22T07:09:37.515.fits'

;scoma=dirgencalib+'/proc/FLAT/CR_PFLT_090402B_1090.4nm.fits'
;swmpa=dirscigroh+'crires_spec_jitter_wlmap_0002.fits'
swmpa=dirsci+'CR_SWMA_502565_2010-12-22T07:06:13.005_DIT1_1082.7nm.fits' ;SWMA files look better

cal2070=dircal+'CR_PEXT_101221A_DIT30_1082.7nm.fits' ;for P86


;astrometric reference image
astrometry_ref_image=dirsciraw+'CRIRE.2010-12-22T07:07:45.260.fits' ;last exposure on star, to measure y offset
astrometry_ref_image=dirsciraw+list[1] ;last exposure on star, to measure y offset
...
keyword='CRVAL1'
ZE_ESO_FITS_HIERARCHY_RETURN_KEYWORD,headera2,keyword,crval1

keyword='CD1_1'
ZE_ESO_FITS_HIERARCHY_RETURN_KEYWORD,headera2,keyword,cd1_1


;crude wavecal first pass based on header info
swmpa2t=dblarr((size(swmpa2))[1])
for i=0, (size(swmpa2))[1] -1 do swmpa2t[i]=crval1 + i*cd1_1
for j=0, (size(swmpa2))[2] -1 do swmpa2[*,j]=swmpa2t
 
ZE_ETACAR_CRIRES_READ_DETECTOR, astrometry_ref_image, 0, astrometry_ref_image0, headerastrometry_ref_image0

;read flatfield sky bpm etc
...
keyword='SEQ CUMOFFSETX'
ZE_ESO_FITS_HIERARCHY_RETURN_KEYWORD,headerastrometry_ref_image0,keyword,cumoffsetx_ref
print,'Offset x reference [arcsec]', cumoffsetx_ref*0.085
...
ZE_SELECT_STAR_CENTER,dataa2,star=star
...
;dataa2[*,i]=dataa2[*,i]-dataa2[norm_col,i]
...
;dataa2[*,i]=dataa2[*,i]/dataa2[*,row]
dataa2[*,i]=dataa2[*,i]-norm_line_val
...
;restore,'/Users/jgroh/espectros/etc_poly_wavecal_2070_1_line_auto_tel.sav'
;polycal_tel=dblarr(3)
;polycal_tel[0]=yfit[0]
;polycal_tel[1]=yfit[1]
;polycal_tel[2]=yfit[2]
;for i=0., sizespat - 1 do begin
;;restore,'/Users/jgroh/espectros/etc_poly_wavecal_2070_det1_line_auto_'+strcompress(string(i, format='(I02)'))+'.sav'
...
;;ZE_READ_SPECTRA_FITS,'/Users/jgroh/espectros/etc_cal_2070_2.fits',lambdatel,fluxtel,header,nrec
...
scl=ABS(0.8 + 0.01428*i)
IF i gt 14 THEN scl=(1.2-0.01428*i)
scl=1
v=0.0
...
;using  sqrt
dataa2=SQRT(dataa2)
dataa2=ROTATE(dataa2,7)
;plotting image
a=min(dataa2,/NAN)
a=1.2
b=max(dataa2,/NAN)/3.5
;b=5.0
...
LOADCT, 13
;LOADCT,0
tvimage,imginv, /Overplot,/nointerp
;linear colorbar
x=[0,10]
xfin=[0,2,4,6,8,10]
y=[a,b]
...
plot,ZE_LAMBDA_TO_VEL(swmpa2[*,row]*10.,lambda0*10000.),dataa2[*,row],xstyle=1,ystyle=1,xrange=[-3000,-1550], xtitle='velocity [km/s]',ytitle='F/Fc',$
yrange=[ymin,ymax],charsize=2,charthick=1.5, /NODATA,POSITION=[0.08,0.2,0.9,0.98]
plots,ZE_LAMBDA_TO_VEL(swmpa2[*,row+cut1]*10.,lambda0*10000.),dataa2[*,row+cut1],noclip=0
plots,ZE_LAMBDA_TO_VEL(swmpa2[*,row+cut2]*10.,lambda0*10000.),dataa2[*,row+cut2],color=fsc_color('orange'),noclip=0,linestyle=2
;flux_sum=dataa2[*,row+cut3]+dataa2[*,row+cut3+1]+dataa2[*,row+cut3-1]
plots,ZE_LAMBDA_TO_VEL(swmpa2[*,row+cut3]*10.,lambda0*10000.),dataa2[*,row+cut3],color=fsc_color('blue'),noclip=0,linestyle=0
...
;ZE_WRITE_SPECTRA_COL_VEC,'/Users/jgroh/espectros/etacar/10830/etc_crires_onstar_hei2070_detector2_2009jan07_vel.txt',ZE_LAMBDA_TO_VEL(lambda_newcal,lambda0*10000.)+heliovel,dataa2[*,row+cut3]/dataa2[norm_col,row+cut3]
...
;ZE_WRITE_SPECTRA_COL_VEC,'/Users/jgroh/espectros/etacar/10830/etc_crires_onstar_hei2070_detector1_2009jan07.txt',lambda_spec,fonstar_norm
...
grat_angle=1641
gratdet='2011apr12_'+strcompress(string(grat_angle, format='(I04)'))+'_offset'+strcompress(string(pos, format='(I02)'))
imgname='etc_crires'+gratdet
;ZE_ETACAR_CRIRES_PLOT_GENERIC_IMAGE_EPS,img,a,b,imgname,swmpa2,cmi,cma,star,sub,row,aa,bb,pos,cumoffsetx,signcumoffsetx,lambda0

xsize=aa
ysize=bb

set_plot,'ps'
device,filename='/Users/jgroh/temp/etc_crires_generic_offset_+''.eps',/encapsulated,/color,bit=8,xsize=10*xsize/ysize,ysize=10,/inches
!X.THICK=5.5
!Y.THICK=5.5
!X.CHARSIZE=2
!Y.CHARSIZE=2
...
;xyouts,420/aa,870/bb,TEXTOIDL('PA=325^o'),/NORMAL,color=fsc_color('black')
;
;save,/variables,FILENAME='/Users/jgroh/espectros/etc_2070_det3_allvar.sav'
END

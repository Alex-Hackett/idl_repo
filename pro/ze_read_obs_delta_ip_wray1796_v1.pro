...
dir='/Users/jgroh/ze_models/2D_models/wray1796/'
model='2'
model2d='a'
;sufix=''
model='latidep_ring'
...
;rstar=1717.513 ; in CMFGEN UNITS model 1
rstar=1714.58; model 2
;rstar=876.269 ; in CMFGEN UNITS model 3
;rstar=3081.303 ; in CMFGEN UNITS model 4
;rstar=1500.4
;rstar=785.
dist=4.0 ;in kpc
...
pa=123.          ;position angle in degrees; by definition PA=0 towards N, and increase eastwards. USE PA significantly different than 0 (e.g.50) for spherical models
;pa=227
...
PA_obs_wra1796_ut_25aug10=[33.77,91.28,69.24] ;in degress
;changing PAs because the IMAGE PA should be 60, not 0
;PA_obs_irc10420_ut=PA_obs_irc10420_ut-60.
Base_obs_wra1796_ut_25aug10=[54.98,85.04,123.6]
...
PA_obs=PA_obs_wra1796_ut_25aug10
Base_obs=Base_obs_wra1796_ut_25aug10
...
lambda_ini=21645.   ;initial lambda to do calculations 21610
lambda_fin=21685.    ;initial lambda to do calculations 21720
;lambda_ini=21655   ;initial lambda to do calculations 21610
;lambda_fin=21665    ;initial lambda to do calculations 21720
;
...
wset,8
file_output='/Users/jgroh/temp/wra1796_'+model+'_'+model2d+'_'+sufix+'_' +'i_'+ inc_Str+'_PA_'+pa_str+strcompress(string(i, format='(I04)'), /remove)+'.gif'
...
ZE_AMBER_READ_3T_ASCII_FROM_ALEX_KREPLIN,dir_obs+file_obs,data_wra1796,header


lobs=REFORM(data_wra1796[0,*]*10000.)
fobs=REFORM(data_wra1796[19,*])

RESTORE,'/Users/jgroh/espectros/amber/wra1796_25aug10.sav'
fobs=fobsn_wra1796
lobs=lobs_wra1796

vis12_ut=REFORM(data_wra1796[1,*])
vis23_ut=REFORM(data_wra1796[3,*])
vis31_ut=REFORM(data_wra1796[5,*])

phase12_ut=REFORM(data_wra1796[7,*])
phase23_ut=REFORM(data_wra1796[9,*])
phase31_ut=REFORM(data_wra1796[11,*])

cp_ut=REFORM(data_wra1796[13,*])

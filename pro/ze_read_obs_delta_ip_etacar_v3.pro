...
ZE_BOREHOLE_TO_TOM_COMPUTE_VIS_PHASE,res_array,minx,maxx
...
;print,min(x2),max(x2)
circxvector=(circxvector/1.496e+13)/(2.3)
circyvector=circxvector
...
circ_GridSpace_mas_vis=[0.08,0.08] ;orignal for eta car john's model
circ_GridSpace_mas_vis_val=(circxvector[300]-circxvector[299])
circ_GridSpace_mas_vis=[circ_GridSpace_mas_vis_val,circ_GridSpace_mas_vis_val]
for i=0., nlambda-1 do begin
lambda_val=lambda_ini + i*lambda_sampling
lambda_vector[i]=lambda_val

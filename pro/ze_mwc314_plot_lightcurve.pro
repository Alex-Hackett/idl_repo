PRO ZE_MWC314_PLOT_LIGHTCURVE,hjd,yr_frac,mag,hjd_av
...
;******************************************************
plotsym,1,3
device,filename='/Users/jgroh/temp/mwc314_lightcurve.eps',/encapsulated,/color,bit=8,xsize=10*xsize/ysize,ysize=10,/inches
plot,hjd,mag,yrange=[max(mag)*1.004,min(mag)*0.996],XTITLE='Heliocentric Julian Date - 50,000', YTITLE='V mag',$

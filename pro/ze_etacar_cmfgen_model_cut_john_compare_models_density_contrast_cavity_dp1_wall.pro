;PRO ZE_ETACAR_CMFGEN_MODEL_CUT_JOHN_COMPARE_MODELS_DENSITY_CONTRAST_CAVITY_DP1_WALL
close,/all
...
sufix2='1d28em2'
extra_label2=TEXTOIDL(',b=1.28e^{-2}')
filename2='OBSFRAME1'
...
sufix3='1d02em1'
extra_label3=TEXTOIDL(',b=1.02e^{-1}')
filename3='OBSFRAME1'
...
device,filename='/Users/jgroh/temp/etc_cmfgen_mod111_plus_cavity_compare_models_uv_'+model1+'_'+sufix1+'_'+filename1+'_i'+inc_str1+model2+'_'+sufix2+'_'+filename2+'_i'+inc_str2+'_wall.eps',/encapsulated,/color,bit=8,xsize=8.48,ysize=3.48,/inches
...
device,filename='/Users/jgroh/temp/etc_cmfgen_mod111_plus_cavity_compare_models_halpha_emiss_'+model1+'_'+sufix1+'_'+filename1+'_i'+inc_str1+model2+'_'+sufix2+'_'+filename2+'_i'+inc_str2+'_wall.eps',/encapsulated,/color,bit=8,xsize=8.48,ysize=3.48,/inches
...
device,filename='/Users/jgroh/temp/etc_cmfgen_mod111_plus_cavity_compare_models_halpha_abs_'+model1+'_'+sufix1+'_'+filename1+'_i'+inc_str1+model2+'_'+sufix2+'_'+filename2+'_i'+inc_str2+'_wall.eps',/encapsulated,/color,bit=8,xsize=8.48,ysize=3.48,/inches
colorm=fsc_color('blue')
!X.thick=3.7
!Y.thick=3.7
!p.charthick=3.5

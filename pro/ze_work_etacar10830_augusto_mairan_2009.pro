...
obsdir='/Users/jgroh/espectros/etacar/from_mairan_10830_2009/'
file='mairan_in_redisp'
...
data=read_ascii(obsdir+file,COUNT=nspec,TEMPLATE=template)
...
shift=11.0
mjd_sort=(mjd_sort-52819.8-0.5)/2022.7 + shift
...
device,filename='/Users/jgroh/temp/etacar_opd_hei10830_intens_phase_2D_2009.eps',/encapsulated,/color,bit=8,xsize=width,ysize=width*ysize/xsize,/inches
...
FOR I=0, n_elements(mjd_sort)-1 DO BEGIN
plots,[-1900,-1800],[mjd_sort[i],mjd_sort[i]]
;xyouts,100,mjd_sort[i]-0.003,date_obs[i]
ENDFOR
xyouts,0,1.05+shift,'2009.0 event',charsize=3.,color=fsc_color('black')

;timedep_armagh_7 reads rv from a model which has a reduced effective temperature
...
;ZE_READ_RVTJ,rvtj,r1,v1,sigma1,ed,t,chiross,fluxross,atom,ionden,den1,clump1,i,NC,NP,NCF,mdot,lstar,output_format_date,$
...
ZE_READ_SPECTRA_COL_VEC,'/Users/jgroh/ze_models/timedep_armagh/7/rv150.txt',r1,v1

;r and v values of model 2
ZE_READ_SPECTRA_COL_VEC,'/Users/jgroh/ze_models/timedep_armagh/7/rv150.txt',r2,v2

ZE_READ_SPECTRA_COL_VEC,'/Users/jgroh/ze_models/timedep_armagh/7/rv6.txt',r6,v6
...
;write VM_FILE
ZE_WRITE_VM_FILE,rout,vout,sigmaout,denout,clumpout,i,'/Users/jgroh/ze_models/timedep_armagh/7/VM_FILE_NEW' 

;write RVSIG_COL
ZE_WRITE_RVSIG_COL,rout,vout,sigmaout,i,'/Users/jgroh/ze_models/timedep_armagh/7/RVSIG_COL_NEW'  
...
rrev[29:74]=rout[29:74]
vrev[29:74]=vout[29:74]
...
;;write VM_FILE
ZE_WRITE_VM_FILE,rrev,vrev,sigmaoutrev,denoutrev,clumpoutrev,ndrev,'/Users/jgroh/ze_models/timedep_armagh/7/VM_FILE_NEW'  
;
;;write RVSIG_COL
ZE_WRITE_RVSIG_COL,rrev,vrev,sigmaoutrev,ndrev,'/Users/jgroh/ze_models/timedep_armagh/7/RVSIG_COL_NEW'  

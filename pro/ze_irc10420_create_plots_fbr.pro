;PRO ZE_IRC10420_CREATE_PLOTS_FBR
...
/nodata,XTICKFORMAT='(I6)',xstyle=9,ystyle=1,Position=PositionPlot,ytickinterval=1.0
...
a=-90
b=90
device,filename='/Users/jgroh/temp/vis_wavelength_comp_b12_19.eps',encapsulated=1,/color,bit=8,xsize=10*xwindowsize/ywindowsize,ysize=10,/inches
plot,lambda_vector,vis_triplet_wavelength_cnvl[0,*],yrange=[0,1.1],XTITLE=xtitlePlot, YTITLE='Visibility',$
/nodata,XTICKFORMAT='(I6)',xstyle=9,ystyle=1,Position=PositionPlot,ytickinterval=0.5,xtickinterval=15.,yminor=4
plots,vis12_ut.field1[2,*]*10000.,vis12_ut.field1[3,*],color=FSC_COLOR('black'),noclip=0
plots,lambda_vector_19asub,vis_triplet_wavelength_cnvl_19asub[0,*],noclip=0,color=FSC_COLOR('red'),linestyle=0
;plots,lambda_vector_19a,vis_triplet_wavelength_cnvl_19a[0,*],noclip=0,color=FSC_COLOR('blue'),linestyle=3
xyouts,0.28,0.3,TEXTOIDL('B_{12}=54.30m,PA=36.0')+'!Eo!N',/NORMAL
;plots,lambda_vector_17c,vis_triplet_wavelength_cnvl_17c[0,*],noclip=0,color=FSC_COLOR('blue'),linestyle=3
AXIS,XAXIS=1,XTICKFORMAT='(I5)',XSTYLE=1,COLOR=fsc_color('black'),XTITLE='v - vsys (km/s)',XRANGE=[ZE_LAMBDA_TO_VEL(min(lambda_vector),lambda0)-vsys,ZE_LAMBDA_TO_VEL(max(lambda_vector),lambda0)-vsys],$
xtickinterval=200.0
device,/close
...
/nodata,XTICKFORMAT='(I6)',xstyle=9,ystyle=1,Position=PositionPlot,ytickinterval=0.5,xtickinterval=15.,yminor=4
plots,vis23_ut.field1[2,*]*10000.,vis23_ut.field1[3,*],color=FSC_COLOR('black'),noclip=0
plots,lambda_vector_19asub,vis_triplet_wavelength_cnvl_19asub[1,*],noclip=0,color=FSC_COLOR('red'),linestyle=0
;plots,lambda_vector_19a,vis_triplet_wavelength_cnvl_19a[1,*],noclip=0,color=FSC_COLOR('blue'),linestyle=3
xyouts,0.28,0.31,TEXTOIDL('B_{23}=82.75m,PA=76.5')+'!Eo!N',/NORMAL
;plots,lambda_vector_17c,vis_triplet_wavelength_cnvl_17c[1,*],noclip=0,color=FSC_COLOR('blue'),linestyle=3
AXIS,XAXIS=1,XTICKFORMAT='(I5)',XSTYLE=1,COLOR=fsc_color('black'),XTITLE='v - vsys (km/s)',XRANGE=[ZE_LAMBDA_TO_VEL(min(lambda_vector),lambda0)-vsys,ZE_LAMBDA_TO_VEL(max(lambda_vector),lambda0)-vsys],$
xtickinterval=200.0
device,/close
...
/nodata,XTICKFORMAT='(I6)',xstyle=9,ystyle=1,Position=PositionPlot,ytickinterval=0.5,xtickinterval=15.,yminor=4
plots,vis31_ut.field1[2,*]*10000.,vis31_ut.field1[3,*],color=FSC_COLOR('black'),noclip=0
plots,lambda_vector_19asub,vis_triplet_wavelength_cnvl_19asub[2,*],noclip=0,color=FSC_COLOR('red'),linestyle=0
;plots,lambda_vector_19a,vis_triplet_wavelength_cnvl_19a[2,*],noclip=0,color=FSC_COLOR('blue'),linestyle=3
xyouts,0.285,0.73,TEXTOIDL('B_{31}=128.9m,PA=60.6')+'!Eo!N',/NORMAL
;plots,lambda_vector_17c,vis_triplet_wavelength_cnvl_17c[2,*],noclip=0,color=FSC_COLOR('blue'),linestyle=3
AXIS,XAXIS=1,XTICKFORMAT='(I5)',XSTYLE=1,COLOR=fsc_color('black'),XTITLE='v - vsys (km/s)',XRANGE=[ZE_LAMBDA_TO_VEL(min(lambda_vector),lambda0)-vsys,ZE_LAMBDA_TO_VEL(max(lambda_vector),lambda0)-vsys],$
xtickinterval=200.0
device,/close
...
/nodata,XTICKFORMAT='(I6)',xstyle=9,ystyle=1,Position=PositionPlot,ytickinterval=50.,xtickinterval=15.,yminor=4
plots,phase12_ut.field1[2,*]*10000.,phase12_ut.field1[3,*],color=FSC_COLOR('black'),noclip=0
;plots,[21645,21684],[0,0],color=FSC_COLOR('red'),noclip=0,linestyle=0
plots,lambda_vector_19asub,phase_triplet_wavelength_cnvl_19asub[0,*]+4.22,noclip=0,color=FSC_COLOR('red'),linestyle=0
;plots,lambda_vector_19a,phase_triplet_wavelength_cnvl_19a[0,*]-2.22,noclip=0,color=FSC_COLOR('blue'),linestyle=3
xyouts,0.28,0.72,TEXTOIDL('B_{12}=54.30m,PA=36.0')+'!Eo!N',/NORMAL
;plots,lambda_vector_17c,vis_triplet_wavelength_cnvl_17c[0,*],noclip=0,color=FSC_COLOR('blue'),linestyle=3
AXIS,XAXIS=1,XTICKFORMAT='(I5)',XSTYLE=1,COLOR=fsc_color('black'),XTITLE='v - vsys (km/s)',XRANGE=[ZE_LAMBDA_TO_VEL(min(lambda_vector),lambda0)-vsys,ZE_LAMBDA_TO_VEL(max(lambda_vector),lambda0)-vsys],$
xtickinterval=200.0
device,/close
...
plots,lambda_vector_19asub,phase_triplet_wavelength_cnvl_19asub[1,*]+6.54,noclip=0,color=FSC_COLOR('red'),linestyle=0
;plots,[21645,21684],[0,0],color=FSC_COLOR('red'),noclip=0,linestyle=0
;plots,lambda_vector_19a,phase_triplet_wavelength_cnvl_19a[1,*]-1.96,noclip=0,color=FSC_COLOR('blue'),linestyle=3
xyouts,0.28,0.72,TEXTOIDL('B_{23}=82.75m,PA=76.5')+'!Eo!N',/NORMAL
...
plots,lambda_vector_19asub,phase_triplet_wavelength_cnvl_19asub[2,*]+7.87,noclip=0,color=FSC_COLOR('red'),linestyle=0
;plots,[21645,21684],[0,0],color=FSC_COLOR('red'),noclip=0,linestyle=0
;plots,lambda_vector_19a,phase_triplet_wavelength_cnvl_19a[2,*]-3.83,noclip=0,color=FSC_COLOR('blue'),linestyle=3
xyouts,0.285,0.72,TEXTOIDL('B_{31}=128.9m,PA=60.6')+'!Eo!N',/NORMAL
...
/nodata,XTICKFORMAT='(I6)',xstyle=9,ystyle=1,Position=PositionPlot,ytickinterval=100.,xtickinterval=15.,yminor=4
plots,cp_ut.field1[2,*]*10000.,cp_ut.field1[3,*],color=FSC_COLOR('black'),noclip=0
plots,lambda_vector_19asub,cp_triplet_wavelength_cnvl_19asub,noclip=0,color=FSC_COLOR('red'),linestyle=0
;plots,[21645,21684],[0,0],color=FSC_COLOR('red'),noclip=0,linestyle=0
...
plot,lambda_vector,totalfluxfimsysn,yrange=[0,3.0],xtitle=xtitlePlot, YTITLE='F/Fcont',$
/nodata,XTICKFORMAT='(I6)',xstyle=9,ystyle=1,Position=PositionPlot,ytickinterval=1.0,xtickinterval=15.,yminor=4
plots,lobs,fobsheln,color=FSC_COLOR('black'),noclip=0
plots,lambda_vector,totalfluxfimsysn_19asub,noclip=0,color=FSC_COLOR('red'),linestyle=0
;plots,lambda_vector,totalfluxfimsysn_19a,noclip=0,color=FSC_COLOR('blue'),linestyle=3
AXIS,XAXIS=1,XTICKFORMAT='(I5)',XSTYLE=1,COLOR=fsc_color('black'),XTITLE='v - vsys (km/s)',XRANGE=[ZE_LAMBDA_TO_VEL(min(lambda_vector),lambda0)-vsys,ZE_LAMBDA_TO_VEL(max(lambda_vector),lambda0)-vsys],$
xtickinterval=200.0
device,/close

device,filename='/Users/jgroh/temp/spec_wavelength_19asub.ps',encapsulated=0,/color,bit=8,xsize=10*xwindowsize/ywindowsize,ysize=10,/inches
plot,lambda_vector,totalfluxfimsysn,yrange=[0,3.0],xtitle=xtitlePlot, YTITLE='F/Fcont',$
/nodata,XTICKFORMAT='(I6)',xstyle=9,ystyle=1,Position=PositionPlot,ytickinterval=1.0,xtickinterval=15.,yminor=4
plots,lobs,fobsheln,color=FSC_COLOR('black'),noclip=0
plots,lambda_vector,totalfluxfimsysn_19asub,noclip=0,color=FSC_COLOR('red'),linestyle=0
...
device,filename='/Users/jgroh/temp/vis_wavelength_comp_b12_19.ps',encapsulated=0,/color,bit=8,xsize=10*xwindowsize/ywindowsize,ysize=10,/inches
plot,lambda_vector,vis_triplet_wavelength_cnvl[0,*],yrange=[0,1.1],XTITLE=xtitlePlot, YTITLE='Visibility',$
/nodata,XTICKFORMAT='(I6)',xstyle=9,ystyle=1,Position=PositionPlot,ytickinterval=0.5,xtickinterval=15.,yminor=4
plots,vis12_ut.field1[2,*]*10000.,vis12_ut.field1[3,*],color=FSC_COLOR('black'),noclip=0
plots,lambda_vector_19asub,vis_triplet_wavelength_cnvl_19asub[0,*],noclip=0,color=FSC_COLOR('red'),linestyle=0
...
device,filename='/Users/jgroh/temp/vis_wavelength_comp_b23_19.ps',encapsulated=0,/color,bit=8,xsize=10*xwindowsize/ywindowsize,ysize=10,/inches
plot,lambda_vector,vis_triplet_wavelength_cnvl[0,*],yrange=[0,1.1],XTITLE=xtitlePlot, YTITLE='Visibility',$
/nodata,XTICKFORMAT='(I6)',xstyle=9,ystyle=1,Position=PositionPlot,ytickinterval=0.5,xtickinterval=15.,yminor=4
plots,vis23_ut.field1[2,*]*10000.,vis23_ut.field1[3,*],color=FSC_COLOR('black'),noclip=0
plots,lambda_vector_19asub,vis_triplet_wavelength_cnvl_19asub[1,*],noclip=0,color=FSC_COLOR('red'),linestyle=0
...
device,filename='/Users/jgroh/temp/vis_wavelength_comp_b31_19.ps',encapsulated=0,/color,bit=8,xsize=10*xwindowsize/ywindowsize,ysize=10,/inches
plot,lambda_vector,vis_triplet_wavelength_cnvl[0,*],yrange=[0,1.1],XTITLE=xtitlePlot, YTITLE='Visibility',$
/nodata,XTICKFORMAT='(I6)',xstyle=9,ystyle=1,Position=PositionPlot,ytickinterval=0.5,xtickinterval=15.,yminor=4
plots,vis31_ut.field1[2,*]*10000.,vis31_ut.field1[3,*],color=FSC_COLOR('black'),noclip=0
plots,lambda_vector_19asub,vis_triplet_wavelength_cnvl_19asub[2,*],noclip=0,color=FSC_COLOR('red'),linestyle=0
...
device,filename='/Users/jgroh/temp/phase_wavelength_comp_b23_19.ps',encapsulated=0,/color,bit=8,xsize=10*xwindowsize/ywindowsize,ysize=10,/inches
plot,lambda_vector,phase_triplet_wavelength_cnvl[0,*],yrange=[a,b],XTITLE=xtitlePlot, YTITLE='Differential phase (deg)',$
/nodata,XTICKFORMAT='(I6)',xstyle=9,ystyle=1,Position=PositionPlot,ytickinterval=50.,xtickinterval=15.,yminor=4
plots,phase23_ut.field1[2,*]*10000.,phase23_ut.field1[3,*],color=FSC_COLOR('black'),noclip=0
plots,lambda_vector_19asub,phase_triplet_wavelength_cnvl_19asub[1,*]+6.54,noclip=0,color=FSC_COLOR('red'),linestyle=0
...
device,filename='/Users/jgroh/temp/phase_wavelength_comp_b31_19.ps',encapsulated=0,/color,bit=8,xsize=10*xwindowsize/ywindowsize,ysize=10,/inches
plot,lambda_vector,phase_triplet_wavelength_cnvl[0,*],yrange=[a,b],XTITLE=xtitlePlot, YTITLE='Differential phase (deg)',$
/nodata,XTICKFORMAT='(I6)',xstyle=9,ystyle=1,Position=PositionPlot,ytickinterval=50.,xtickinterval=15.,yminor=4
plots,phase31_ut.field1[2,*]*10000.,phase31_ut.field1[3,*],color=FSC_COLOR('black'),noclip=0
plots,lambda_vector_19asub,phase_triplet_wavelength_cnvl_19asub[2,*]+7.87,noclip=0,color=FSC_COLOR('red'),linestyle=0
...
device,filename='/Users/jgroh/temp/cp_wavelength_comp_19.ps',encapsulated=0,/color,bit=8,xsize=10*xwindowsize/ywindowsize,ysize=10,/inches
plot,cp_ut.field1[2,*]*10000.,cp_ut.field1[3,*],yrange=[-190,190],XRANGE=[21645,21685],XTITLE=xtitlePlot, YTITLE='Closure phase (deg)',$
/nodata,XTICKFORMAT='(I6)',xstyle=9,ystyle=1,Position=PositionPlot,ytickinterval=100.,xtickinterval=15.,yminor=4
plots,cp_ut.field1[2,*]*10000.,cp_ut.field1[3,*],color=FSC_COLOR('black'),noclip=0
plots,lambda_vector_19asub,cp_triplet_wavelength_cnvl_19asub,noclip=0,color=FSC_COLOR('red'),linestyle=0

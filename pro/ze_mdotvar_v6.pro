...
rvdenclump1='/Users/jgroh/var_mdot/var_191regrid223_mdot8_222/rvdenclump_var_191_regrid_223_mdot8.txt'  
openu,1,rvdenclump1     ; open file without writing

;defines file rvdenclump2.txt
rvdenclump2='/Users/jgroh/var_mdot/var_191regrid223_mdot8_222/rvdenclump_222.txt'  
...
output='/Users/jgroh/var_mdot/var_191regrid223_mdot8_222/output_scratch.txt'  
openw,4,output     ; open file to write

;defines file mdotvinfflow.txt ; outputs Mdot, vinf and flowtime as a function of r
mdotvinfflow='/Users/jgroh/var_mdot/var_191regrid223_mdot8_222/mdotvinfflow_scratch.txt'  
...
vinft= 114.+(v2[0]-114.)/deltat * (deltat-flowtime[k])
endif
if (flowtime[k] gt deltat) and (flowtime[k] lt 329) then begin
vinft=321.9+(114.-321.9)/230 * (329-flowtime[k])
endif
vinft2=v1[0]+(v2[0]-v1[0])/329. * (329-flowtime[k])
;vinft= v1[0]+(v2[0]-v1[0])*exp(-(((deltat-flowtime[k])/deltat)-1))
vinf[k]=vinft
vinf2[k]=vinft2
if flowtime[k] gt 329 then begin
vinf[k]=v1[0]
vinf2[k]=v1[0]
endif
endfor
...
if (flowtime[k] gt deltat) and (flowtime[k] lt 329) then begin ;remember r1 here is r2 in the previous model
rstartt= 348.115+(r1[i-1]-348.115)/230 * (329-flowtime[k])
endif
rstart[k]=rstartt
if flowtime[k] gt 329 then begin
rstart[k]=348.115
...
if (flowtime[k] gt deltat) and (flowtime[k] lt 329) then begin
mdotout[k] = mdot1regrid[k]+((mdot2[k]-mdot1regrid[k])/230 * (329-flowtime[k]))
endif
if flowtime[k] gt 329 then begin 
...
;making psplots
set_plot,'ps'
device,filename='/Users/jgroh/var_mdot/var_191_regrid_223_mdot5/output.eps',/encapsulated,/color,bit=8,xsize=6.48,ysize=10.02,/inches
!p.multi=[0, 1, 5, 0, 0]
;flowtime
...
;write VM_FILE
ZE_WRITE_VM_FILE,rout,vout,sigmaout,denout,clumpout,i,'/Users/jgroh/var_mdot/var_191regrid223_mdot8_222/VM_FILE'  

;write RVSIG_COL
ZE_WRITE_RVSIG_COL,rout,vout,sigmaout,i,'/Users/jgroh/var_mdot/var_191regrid223_mdot8_222/RVSIG_COL'  

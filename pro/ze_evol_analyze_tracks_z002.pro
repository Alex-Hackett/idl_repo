;PRO ZE_EVOL_ANALYZE_TRACKS_Z002
;analyze and plot tracks for metalicity Z=0.002, suitable for SMC
...
ZE_EVOL_PLOT_XY_GENERAL_EPS_V4,xtt120,xl120,'Log Temperature (K) ','Log Luminosity (Lsun)','Z=0.002, no rot.',z1=nh120,x2=xtt85,y2=xl85,z2=nh85,x3=xtt40,y3=xl40,z3=nh40,x4=xtt32,y4=xl32,z4=nh32,x5=xtt25,y5=xl25,z5=nh25,x6=xtt20,y6=xl20,z6=nh20,x7=xtt12,y7=xl12,z7=nh12,x8=xtt60,y8=xl60,z8=nh60,$
...
;for paper
ZE_EVOL_PLOT_XY_GENERAL_EPS_V4,xtt1204,xl1204,'Log Temperature (K) ','Log Luminosity (Lsun)','Z=0.002,rot.',x2=xtt854,y2=xl854,x3=xtt404,y3=xl404,x4=xtt324,y4=xl324,x5=xtt254,y5=xl254,x6=xtt204,y6=xl204,$
                              x7=xtt124,y7=xl124,x8=xtt604,y8=xl604,x9=xtt154,y9=xl154,x10=xtt094,y10=xl094,$;x11=xtt074,y11=xl074,z_11=nh074,$
                              minz=6.25,maxz=7.75,rebin=1,xrange=[5.5,3.41],yrange=[3.41,6.83],xreverse=0,_EXTRA=extra,ct=33,$
                              factor1=4,factor2=4,factor_10=1,factor_11=1

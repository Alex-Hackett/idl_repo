...
PRO ZE_PRINT_SPECTRA_EPS_OPT_86_90_COLOR,lambda86jun1,flux86jun1,lambda87jan1,flux87jan1,lambda87jan2,flux87jan2,lambda87jun1,flux87jun1,$
...
set_plot,'ps'
device,filename='/aux/pc20072b/jgroh/temp/output_opt_color.eps',/encapsulated,/color,bit=8,xsize=6.48,ysize=8.48,/inches
!X.OMARGIN=[4.5,0.5]
!Y.OMARGIN=[0.5,0.5]
!p.multi=[0, 3, 4, 0, 0]
!X.THICK=1.7
...
plots,lambda86jun1,flux86jun1,color=fsc_color('black'),noclip=0,clip=[x1l,0,x1u,13],thick=2
;plots,l362narv,f362narv,color=fsc_color('white',!d.table_size-10), noclip=0,clip=[x1l,0,x1u,13],linestyle=1,thick=2
;plots,l223narv,f223narv,color=fsc_color('white',!d.table_size-10), noclip=0,clip=[x1l,0,x1u,13],linestyle=0,thick=2
...
plots,lambda86jun1-0.2,flux86jun1,color=fsc_color('black'),noclip=0,clip=[x2l,0,x2u,13],thick=2
;plots,l362narv,f362narv,color=fsc_color('white'), noclip=0,clip=[x2l,0,x2u,13],linestyle=1,thick=2
;plots,l358narv,f358narv,color=fsc_color('white'), noclip=0,clip=[x2l,0,x2u,13],linestyle=0,thick=2
...
/nodata,charsize=c1,XMARGIN=[5/c1,3/c1],YMARGIN=[5/c1,3/c1],XTICKINTERVAL=10.,charthick=charthickv
plots,lambda87jan1,flux87jan1,color=fsc_color('black'),noclip=0,clip=[x1l,0,x1u,13],thick=2
;plots,l362narv,f362narv,color=fsc_color('white',!d.table_size-10), noclip=0,clip=[x1l,0,x1u,13],linestyle=1,thick=2
;plots,l223narv,f223narv,color=fsc_color('white',!d.table_size-10), noclip=0,clip=[x1l,0,x1u,13],linestyle=0,thick=2
;plots,l391narv,f391narv,color=fsc_color('white',!d.table_size-10), noclip=0,clip=[x1l,0,x1u,13],linestyle=1,thick=2
...
ytitle='F/F!Ic',/nodata,charsize=c1,XMARGIN=[5/c1,3/c1],YMARGIN=[5/c1,3/c1],XTICKINTERVAL=10.,charthick=charthickv
plots,lambda87jan2-0.1,flux87jan2,color=fsc_color('black'),noclip=0,clip=[x2l,0,x2u,13],thick=2
;plots,l223narv,f223narv,color=fsc_color('white'), noclip=0,clip=[x2l,0,x2u,13],linestyle=1,thick=2
;plots,l223narv,f223narv,color=fsc_color('white',!d.table_size-10), noclip=0,clip=[x2l,0,x2u,13],linestyle=0,thick=2
...
plots,lambda87jun1+0.1,flux87jun1,color=fsc_color('black'),noclip=0,clip=[x3l,0.75,x3u,1.4],thick=2
;plots,l362narv,f362narv,color=fsc_color('white',!d.table_size-10), noclip=0,clip=[x3l,0.75,x3u,1.4],linestyle=1,thick=2
;plots,l367narv,f367narv/1.05,color=fsc_color('white',!d.table_size-10), noclip=0,clip=[x3l,0.75,x3u,1.4],linestyle=0,thick=2
...
/nodata,charsize=c1,XMARGIN=[5/c1,3/c1],YMARGIN=[5/c1,3/c1],XTICKINTERVAL=10.,charthick=charthickv
plots,lambda87jun2-0.1,flux87jun2,color=fsc_color('black'),noclip=0,clip=[x2l,0,x2u,13],thick=2
;plots,l223narv,f223narv,color=fsc_color('white'), noclip=0,clip=[x2l,0,x2u,13],linestyle=1,thick=2
;plots,l223narv,f223narv,color=fsc_color('white'), noclip=0,clip=[x2l,0,x2u,13],linestyle=0,thick=2
...
plots,lambda89mar1-0.15,flux89mar1,color=fsc_color('black'),noclip=0,clip=[x7l,0,x7u,13],thick=2
;plots,l223narv,f223narv,color=fsc_color('white'), noclip=0,clip=[x7l,0,x7u,13],linestyle=0,thick=2
plots,l367narv,t/1.05,color=fsc_color('white'), noclip=0,clip=[x7l,0,x7u,13],linestyle=0,thick=2
...
;plots,lambda89mar1,flux89mar1,color=fsc_color('black'),noclip=0,clip=[x8l,0,x8u,13],thick=2
plots,lambda89mar1-0.15,flux89mar1,color=fsc_color('black'),noclip=0,clip=[x8l,0,x8u,13],thick=2
;plots,l223narv,f223narv,color=fsc_color('white'), noclip=0,clip=[x8l,0,x8u,13],linestyle=0,thick=2
plots,l367narv,t,color=fsc_color('white'), noclip=0,clip=[x8l,0,x8u,13],linestyle=0,thick=2
...
plots,lambda89mar1-0.5,flux89mar1,color=fsc_color('black'),noclip=0,clip=[x9l,0,x9u,13],thick=2
;plots,l223narv,f223narv,color=fsc_color('white'), noclip=0,clip=[x9l,0,x9u,13],linestyle=1,thick=2
plots,l367narv,t,color=fsc_color('white'), noclip=0,clip=[x9l,0,x9u,13],linestyle=0,thick=2

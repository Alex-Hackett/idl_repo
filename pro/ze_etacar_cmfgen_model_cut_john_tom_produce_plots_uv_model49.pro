;PRO ZE_ETACAR_CMFGEN_MODEL_CUT_JOHN_TOM_PRODUCE_PLOTS_UV_MODEL49
close,/all
!P.MULTI=0
...
xyouts,1277,0.40e-11/s,TEXTOIDL('obs \phi_{orb}=10.603 '),alignment=0,orientation=0,charsize=0.8

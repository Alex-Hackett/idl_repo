;PRO ZE_EVOL_ANALYZE_TRACKS_Z014_LBV_SN_PROGENITOR
...
xyouts,0.77,0.26,'Z=0.014',/NORMAL,color=fsc_color('black')
xyouts,0.77,0.22,TEXTOIDL('v_{rot}/v_{crit}=0.4'),/NORMAL,color=fsc_color('black')
...
xyouts,3.65,5.08,'(RSG)',/DATA,color=fsc_color('red')

;PRO ZE_ETACAR_CMFGEN_MODEL_CUT_JOHN_COMPARE_MODELS_OPENING_ANGLE_ALPHA
close,/all
...
x1u=6590
s98mar=3.06e-12
plot,lm1,fm1n,xstyle=1,ystyle=1,xrange=[x1l-2,x1u+2],yrange=[0.1,70],xcharsize=2.0,ytickinterval=10,ycharsize=2.0,thick=3.5,xthick=3.5,ythick=3.5,$
/nodata,POSITION=[0.11,0.25,0.96,0.96]
plots,lambda_17apr01,flux_17apr01n,color=color0,linestyle=0,noclip=0,clip=[x1l,0,x1u,39.5e-11/s98mar],thick=b+1.5
...
/nodata,POSITION=[0.11,0.25,0.96,0.96]
plots,lambda_17apr01,flux_17apr01n,color=color0,linestyle=0,noclip=0,clip=[x1l,0,x1u,10],thick=b+1.5

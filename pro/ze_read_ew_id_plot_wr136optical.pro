...
ewdata='/home/groh/espectros/wr136/ewdata_18fined136'  
openu,1,ewdata     ; open file without writing

;defines observed FUSE file
obsfuse='/home/groh/espectros/wr136/wr136_hamman.txt'  
...
;defines model file
model='/home/groh/espectros/wr136/wr136_20_nar.txt'  
...
if (lambdac[l] gt 3470) and (lambdac[l] lt 11280) and (abs(ew[l]) gt 5.00) then begin
...
plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x1l,x1u],yrange=[0,12],xtitle='wavelength (Angstrom)',$
ytitle='Normalized Flux',/nodata
plots,lambdafuse,fluxfuse,color=fsc_color('grey'),noclip=0,clip=[x1l,0,x1u,12]
plots,lambdamod,fluxmod,color=fsc_color('black',!d.table_size-10), noclip=0,clip=[x1l,0,x1u,12]
...
xyouts,lambdac[l],11,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90
endif
...
plots,lambdamod,fluxmod,color=fsc_color('black'), noclip=0,clip=[x2l,0,x2u,7]
for l=0, i-1 do begin
...
;making psplots
set_plot,'ps'
device,filename='/home/groh/espectros/wr136/output_opt.eps',/encapsulated,/color,bit=8,xsize=6.48,ysize=8.48,/inches
!p.multi=[0, 1, 3, 0, 0]

;1st panel, 925--1160 Angstrom

plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x1l,x1u],yrange=[0,15],xtitle='wavelength (Angstrom)',$
ytitle='Normalized Flux',/nodata,charsize=2
plots,lambdafuse,fluxfuse,color=fsc_color('black'),noclip=0,clip=[x1l,0,x1u,13]
plots,lambdamod,fluxmod,color=fsc_color('red',!d.table_size-10), noclip=0,clip=[x1l,0,x1u,13],linestyle=1,thick=3.5
...
if ((sobc[l] ne 'FeV') && (sobc[l] ne 'FeVI')) then begin ;colocando apenas um traco nas transicoes do FeV,normal para os outros.
xyouts,lambdac[l]+14,11.5,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90
endif
if (sobc[l] eq '  FeV') then begin
xyouts,lambdac[l],6,'!3'+string(45B),alignment=0.5,orientation=90
endif
...
plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x2l,x2u],yrange=[0,7.5],xtitle='wavelength (Angstrom)', ytitle='Normalized Flux',/nodata,charsize=2
plots,lambdafuse,fluxfuse,color=fsc_color('black'),noclip=0,clip=[x2l,0,x2u,7]
plots,lambdamod,fluxmod,color=fsc_color('red'), noclip=0,clip=[x2l,0,x2u,7],linestyle=1,thick=3.5
for l=0, i-1 do begin
if (lambdac[l] gt x2l) and (lambdac[l] lt x2u) and (abs(ew[l]) gt 4.00) then begin
pos=strpos(strtrim(sob[l],1),'(')
sobc[l]=strmid(sob[l],4,pos)
if ((sobc[l] ne 'FeV') && (sobc[l] ne 'FeVI')) then begin ;colocando apenas um traco nas transicoes do FeV,normal para os outros.
xyouts,lambdac[l],6e,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90
...
plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x3l,x3u],yrange=[0,8],xtitle='wavelength (Angstrom)', ytitle='Normalized Flux',/nodata,charsize=2
plots,lambdafuse,fluxfuse,color=fsc_color('black'), noclip=0,clip=[x3l,0,x3u,7]
plots,lambdamod,fluxmod,color=fsc_color('red'), noclip=0,clip=[x3l,0,x3u,7],linestyle=1,thick=3.5
for l=0, i-1 do begin
if (lambdac[l] gt x3l) and (lambdac[l] lt x3u) and (abs(ew[l]) gt 4.00) then begin
pos=strpos(strtrim(sob[l],1),'(')
sobc[l]=strmid(sob[l],4,pos)
if ((sobc[l] ne 'FeV') && (sobc[l] ne 'FeVI')) then begin ;colocando apenas um traco nas transicoes do FeV,normal para os outros.
xyouts,lambdac[l],6e,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90

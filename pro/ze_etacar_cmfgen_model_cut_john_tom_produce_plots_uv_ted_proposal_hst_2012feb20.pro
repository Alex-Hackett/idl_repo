;PRO ZE_ETACAR_CMFGEN_MODEL_CUT_JOHN_TOM_PRODUCE_PLOTS_UV_TED_PROPOSAL_HST_2012FEB20
close,/all
!P.MULTI=0
...
model='cut_v4_vstream'   ;b,c,o,r,t,u,v don't cover the UV range
sufix='d' ;opening angle 50.4 degrees
...
ZE_CMFGEN_READ_OBS,'/Users/jgroh/ze_models/etacar/mod7_groh/obs/obs_fin',lambdamod2,fluxmod2,num_rec,/flam




;CHANGED HERE 2012FEB20 to read another spherical model to replace cavity model for Ted's proposal
;ZE_CMFGEN_READ_OBS,'/Users/jgroh/ze_models/etacar/mod7_groh/obs/obs_fin',lmcav,fmcav,num_rec,/flam
...
xyouts,1277,0.32e-11/s,TEXTOIDL('1D CMFGEN model Mdot 4x lower'),alignment=0,orientation=0,color=colorm2,charsize=0.8
plots, [1270,1275],[0.25e-11/s,0.25e-11/s],color=colorm,thick=b+1.5
xyouts,1277,0.24e-11/s,TEXTOIDL('2D cavity model Groh+ 2012'),alignment=0,orientation=0,color=colorm,charsize=0.8
...
plots,lmcav,fmcavd23r/s/scale/1.0,color=colorm,linestyle=lm, noclip=0,clip=[x5l,0,x5u,1.3e-11/s],thick=b+1.5

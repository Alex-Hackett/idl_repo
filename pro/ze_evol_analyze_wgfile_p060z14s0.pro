;PRO ZE_EVOL_ANALYZE_WGFILE_P060z14S0
...
timesteps=[56,500,1000,1750,2500,3000,3500,3800,4050,4200,4301,4379,4441,4501,4701,4717,4723,4729,4730,4732,4733,4734,4736,4800,4900,5000,5100,5200,5300,5308,5360,5375,5404,5430,5442,5460,5500,5601,5820,6250,6551,6870,7027,7201,7577,8201,10131,11201,12551,14951,18950.,21950.,22251,22271,23950]
timesteps_completed=[56,500,1000,1750,2500,3000,3500,3800,4301,4379,4501,4701,4717,4723,4729,5375,5404,5500,5601,5820,6250,6551,6870,7201,8201,10131,11201,12551,14951,18950.,21950,22251,22271,23950]
;i=3800 ;timestep
...
ZE_EVOL_PLOT_XY_GENERAL_EPS_V2,xte60,xl60,'xte','xl',label,z1=xmdot60,pointsx2=alog10(tstar_array),pointsy2=alog10(lstar_array),labelz='xmdot',$
                              minz=-6,maxz=-3,rebin=1,xreverse=1,_EXTRA=extra,timesteps=timesteps,YRANGE=[5.4,6.2],xrange=[5.45,3.75]                              
...
ZE_EVOL_PLOT_XY_GENERAL_EPS_V2,10^xte60,10^xl60,'lin xte','lin xl',label,z1=xmdot60,pointsx2=tstar_array,pointsy2=lstar_array,labelz='xmdot',$
                              minz=-6,maxz=-3,rebin=1,xreverse=1,_EXTRA=extra,timesteps=timesteps,YRANGE=[10^5.4,10^6.2],xrange=[100000,8000]  
...
ZE_EVOL_PLOT_XY_GENERAL_EPS_V2,xte60,xl60,'xte','xl',label+' completed',z1=xmdot60,pointsx2=alog10(teff_array),pointsy2=alog10(lstar_array),labelz='xmdot',$
                              minz=-6,maxz=-3,rebin=1,xreverse=1,_EXTRA=extra,timesteps=timesteps_completed,YRANGE=[5.4,6.2] ,xrange=[5.45,3.75]   
...
ZE_EVOL_WRITE_INPUT_TO_CMFGEN_VADAT_FORMAT,j,u160[j],u260[j],xte60[j],xtt60[j],xl60[j],rstar60[j],logg60[j],xmdot60[j],vinf60[j],beta,$
                                           u560[j],u760[j],u860[j],u1060[j],u1260[j],u660[j],evol_vadat_file,model,popscl=0               

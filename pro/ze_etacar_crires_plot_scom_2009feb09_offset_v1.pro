;PRO ZE_ETACAR_CRIRES_PLOT_SCOM_2009FEB09_OFFSET_V1,grat_angle,det,pos,star_center_calib
...
xnodes_spec_Ext=0
ynodes_spec_ext=0
gratdet='2009feb09_'+strcompress(string(grat_angle, format='(I04)'))+'_'+strcompress(string(det, format='(I01)'))+'_offset'+strcompress(string(pos, format='(I01)'))
gratdet_orig=gratdet ;in order to keep info of the original gratdet, to write the files correctly.
gratdetonstar='2009feb09_'+strcompress(string(grat_angle, format='(I04)'))+'_'+strcompress(string(det, format='(I01)'))
...
dirrun='/Users/jgroh/data/eso_vlt/crires/Etacar/282D-5043B_2009Feb09/'
...
dirsciraw=dircriresrun+'352647/sci_raw/'
dircal='/Users/jgroh/data/eso_vlt/crires/Etacar/383D-0240A_2009Apr03/361942/cal_proc/' ;calibrator from april 2009
...
skyima=dirsciraw+'CRIRE.2009-02-09T06_23_22.999.fits'
astrometry_ref_image=dirsciraw+'CRIRE.2009-02-09T06_13_55.131.fits' ;last exposure on star, to measure y offset
...
CASE pos OF 
4:  scoma=dirsciraw+'CRIRE.2009-02-09T06_15_25.107.fits'
5:  scoma=dirsciraw+'CRIRE.2009-02-09T06_16_44.352.fits'  
6:  scoma=dirsciraw+'CRIRE.2009-02-09T06_18_04.303.fits' 
3:  scoma=dirsciraw+'CRIRE.2009-02-09T06_19_21.391.fits'  
2:  scoma=dirsciraw+'CRIRE.2009-02-09T06_20_40.256.fits'  
1:  scoma=dirsciraw+'CRIRE.2009-02-09T06_22_01.603.fits'  
7:  scoma=dirsciraw+'CRIRE.2009-02-09T06_23_22.999.fits' ;sky
8:  scoma=dirsciraw+'CRIRE.2009-02-09T06_13_55.131.fits' ;last exposure on star, to measure y offset
9:  scoma=dirsciraw+'CRIRE.2009-02-09T06_12_38.858.fits' ;first exposure on star, to measure y offset
ENDCASE 
    END
...
lambda0=1.08333
restore,'/Users/jgroh/espectros/etc_poly_wavecal_2009apr03_1090_'+strcompress(string(det, format='(I01)'))+'_line_auto_lamp_2d.sav'
lamvalues_Allpix_tel=lamvalues_Allpix
undefine,lamvalues_Allpix
restore,'/Users/jgroh/espectros/etc_poly_wavecal_'+gratdet+'_line_auto_lamp_2d.sav'
;skyima=dirsciraw+'CRIRE.2009-01-08T07_42_07.890.fits' 
skyima=dirsciraw+'CRIRE.2009-02-09T06_23_22.999.fits';using sky image from 1087 as a test
astrometry_ref_image=dirsciraw+'CRIRE.2009-02-09T06_34_00.962.fits' ;last exposure on star, to measure y offset
astrometry_ref_image=dirsciraw+'CRIRE.2009-02-09T06_13_55.131.fits' ;last exposure on star, to measure y offset
CASE pos OF 
4:  scoma=dirsciraw+'CRIRE.2009-02-09T06_36_40.328.fits'
5:  scoma=dirsciraw+'CRIRE.2009-02-09T06_37_57.028.fits'  
6:  scoma=dirsciraw+'CRIRE.2009-02-09T06_39_15.353.fits'  
3:  scoma=dirsciraw+'CRIRE.2009-02-09T06_40_34.993.fits'  
2:  scoma=dirsciraw+'CRIRE.2009-02-09T06_41_53.526.fits'  
1:  scoma=dirsciraw+'CRIRE.2009-02-09T06_43_16.552.fits'  
7:  scoma=dirsciraw+'CRIRE.2009-01-08T07_42_07.890.fits'
8:  scoma=dirsciraw+'CRIRE.2009-02-09T06_34_00.962.fits' ;last exposure on star, to measure y offset
9:  scoma=dirsciraw+'CRIRE.2009-02-09T06_32_42.488.fits' ;first exposure on star, to measure y offset  
ENDCASE
    END

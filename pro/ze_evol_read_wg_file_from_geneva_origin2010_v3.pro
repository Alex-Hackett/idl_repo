PRO ZE_EVOL_READ_WG_FILE_FROM_GENEVA_ORIGIN2010_V3,wgfile,data_wgfile,data_wgfile_cut,$
...
savedfile='/Users/jgroh/temp/'+modelsufix+'.sav'
;savedfile = '~/_PopIIIProject/geneva_code/P015d010_tmp/P015d010.sav'
...
;compress not working properly WORK IN ZE_READ_ASCII.PRO
  ...
  ENDIF ELSE BEGIN
    ...
    ;cd, '/Users/jgroh/evol_models/Grids2010/wg'
  ...
  save,wgfile,data_wgfile_cut,timestep_ini,timestep_fin,filename='/Users/jgroh/temp/'+modelsufix+'.sav'
  
ENDIF ELSE BEGIN
  print,'A .sav corresponding to model '+ modelsufix+' has been found in /Users/jgroh/temp. Loading...'
  restore,savedfile
ENDELSE   
END

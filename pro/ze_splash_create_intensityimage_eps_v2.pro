PRO ZE_SPLASH_CREATE_INTENSITYIMAGE_EPS_V2,pa,circ_griddedData=circ_griddedData,circxvector=circxvector,circyvector=circyvector

ZE_SPLASH_COMPUTE_IMAGE_I_P_DELTA_LAMBDA_v2,circxvector=circxvector,circyvector=circyvector,circ_griddedData=circ_griddedData

PRO ZE_CREATE_IDENT_PLOT_TELURIC,ltel,ftel,grat_angle,det,linelist_file
cs=1.7
ct=2.5
...
XYOUTS,0.5,0.9,'Telluric line identification for grating '+strcompress(string(grat_angle, format='(I04)'))+', detector'+strcompress(string(det, format='(I01)')),align=0.5,charsize=3,/NORMAL
...
END
WRITE_PNG, '/Users/jgroh/espectros/telluriclines_air_list_'+strcompress(string(grat_angle, format='(I04)'))+'_'+strcompress(string(det, format='(I01)'))+'.png', TVRD(True=1)
!P.CHARSIZE=0
!P.CHARTHICK=0

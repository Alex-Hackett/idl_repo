PRO ZE_AMBER_INTERPOLATE_QUANTITY_SAME_LAMBDA_GRID_CREATE_SURFACE_IMAGE_V2, z_array,x_array,y_array,npix,nspec,column,reference_dataset_line,x1,x2,y1,y2,a,b,x_array_out,z_array_out,image_surface

;v2 tries to interpolate in regular grid in phase before doing the surface image ; time consuming, should use TRIGRID instead...

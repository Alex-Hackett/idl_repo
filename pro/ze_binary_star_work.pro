...
phi_periastron=0.0
M_vector=2*!PI*(phi_vector-phi_periastron)
e=0.0
eccanom_vector=keplereq(M_vector,e)
omega_val=0.0*!PI/180.0
inc_val=0.0*!PI/180.0
phase_angle_vector=eccanom_vector+omega_val-!PI/2.0
phase_angle_vector_deg=phase_angle_vector*180.0/!PI
cone_inc=90.0-ACOS((COS(phase_angle_vector)*SIN(inc_val)))*180.0/!PI
window,0
!P.Background = fsc_color('white')
!P.Color = fsc_color('black')
 orbitplot,eccen=0.9,a=a,omega=90.0,lonasc=45.0,units=textoidl('AU'), $
...
omega2=270.
 ...
 orbitplot,eccen=e2,a=a2,omega=omega2,incl=0*!PI/180.,units=textoidl('AU'), $
   starrad=0.2,/degrees,/periastron,starname=' ', $
   position=[0.11,0.11,0.97,0.97],space=0.19,phase1=0.25,phase2=0.3,orbitcol=fsc_color('red'),/oplot
 orbitplot,eccen=e2,a=a2,omega=omega2,incl=0*!PI/180.,units=textoidl('AU'), $
   starrad=0.2,/degrees,/periastron,starname=' ', $
   position=[0.11,0.11,0.97,0.97],space=0.19,phase1=0.92,phase2=0.98,orbitcol=fsc_color('green'),/oplot
...
device,filename='/Users/jgroh/temp/etacar_wind_eclipse_sketch.eps',/encapsulated,/color,bit=8,xsize=width,ysize=width*ysize/xsize,/inches
LOADCT,0

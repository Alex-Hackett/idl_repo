;PRO ZE_ETACAR_CMFGEN_MODEL_CUT_JOHN_COMPARE_MODELS_INCLINATION_WALL_VPROPOSAL
close,/all
...
!P.thick=3.7*2
!p.charthick=3.5*2
a=2.0*2 ;line thick obs
b=3.5*2 ;line thick model
...
x1u=6592
s98mar=3.06e-12
plot,lm00,fn00,xstyle=1,ystyle=1,xrange=[x1l,x1u],yrange=[0.0,50],xcharsize=2.0,ytickinterval=10,ycharsize=2.0,$
...
plots,lm00,fn00,color=colorm1,linestyle=0,noclip=0,clip=[x1l,0,x1u,39.5e-11/s98mar],thick=b+1.5
plots,lm00,fn00,color=colorm2,linestyle=2,noclip=0,clip=[x1l,0,x1u,39.5e-11/s98mar],thick=b+1.5
...
plots,lm41,fn41,color=colorm5,linestyle=0,noclip=0,clip=[x1l,0,x1u,39.5e-11/s98mar],thick=b+1.5
...
plots,lm50,fn50,color=colorm8,linestyle=2,noclip=0,clip=[x1l,0,x1u,39.5e-11/s98mar],thick=b+1.5
...
;optmized labels
xyouts,3700,7500,TEXTOIDL('\omega=0^\circ'),charthick=3.5,color=colorm1,orientation=0,/DEVICE
xyouts,3700,7000,TEXTOIDL('\omega=180^\circ'),charthick=3.5,color=colorm2,orientation=0,/DEVICE
...
xyouts,3700,6500,TEXTOIDL('\omega=220^\circ'),charthick=3.5,color=colorm5,orientation=0,/DEVICE
...
xyouts,3700,6000,TEXTOIDL('\omega=270^\circ'),charthick=3.5,color=colorm8,orientation=0,/DEVICE
...
device,filename='/Users/jgroh/temp/etc_cmfgen_mod111_plus_cavity_compare_models_halpha_emiss_omega'+model00+'_wall.eps',/encapsulated,/color,bit=8,xsize=8.48,ysize=3.48,/inches
...
;plots,lm36,fn36,color=colorm3,linestyle=2,noclip=0,clip=[x1l,0,x1u,39.5e-11/s98mar],thick=b+1.5
;plots,lm41,fn41,color=colorm4,linestyle=3,noclip=0,clip=[x1l,0,x1u,39.5e-11/s98mar],thick=b+1.5
plots,lm50,fn50,color=colorm5,linestyle=0,noclip=0,clip=[x1l,0,x1u,39.5e-11/s98mar],thick=b+1.5
;plots,lm60,fn60,color=colorm6,linestyle=2,noclip=0,clip=[x1l,0,x1u,39.5e-11/s98mar],thick=b+1.5
;plots,lm75,fn75,color=colorm7,linestyle=2,noclip=0,clip=[x1l,0,x1u,39.5e-11/s98mar],thick=b+1.5
...
;xyouts,2700,6500,model36+extra_label36,charthick=3.5,color=colorm3,orientation=0,/DEVICE
;xyouts,2700,6000,model41+extra_label41,charthick=3.5,color=colorm4,orientation=0,/DEVICE
xyouts,2700,6500,model30+extra_label50,charthick=3.5,color=colorm5,orientation=0,/DEVICE
;xyouts,2700,5000,model30+extra_label60,charthick=3.5,color=colorm6,orientation=0,/DEVICE
;xyouts,2700,4500,model30+extra_label75,charthick=3.5,color=colorm7,orientation=0,/DEVICE
xyouts,2700,6000,model30+extra_label90,charthick=3.5,color=colorm8,orientation=0,/DEVICE

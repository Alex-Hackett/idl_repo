;PRO ZE_CMFGEN_EVOL_WORK_SUPERNOVA_PROGENITORS_RSG_V2
...
model_array_rot_rsgl=['s3400_g+0.0_m5.0_t02_hc_z+0.00_a+0.00_c-0.38_n+0.53_o+0.00_r+0.00_s+0.00','s3400_g+0.0_m5.0_t02_hc_z+0.00_a+0.00_c-0.38_n+0.53_o+0.00_r+0.00_s+0.00','s3600_g+0.0_m5.0_t02_hc_z+0.00_a+0.00_c-0.38_n+0.53_o+0.00_r+0.00_s+0.00']
model_array_rot_rsgu=['s3600_g+0.0_m5.0_t02_hc_z+0.00_a+0.00_c-0.38_n+0.53_o+0.00_r+0.00_s+0.00','s3600_g+0.0_m5.0_t02_hc_z+0.00_a+0.00_c-0.38_n+0.53_o+0.00_r+0.00_s+0.00','s3800_g+0.0_m5.0_t02_hc_z+0.00_a+0.00_c-0.38_n+0.53_o+0.00_r+0.00_s+0.00']

evolmass_array_rot_rsg=[9,12,15]
evollstar_array_rot_rsg=[42780.,72655.,121441.];;actual values that we want to find interpolated magnitudes and bcs
evoltstar_array_rot_rsg=[3528.,3550.,3623.] ;actual values that we want to find interpolated magnitudes and bcs
...
evolmass_array_norot_rsg=[9,12,15,20]
evollstar_array_norot_rsg=[39441.,46259.,79999.,152236.];actual values that we want to find interpolated magnitudes and bcs
evoltstar_array_norot_rsg=[3480.,3556.,3571.,3741.] ;actual values that we want to find interpolated magnitudes and bcs
...
sntype_array_rot_rsg=['II-Prot','II-P','II-P']  
sntype_array_norot_rsg=['II-P','II-P','II-P','II-P']  

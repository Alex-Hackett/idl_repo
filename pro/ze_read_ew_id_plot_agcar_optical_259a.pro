...
obsfuse='/home/groh/espectros/agcar/agcar_uves_03jan11_30a36n.txt'  
...
if (lambdamod1 gt 3000.0) then begin 
...
if (lambdac[l] gt 3200) and (lambdac[l] lt 3780) and (abs(ew[l]) gt 0.10) then begin
...
max1=1.9
plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x1l,x1u],yrange=[0,max1],xtitle='wavelength (Angstrom)',$
...
if ((sobc[l] ne 'FeII') && (sobc[l] ne 'FeVI')) then begin ;colocando apenas um traco nas transicoes do FeV,normal para os outros.
xyouts,lambdac[l]+2,max1-0.3,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90
endif
if (sobc[l] eq 'FeII') then begin
xyouts,lambdac[l]+1.5,max1-0.16,'!3'+string(45B)+string(45B),alignment=0.5,orientation=90
endif
if(sobc[l] eq '  FeVI') then begin
xyouts,lambdac[l],8,'!3'+string(45B),alignment=0.5,orientation=90
endif
...
sobc[l]=strmid(sob[l],4,pos)
if ((sobc[l] ne 'FeII') && (sobc[l] ne 'FeVI')) then begin ;colocando apenas um traco nas transicoes do FeV,normal para os outros.
xyouts,lambdac[l]+2,max2-0.3,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90
endif
if (sobc[l] eq 'FeII') then begin
xyouts,lambdac[l]+1.5,max2-0.16,'!3'+string(45B)+string(45B),alignment=0.5,orientation=90
endif
if(sobc[l] eq '  FeVI') then begin
xyouts,lambdac[l],8,'!3'+string(45B),alignment=0.5,orientation=90
endif
...
;3rd panel
max3=2.0
plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x3l,x3u],yrange=[0.5,max3],xtitle='wavelength (Angstrom)', ytitle='Normalized Flux',/nodata,charsize=2
plots,lambdafuse,fluxfuse,color=fsc_color('black'), noclip=0,clip=[x3l,0.5,x3u,7]
plots,lambdamod,fluxmod,color=fsc_color('red'), noclip=0,clip=[x3l,0.5,x3u,7],linestyle=1,thick=3.5
for l=0, i-1 do begin
...
xyouts,lambdac[l]+2.3,max2-0.15,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90
endif
if (sobc[l] eq 'HI') then begin
xyouts,lambdac[l]+1.8,max2-0.07,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90
endif
if(sobc[l] eq '  FeVI') then begin
xyouts,lambdac[l],8,'!3'+string(45B),alignment=0.5,orientation=90
endif

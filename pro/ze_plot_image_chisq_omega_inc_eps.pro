PRO ZE_PLOT_IMAGE_chisq_omega_inc_EPS,label,values,img,a,b,c,imgname,circxvector,circyvector,aa,bb,title,VEL=vel,INV=inv,CONT=cont
title=''
set_plot,'x'
...
IF label eq 'a)' OR label eq 'c)' OR label eq 'd)' OR label eq 'f)' THEN xyouts,0.06,0.035,TEXTOIDL('\chi^2_{red}'),/NORMAL,color=fsc_color('black'),charsize=3.5,charthick=12 ELSE BEGIN 
xyouts,0.045,0.07,TEXTOIDL('CP'),/NORMAL,color=fsc_color('black'),charsize=3.5,charthick=12
xyouts,0.015,0.015,TEXTOIDL('[deg]'),/NORMAL,color=fsc_color('black'),charsize=3.5,charthick=12

...
rvdenclump2='/Users/jgroh/ze_models/timedep_armagh/1/rvdenclump.txt'
...
;;velocity plots
!P.Background = fsc_color('black120')
...
;write VM_FILE
ZE_WRITE_VM_FILE,rout,vout,sigmaout,denout,clumpout,i,'/Users/jgroh/temp/VM_FILE'  

;write RVSIG_COL
ZE_WRITE_RVSIG_COL,rout,vout,sigmaout,i,'/Users/jgroh/temp/RVSIG_COL'  
...
;READCOL,'/Users/jgroh/temp/t/rvs3.txt',rrev,vrev,sigmarev
...
;
;;write VM_FILE
;ZE_WRITE_VM_FILE,rrev,vrev,sigmarev,denoutrev,clumpoutrev,ndrev,'/Users/jgroh/temp/VM_FILE'  
;
;;write RVSIG_COL
;ZE_WRITE_RVSIG_COL,rrev,vrev,sigmarev,ndrev,'/Users/jgroh/temp/RVSIG_COL'  

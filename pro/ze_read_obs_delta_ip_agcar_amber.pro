...
PRO ZE_COMPUTE_IMAGE_I_P_DELTA_LAMBDA,pa,rstar,dist,lambda_val,lambda0,lambda,np,ndelta1,nos,ipdelta,p,delta1_vec,x,y,intens2d_lambda=intens2d_lambda,$
...
factor=0.42;                                                      ;BEST for IRC 10420 vis is factor=1.18 for p=p-1, pix=1027 (DO NOT CHANGE THAT! INTENSIVE TESTS WERE MADE!)
pix=1027.                                                          ; BEST 1027 
...
dir='/Users/jgroh/ze_models/2D_models/agcar/'
model='423_fineob'
...
;sufix=''
;model='1'
filename_ipdata_txt=dir+model+'/'+model2d+'/IP_DELTA_DATA'             ;correct IP_DELTA
...
Base_obs_irc10420_ut=[14.27,28.51,42.78]
...
lambda0=20893.8    ; Br gamma
lambda_ini=20875   ;initial lambda to do calculations 21610
lambda_fin=20915    ;initial lambda to do calculations 21720
...
ZE_COMPUTE_IMAGE_I_P_DELTA_LAMBDA,pa,rstar,dist,lambda_val,lambda0,lambda,np,ndelta1,nos,ipdelta,p,delta1_vec,x,y,intens2d_lambda=intens2d_lambda,$
circxvector=circxvector,circyvector=circyvector,circ_griddedData=circ_griddedData,circ_GridSpace_mas=circ_GridSpace_mas
...
;
lambda_val=21661.2 ;ONLY for baseline calculations; actually uses the last image for computing values...
paprof=60. ; PA in degrees
image=visamp
window,29
LOADCT,0, /SILENT
!P.Background = fsc_color('white')
...
line_norm,lambda_vector,totalfluxfimsys,totalfluxfimsysn
ZE_SPEC_CNVL,lambda_vector,totalfluxfimsys,res,lambda_val,fluxcnvl=totalfluxfimsysn_cnvl
...
ZE_SPEC_CNVL,lambdat,t3,res,lambda_val,fluxcnvl=t4
vis12_ut.field1[3,*]=t4
;
...
plot,lambda_vector,totalfluxfimsysn,yrange=[0,2.5],XTITLE='Heliocentric vacuum wavelength (Angstrom)', YTITLE='F/Fc',$
/nodata,XTICKFORMAT='(I6)',xstyle=9,ystyle=1,Position=[0.16, 0.09, 0.85, 0.78*xwindowsize/ywindowsize]
plots,lambda_vector,totalfluxfimsysn_cnvl,noclip=0,color=FSC_COLOR('red'),linestyle=2
...
img=bytscl(circ_griddedData,MAX=max(circ_griddedData))
...
device,filename='/Users/jgroh/temp/img_true'+model+model2d+sufix+'.eps',/encapsulated,/color,bit=8,xsize=10*xwindowsize/ywindowsize,ysize=10,/inches
!X.THICK=3.5
!Y.THICK=3.5
!P.CHARTHICK=3.5
   LOADCT, 13
...
;save,/variables,FILENAME='/Users/jgroh/espectros/irc10420/irc10420_variables_vis_'+model+model2d+sufix+'_d'+dstr+'.sav'
END

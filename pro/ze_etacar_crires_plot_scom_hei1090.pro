...
;dirsci='/Users/jgroh/data/eso_vlt/crires/Etacar/381D-0262A_C01/310722/sci_proc/' ;for brg
...
swmpa=dirsci+'CR_SWMP_310723_2008-05-05T01:00:20.825_DIT1_1090.4nm.fits'
...
;normalized spectrum from the central star
fnormdiv=dataa2[*,row]/dataa2[900,row];
...
;dataa2[*,i]=dataa2[*,i]/dataa2[900,i]
;dataa2[*,i]=dataa2[*,i] - (dataa2[900,i]*fnormdiv)
;dataa2[*,i]=dataa2[*,i]/dataa2[*,row+1]
;dataa2[*,i]=dataa2[*,i]/fnormdiv

;subtract continuum for each row ? crudely done 
;dataa2[*,i]=dataa2[*,i] - dataa2[900,i]        ;column 900 for He I 1090.4
;dataa2[*,i]=dataa2[*,i]/dataa2[*,row+1]
;dataa2[*,i]=dataa2[*,i]/fnormdiv
...
;keywords.filename='/Users/jgroh/temp/output_crires.eps'
;xsize=6.48
...
LOADCT,13
colorbar, COLOR=fsc_color('black'),TICKNAMES=colorbarv,DIVISIONS=div, xminor=0, /VERTICAL, /RIGHT,POSITION=[0.95, 0.24, 0.97, 0.90]
LOADCT,0
!P.Background = fsc_color('white')
!P.Color = fsc_color('black')
...
;tvlaser,BARPOS='no',FILENAME='/Users/jgroh/temp/output_crires.eps',/NoPrint,/COLORPS,/ENCAP,XDIM=aa,YDIM=bb
;device,/close_file
set_plot,'x'
...
fnormdiv1=dataa2[*,row+cut1]/dataa2[900,row+cut1]; use this if 2d image is already divided by t
...
plots,swmpa2[*,row+cut1]/1000.,fnormdiv1,noclip=0

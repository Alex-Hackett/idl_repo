...
;ATTENTION!!!!
;changed by J Groh 2011Mar18 17:46 specifically for models cut_v4/m15_uv1400 and spherical_uv1400 to plot both under the same colorbar
;a=2.5e-9
;b=4.6e-5
...
;pa=33.          ;position angle in degrees; by definition PA=0 towards N, and increase eastwards. USE PA significantly different than 0 (e.g.50) for spherical models
pa=312.   ;USE above PA=33 for cut_v4 spherical, use 130 for facvity cut_v4 
 ;pa=0.
...
lambda_ini=6530.   ;initial lambda to do calculations 21610
lambda_fin=6600.
lambda_sampling=0.6     ;sampling in Angstrom ; use 1

lambda0=35556.   ; Br gamma
lambda_ini=35550.   ;initial lambda to do calculations 21610
lambda_fin=35600.
lambda_sampling=2.6     ;sampling in Angstrom ; use 1

;lambda_ini=1370.   ;initial lambda to do calculations 21610
;lambda_fin=1410.
;lambda_sampling=7.6     ;sampling in Angstrom ; use 1
;
;lambda0=1385.87
;lambda_ini=1385.   ;initial lambda to do calculations 21610
;lambda_fin=1387.
...
ENDCASE
lambda0=double(sufix)
;filterwidth=20 ;in Angstroms
...
;circ_GridSpace_mas=[0.035*3.75,0.035*3.75];teset 60 AU
;circ_GridSpace_mas=[0.035*0.1,0.035*0.1];test for companion
;circ_GridSpace_mas=[0.035*1.25,0.035*1.25];teset 20 AU
circ_GridSpace_mas=[0.035*0.4,0.035*0.4];teset 20 AU
...
wset,8
file_output='/Users/jgroh/anim_gif/etacar/'+model+'/'+model2d+'/'+sufix+'/etc_'+strcompress(string(i, format='(I04)'), /remove)
...
ZE_ETACAR_CREATE_INTENSITYIMAGE_EPS_V3,pa,rstar,dist,lambda_val,lambda0,lambda,np,ndelta1,nos,ipdelta,p,delta1_vec,x,y,model,model2d,sufix,dstr,inc_str,circ_GridSpace_mas,$
circ_griddedData=circ_griddedData,circxvector=circxvector,circyvector=circyvector,/vel
...
;lambda_val=1385.87
;lambda_val_str=strcompress(string(lambda_val*10., format='(I06)'))
;ZE_ETACAR_CREATE_INTENSITYIMAGE_EPS_V2,pa,rstar,dist,lambda_val,lambda0,lambda,np,ndelta1,nos,ipdelta,p,delta1_vec,x,y,model,model2d,sufix,dstr,inc_str,circ_GridSpace_mas,$

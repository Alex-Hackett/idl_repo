...
;for brgamma 26 2156 
;t=ZE_SHIFT_SPECTRA_VEL(swmpa2[*,i],f2cainormv,+4.)
;for brgamma 26 2150 
t=ZE_SHIFT_SPECTRA_VEL(swmpa2[*,i],f2cainormv,0.)
;for hei 20587
;t=ZE_SHIFT_SPECTRA_VEL(swmpa2[*,i],f2cainormv,+2.4)
...
plot,ZE_LAMBDA_TO_VEL(swmpa2[*,row]*10.,lambda0*10000.),dataa2[*,row]/dataa2[900,row],xstyle=1,ystyle=1,xrange=[-1850,250.], xtitle='velocity [km/s]',ytitle='F/Fc',$

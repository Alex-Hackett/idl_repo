...
$MAIN CODE
PRO ZE_READ_OBS_DELTA_IP_ETACAR_V4_MOD106_JOHN,dir,model,model2d,sufix,pa,cp_kband,compute_image=compute_image,gauss=gauss,fwhm_g,gauss_frac_wind
...
;v4_MOD106_john is adaptaed for model 106

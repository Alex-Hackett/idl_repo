; $Id: read_ascii.pro,v 1.51 2005/02/01 20:24:33 scottm Exp $
;
...
;-  JHG May 2013: added compress keyword
...
function ra_read_from_templ, $
  ...
  ;  Open the file.
  ;
  openr, unit, name, /get_lun,compress=compress

PRO ZE_IRC10420_CREATE_INTENSITYIMAGE_EPS_V3,pa,rstar,dist,lambda_val,lambda0,lambda,np,ndelta1,nos,ipdelta,p,delta1_vec,x,y,model,model2d,sufix,dstr,inc_str,circ_GridSpace_mas,$
...
device,filename='/Users/jgroh/temp/img_kband_'+model+'_'+model2d+'_'+sufix+'_d'+dstr+'_'+'_PA'+pa_str+'_i'+inc_str+'_'+lambda_val_str+'.eps',/encapsulated,/color,bit=8,xsize=10*xwindowsize/ywindowsize,ysize=10,/inches
...
xyouts,0.08,0.970,'K-band image, '+TEXTOIDL('W=0.')+omega_str+', i='+inc_str+'!Eo!N, PA='+pa_str+'!Eo ',/NORMAL,charsize=3.0,color=fsc_color('black')
xyouts,0.85,0.85,'k)',/NORMAL,color=fsc_color('white'),charsize=3.5,charthick=8

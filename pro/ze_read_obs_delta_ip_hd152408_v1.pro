...
dir='/Users/jgroh/ze_models/2D_models/hd152408/'
model='11'
...
;lambda0=21661.2    ; Br gamma vacuum
;lambda0=21655.29    ; Br gamma air
;lambda_ini=21555   ;initial lambda to do calculations 21610
;lambda_fin=21685    ;initial lambda to do calculations 21720
;lambda_ini=21600   ;initial lambda to do calculations 21610
;lambda_fin=21755    ;initial lambda to do calculations 21720
lambda_ini=20520.  ;initial lambda to do calculations 21610
lambda_fin=20670.    ;initial lambda to do calculations 21720

;filterwidth=200 ;in Angstroms
;lambda_ini=lambda0-filterwidth/2
;lambda_fin=lambda0+filterwidth/2

lambda_sampling=9.8     ;sampling in Angstrom ; use 1
...
VACTOAIR,lambda_vector
print,'coonverted to air wavelength'

lambda_val=21655.29 ;millour is using air wavelength ;ONLY for baseline calculations; actually uses the last visamp for computing values...
...
restore,FILENAME='/Users/jgroh/espectros/hd152408_work.sav' 
...
vsys=0; 33.          ;from crowther and bohannan 1997
...
plot,lambda_vector,vis_triplet_wavelength_cnvl[0,*],yrange=[0.93,1.02],XTITLE='Heliocentric vacuum wavelength (Angstrom)', YTITLE='Visibility',$
/nodata,XTICKFORMAT='(I6)',xstyle=9,ystyle=1,Position=[0.16, 0.09, 0.85, 0.78*xwindowsize/ywindowsize]
plots,lambda_vector,vis_triplet_wavelength_cnvl[0,*]/vis_triplet_wavelength_cnvl[0,1],noclip=0,color=FSC_COLOR('red'),linestyle=2
plots,lambda_vector,vis_triplet_wavelength_cnvl[1,*]/vis_triplet_wavelength_cnvl[1,1],noclip=0,color=FSC_COLOR('green'),linestyle=2
plots,lambda_vector,vis_triplet_wavelength_cnvl[2,*]/vis_triplet_wavelength_cnvl[2,1],noclip=0,color=FSC_COLOR('blue'),linestyle=2
;plots,vis12_ut.field1[2,*]*10000.,vis12_ut.field1[3,*],color=FSC_COLOR('red'),noclip=0
;plots,vis23_ut.field1[2,*]*10000.,vis23_ut.field1[3,*],color=FSC_COLOR('green'),noclip=0
;plots,vis31_ut.field1[2,*]*10000.,vis31_ut.field1[3,*],color=FSC_COLOR('blue'),noclip=0
...
plots,lobs,fobsn,color=FSC_COLOR('black'),noclip=0
AXIS,XAXIS=1,XTICKFORMAT='(I5)',XSTYLE=1,COLOR=fsc_color('black'),XTITLE='v - vsys (km/s)',XRANGE=[ZE_LAMBDA_TO_VEL(min(lambda_vector),lambda0)-vsys,ZE_LAMBDA_TO_VEL(max(lambda_vector),lambda0)-vsys]
...
save,/variables,FILENAME='/Users/jgroh/espectros/hd152408/hd152408_2d_variables_'+model+model2d+sufix+'_d'+dstr+'pa'+pa_str+'.sav'   

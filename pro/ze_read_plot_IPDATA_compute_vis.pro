...
y[i] = pgridip[i+min]/(6.96*214.08*6) ;in mas, assuming d=6 kpc 
endfor
...
griddedData = TriGrid(x, y, z, triangles, gridSpace,[MIN(X), MIN(Y), MAX(X), 5.], $
...
ytitle='p  (mas)', /NODATA, Position=[0.07, 0.08, 0.85, 0.95]

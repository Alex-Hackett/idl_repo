PRO ZE_ETACAR_CRIRES_PLOT_SCOM_2009APR03_OFFSET_V1,grat_angle,det,pos,star_center_calib
...
xnodes_spec_Ext=0
ynodes_spec_ext=0
gratdet='2009apr03_'+strcompress(string(grat_angle, format='(I04)'))+'_'+strcompress(string(det, format='(I01)'))+'_offset'+strcompress(string(pos, format='(I01)'))
gratdet_orig=gratdet ;in order to keep info of the original gratdet, to write the files correctly.
gratdetonstar='2009apr03_'+strcompress(string(grat_angle, format='(I04)'))+'_'+strcompress(string(det, format='(I01)'))
...
astrometry_ref_image=dirsciraw+'CRIRE.2009-04-03T01_28_18.699.fits' ;last exposure on star, to measure y offset
...
CASE pos OF 
4:  scoma=dirsciraw+'CRIRE.2009-04-03T01_29_52.819.fits'
5:  scoma=dirsciraw+'CRIRE.2009-04-03T01_31_13.024.fits'  
6:  scoma=dirsciraw+'CRIRE.2009-04-03T01_32_29.844.fits' 
3:  scoma=dirsciraw+'CRIRE.2009-04-03T01_33_48.694.fits'  
...
8:  scoma=dirsciraw+'CRIRE.2009-04-03T01_28_18.699.fits' ;last exposure on star, to measure y offset
9:  scoma=dirsciraw+'CRIRE.2009-04-03T01_27_00.321.fits' ;first exposure on star, to measure y offset
ENDCASE 
    END
...
a=0.
b=30.
ZE_ETACAR_CRIRES_CREATE_GENERIC_IMAGE_FROM_DATAA2,dataa2psfsub,a,b,imgpsfsub,SQRT=0,LOG=0

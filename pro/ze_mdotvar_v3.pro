...
close,2
den2=den2 ;re-scaling to increase Mdot by a factor of 2.5
...
plot,alog10(rout),flowtime,psym=1,symsize=1.5,xtitle='log r (CMFGEN units)', ytitle='flow timescale (days)'
...
Mdot1=4.*!PI*(r1)^2*1E+20*den1*v1*1E+5*(3600.*24*365.)/(1.99E+33)
Mdot2=4.*!PI*(r2)^2*1E+20*den2*v2*1E+5*(3600.*24*365.)/(1.99E+33)
Mdotout=4.*!PI*(rout)^2*1E+20*denout*vout*1E+5*(3600.*24*365.)/(1.99E+33)
end

PRO ZE_WAVECAL_CALIB_LAMBDA_SCI_V3,index,guess_lambda,dataa2,minrow,numberrows,gratdet,linelist_file,template_file
C=299792.458
...
save,yfit,wc,wl,wr,xc,linelist,fit,RMS,FILENAME='/Users/jgroh/espectros/etc_poly_wavecal_'+gratdet+'_line_auto_'+strcompress(string(j, format='(I02)'))+'.sav'

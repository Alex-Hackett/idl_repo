...
;
pro ze_evol_analyze_l_file_interac_v1_event,event
  
  common ze_evol_analyze_l_file_interac_common,info,modelstr,timestepstr,xarray,yarray,xnodes,ynodes,nodes_timestep,rsave,gsave,bsave, $
nr,logptot,logrho,logr,logmass,x_hplus,xmion,logkappa,gamma1,cp,nabla_rad,frad_frac,u,lm,lm_over_hp,logT,x_heplus,beta,grat,fconv_frac,vm,v_over_vs,logptot_noturb,$
 r_over_rtot,m_over_mtot,x_heplusplus,vkat,nabla_ad,nabla_e,facust_Frac,l_over_ledd
...
;X VARIABLES  
  'xn': begin 
      ...
      ze_lfile_line_plot_unzoom,info,xarray,yarray
    end  
  'xlogr': begin 
      xarray=logr
...
;Y VARIABLES
  ...
  'yMintnorm': begin 
      yarray=10^logmass/10^logmass[n_elements(logmass)-1]
      IF N_elements(ynodes) gt 0 THEN ynodes=yarray[nodes_timestep]
      info.yreverse = 0
  ...
  'ylogt': begin 
      ...
      'ylogpgas': begin 
;      yarray=alog10(8.3144621e7*10^logrho*10^logT/mu) 
      yarray=alog10(beta*10^logptot)    
      IF N_elements(ynodes) gt 0 THEN ynodes=yarray[nodes_timestep]
      info.yreverse = 0
      info.ytitle=textoidl('log P')
      ze_lfile_line_plot_unzoom,info,xarray,yarray
   ...
   'ylogpturb': begin 
      yarray=alog10(10^logptot-10^logptot_noturb)
      IF N_elements(ynodes) gt 0 THEN ynodes=yarray[nodes_timestep]
      info.yreverse = 0
   ...
   'yprad_over_ptot': begin 
      yarray=(7.5657e-15/3D0)*(10^logt)^4/10^logptot
      IF N_elements(ynodes) gt 0 THEN ynodes=yarray[nodes_timestep]
      info.yreverse = 0
      info.ytitle=textoidl('Ltot (Lsun)')
      ze_lfile_line_plot_unzoom,info,xarray,yarray
  ...
  'yledd': begin 
      yarray=(4d0*!PI*29979245800*6.67e-8*10^logmass/10^logkappa)/3.839e33
      IF N_elements(ynodes) gt 0 THEN ynodes=yarray[nodes_timestep]
      info.yreverse = 0
      info.ytitle=textoidl('Ltot (Lsun)')
      ze_lfile_line_plot_unzoom,info,xarray,yarray
  ...
  'yp_frac': begin 
     undefine,z1,x2,y2,y3,x3,y3,x4,y4,x5,y5
     undefine,x10,y10
     yarray=((7.5657e-15/3D0)*(10^logt)^4)/10^logptot ;prad
     x2=xarray
     y2=beta ;pgas
     x3=xarray
     y3=(10^logptot-10^logptot_noturb)/10^logptot ;pturb
     y3(where(logptot_noturb LE 0))=0.0

     IF N_elements(ynodes) gt 0 THEN ynodes=yarray[nodes_timestep]
     info.ytitle=TEXTOIDL('Pressure [rad,conv,turb]')
     
     ze_lfile_line_plot,info,xarray,yarray,x2=x2,y2=y2,x3=x3,y3=y3,x4=x4,y4=y4,x5=x5,y5=y5,$
                                ...
                                rebin=rebin,factor=factor,yrange=[0,1.02] 
    end      
  'yflux_frac': begin 
     undefine,z1,x2,y2,y3,x3,y3,x4,y4,x5,y5
     undefine,x10,y10
     ...
     y3=facust_frac     
     IF N_elements(ynodes) gt 0 THEN ynodes=yarray[nodes_timestep]
     info.ytitle=TEXTOIDL('Flux [rad,conv,acust]')
  ...
  'ynabla': begin 
     ...
     y3=nabla_e    
     IF N_elements(ynodes) gt 0 THEN ynodes=yarray[nodes_timestep]
     info.ytitle=TEXTOIDL('Nabla [rad,ad,e]')
...
;      device,/close
      set_plot,'x'
      ze_lfile_line_plot,info,xarray,yarray
      !p.font = -1
      end
    'Write.VADAT': begin
...
;  wset,info.plot4_id
 ...
 ; IF N_elements(xnodes) gt 0 THEN oplot,xnodes,ynodes,color=fsc_color('red'),symsize=1,psym=2,thick=2
  ...
  ;wset,info.pixid2
 ; device,copy=[0,0,950,450,0,0,info.plot4_id]
 ; wset,info.plot4_id
  return
  end
...
END  
;============================================================ ze_vfile_line_plot_UNZOOM
PRO ze_lfile_line_plot_unzoom,info,x,y,x2=x2,y2=y2,x3=x3,y3=y3,x4=x4,y4=y4,x5=x5,y5=y5,$
                                x6=x6,y6=y6,x7=x7,y7=y7,x8=x8,y8=y8,x9=x9,y9=y9,x10=x10,y10=y10,$
                                z1=z1,z2=z2, z3=z3, z4=z4, z5=z5, z6=z6, z7=z7, z8=z8, z9=z9,z_10=z_10,$
                                rebin=rebin,factor=factor
 ...
 ;  ENDELSE 
    LOADCT,0,/silent
    !P.BACKGROUND=fsc_color('white')
    ze_lfile_line_plot,info,x,y,x2=x2,y2=y2,x3=x3,y3=y3,x4=x4,y4=y4,x5=x5,y5=y5,$
                                x6=x6,y6=y6,x7=x7,y7=y7,x8=x8,y8=y8,x9=x9,y9=y9,x10=x10,y10=y10,$
                                z1=z1,z2=z2, z3=z3, z4=z4, z5=z5, z6=z6, z7=z7, z8=z8, z9=z9,z_10=z_10,$
                                rebin=rebin,factor=factor
    widget_control,info.xmin_base,get_v=x_min
...
;
pro ze_lfile_line_plot,info,x,y,ps=ps,x2=x2,y2=y2,x3=x3,y3=y3,x4=x4,y4=y4,x5=x5,y5=y5,$
                                x6=x6,y6=y6,x7=x7,y7=y7,x8=x8,y8=y8,x9=x9,y9=y9,x10=x10,y10=y10,$
                                z1=z1,z2=z2, z3=z3, z4=z4, z5=z5, z6=z6, z7=z7, z8=z8, z9=z9,z_10=z_10,$
...
pro ze_evol_analyze_l_file_interac_v1,model_name, timestep, $
...
; 
  if n_params(0) lt 1 then begin
    print,'CALLING SEQUENCE: ze_evol_analyze_l_file_interac_v1,model_name, timestep
...
l_file=modeldir+'/'+model_name+'.l'+strcompress(string(timestep, format='(I07)'))
print,l_file
ZE_EVOL_READ_L_FILE_FROM_GENEVA_ORIGIN2010,modeldir,model_name,timestep,data_l_file

ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'NR',data_l_file,nr,index_varnamex_l_file,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'UVLPT',data_l_file,logptot,index_varnamex_l_file,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'VLRO',data_l_file,logrho,index_varnamex_l_file,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'VLR',data_l_file,logr,index_varnamex_l_file,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'VLM',data_l_file,logmass,index_varnamex_l_file,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'X_Hplus',data_l_file,x_hplus,index_varnamex_l_file,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'VMION',data_l_file,vmion,index_varnamex_l_file,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'VLKA',data_l_file,logkappa,index_varnamex_l_file1,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'GAMMA1',data_l_file,gamma1,index_varnamex_l_file1,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'CP',data_l_file,cp,index_varnamex_l_file1,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'VNR',data_l_file,nabla_rad,index_varnamex_l_file,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'FR',data_l_file,Frad_frac,index_varnamex_l_file,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'U',data_l_file,U,index_varnamex_l_file,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'LM',data_l_file,lm,index_varnamex_l_file,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'LM_over_HP',data_l_file,lm_over_hp,index_varnamex_l_file,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'VLT',data_l_file,logT,index_varnamex_l_file,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'X_Heplus',data_l_file,x_heplus,index_varnamex_l_file,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'BETA',data_l_file,beta,index_varnamex_l_file1,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'GRAT',data_l_file,grat,index_varnamex_l_file1,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'FC',data_l_file,Fconv_frac,index_varnamex_l_file1,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'VM',data_l_file,vm,index_varnamex_l_file,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'V_over_VS',data_l_file,v_over_vs,index_varnamex_l_file,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'UVLP',data_l_file,logptot_noturb,index_varnamex_l_file,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'R_over_RTOT',data_l_file,r_over_rtot,index_varnamex_l_file,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'M_over_MTOT',data_l_file,m_over_mtot,index_varnamex_l_file,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'X_Heplusplus',data_l_file,x_heplusplus,index_varnamex_l_file,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'VKAT',data_l_file,vkat,index_varnamex_l_file,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'VNA',data_l_file,nabla_ad,index_varnamex_l_file,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'VNE',data_l_file,nabla_e,index_varnamex_l_file,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'FA',data_l_file,Facust_frac,index_varnamex_l_file,return_valx
ZE_EVOL_OBTAIN_VARIABLE_FROM_l_FILE,'L_over_LEDD',data_l_file,l_over_ledd,index_varnamex_l_file,return_valx

;ZE_EVOL_COMPUTE_QUANTITIES_FROM_lFILE,data_l_file,logprad,logpgas,prad_over_ptot,pgas_over_ptot,logpturb,ledd,gammafull_rad,gammafull_tot,nablarad
...
;;     '-adobe-helvetica-bold-r-normal--14-140-75-75-p-82-iso8859-1'
  main = widget_base(/col,group=group,/tracking,uvalue='MAIN', $
      title='Envelope structure from '+modelstr+'.l'+strcompress(string(timestep, format='(I07)')),modal=modal)
 ...
 buttonxlogr = widget_button(xvar,value='logR',uvalue='xlogr') 
  ...
  button2 = widget_button(yvar,value='Pgas/Ptot',uvalue='ypgas_over_ptot')
   button2 = widget_button(yvar,value='P_frac',uvalue='yp_frac')   
  button2 = widget_button(yvar,value='Ledd',uvalue='yledd')  
  button2 = widget_button(yvar,value='Gammafulltot',uvalue='ygammafulltot')
  button2 = widget_button(yvar,value='Frad_frac',uvalue='yfrad_frac')
   button2 = widget_button(yvar,value='Fconv_frac',uvalue='yfconv_frac')
   button2 = widget_button(yvar,value='Facust_frac',uvalue='yfacust_frac')
  button2 = widget_button(yvar,value='Flux_frac',uvalue='yflux_frac')         
  ...
  button = widget_button(yvar,value='nabla_rad',uvalue='ynablarad')
   button = widget_button(yvar,value='nabla',uvalue='ynabla') 
...
;
 LOADCT,0,/silent
 !P.BACKGROUND=fsc_color('white')
  plot4 = widget_draw(main,uvalue='plot4',retain=2, $
...
;
  ...
  pixid2 = !d.window
;
; save widget info in lure
;
  widget_control,main,/realize
  widget_control,plot4,get_value=plot4_id

  info = {message:message,ns:ns,pixid:pixid,pixid2:pixid2,xtitle:xtitle, $
    ytitle:ytitle,title:title,plot4:plot4, $
    ...
    x_min:0, y_min:0, node:0, plot4_id:plot4_id,  $
...
;
  ...
  xmanager,'ze_evol_analyze_l_file_interac_v1',main

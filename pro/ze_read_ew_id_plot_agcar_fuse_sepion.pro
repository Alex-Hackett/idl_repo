...
;defines observed FUSE file (grey)
...
;defines model file no abs due to H and H2 (RED)
modelnoabs='/aux/pc20072b/jgroh/ze_models/agcar/291b/obs_ions_sep/291b_tkiii_fuv.txt'
;modelnoabs='/aux/pc20072b/jgroh/espectros/agcar/291b_fuv.txt'
...
;defines model file (PURPLE)
model='/aux/pc20072b/jgroh/ze_models/agcar/291b/obs_ions_sep/291b_nkiii_fuv.txt'  ;best, but vinf too high
...
FOR l=0, i-1 do begin
 IF (lambdac[l] gt 900) and (lambdac[l] lt 1180) and (abs(ew[l]) gt 0.00169) then begin
 ;print,l,lambdac[l],ew[l],sob[l]
 pos=strpos(strtrim(sob[l],1),'(')
 sobc[l]=strmid(sob[l],2,pos+2)
  IF (sobc[l] eq '  CoIII') then begin
...
plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x2l,x2u],yrange=[0,0.17e-11],xtitle='wavelength (Angstrom)', ytitle='Flux (erg/s/cm^2/Angstrom)'
...
plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x3l,x3u],yrange=[0,0.45e-11],xtitle='wavelength (Angstrom)', ytitle='Flux (erg/s/cm^2/Angstrom)'
...
device,filename='/aux/pc20072b/jgroh/temp/output_fuse_tes.eps',/encapsulated,/color,bit=8,xsize=8.48,ysize=6.48,/inches

plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x1l-2,x1u+2],yrange=[0,9.0e-13],ytitle='Flux (erg/s/cm!E2!N/'+Angstrom+')',xcharsize=2.0,ycharsize=2.0,thick=1.8,xthick=1.8,ythick=1.8,$
/nodata,POSITION=[0.11,0.72,0.99,0.99]
plots,lambdafuse,fluxfuse,color=fsc_color('grey'),noclip=0,clip=[x1l,0,x1u,6.0e-11]
plots,lambdanoabs,3.0*fluxnoabsescd,color=fsc_color('red'),linestyle=1,noclip=0,clip=[x1l,0,x1u,9.0e-13]
plots,lambdamod,3.0*fluxmodescd,color=fsc_color('purple'),noclip=0,clip=[x1l,0,x1u,9.0e-13]
plots, [930,934],[7.0e-13,7.0e-13],color=fsc_color('grey')
xyouts,935,6.8e-13,'AG Car FUSE obs.',alignment=0,orientation=0
plots, [930,934],[6.2e-13,6.2e-13],color=fsc_color('red'),linestyle=1
xyouts,935,6e-13,'Mn III CMFGEN model',alignment=0,orientation=0
plots, [930,934],[5.4e-13,5.4e-13],color=fsc_color('purple')
xyouts,935,5.2e-13,'Ni III CMFGEN model',alignment=0,orientation=0
...
plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x2l-1,x2u+1],yrange=[0,0.19e-11],xcharsize=2.0,ycharsize=2.0,$
thick=1.8,ytitle='Flux (erg/s/cm!E2!N/'+Angstrom+')',xthick=1.8,ythick=1.8,/nodata,POSITION=[0.126,0.40,0.99,0.67]
plots,lambdafuse,fluxfuse,color=fsc_color('grey'),noclip=0,clip=[x2l,0,x2u,1.9e-12]
plots,lambdanoabs-0.07,1.9*fluxnoabsescd,color=fsc_color('red'),linestyle=1, noclip=0,clip=[x2l,0,x2u,1.9e-12]
plots,lambdamod-0.07,1.9*fluxmodescd,color=fsc_color('purple'), noclip=0,clip=[x2l,0,x2u,3.0e-12]
for l=0, i-1 do begin

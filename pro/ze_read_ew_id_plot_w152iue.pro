...
ewdata='/home/groh/espectros/wr152/ewdata_91ed'  
openu,1,ewdata     ; open file without writing

;defines observed FUSE file
obsfuse='/home/groh/espectros/wr152/wr152_iueall.txt'  
...
;defines model file
model='/home/groh/espectros/wr152/wr152_mod15_swplores.txt'  
...
;scales the model flux to 4 kpc (WR152)? No already done in input file, but not in continuum
fluxmodesc=fluxmod
fluxcontesc=fluxcont
...
plots,lambdamod,1.00*fluxmodescd,color=255, noclip=0,clip=[x1l,0,x1u,6.3e-11]
...
plots,lambdamod,1.00*fluxmodescd,color=255, noclip=0,clip=[x2l,0,x2u,2.1e-10]
for l=0, i-1 do begin
...
plots,lambdamod,1.00*fluxmodescd,color=255, noclip=0,clip=[x3l,0,x3u,3.6e-11]
for l=0, i-1 do begin
...
;making psplots
set_plot,'ps'
device,filename='/home/groh/espectros/wr152/output_iue.eps',/encapsulated,/color,bit=8,xsize=7.48,ysize=5.48,/inches
!p.multi=[0, 1, 2, 0, 0]

;1st panel, 925--1160 Angstrom
plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x1l,x1u],yrange=[0,2.0e-10],xtitle='wavelength (!3'+string(197B)+')',$
ytitle='Flux (erg/s/cm^2/Angstrom)',charsize=1.0,charthick=2,color=fsc_color('black'),/nodata,position=[0.135,0.55,0.96,0.96]
plots,lambdafuse,fluxfuse,color=fsc_color('grey'),noclip=0,clip=[x1l,0,x1u,2.0e-10]
plots,lambdamod,1.00*fluxmodescd,color=fsc_color('black'), noclip=0,clip=[x1l,0,x1u,6.9e-10],thick=1.5
...
xyouts,1553.0,1.6e-10,'!3'+string(45B)+'  CIV',alignment=0.5,orientation=90
xyouts,1725.0,1.6e-10,'!3'+string(45B)+'  NIV',alignment=0.5,orientation=90
for l=0, i-1 do begin
if (lambdac[l] gt x1l) and (lambdac[l] lt x1u) and (abs(ew[l]) gt 1.0) then begin
pos=strpos(strtrim(sob[l],1),'(')
sobc[l]=strmid(sob[l],4,pos+0)
if ((sobc[l] ne 'FeV') && (sobc[l] ne 'FeVI')) then begin ;colocando apenas um traco nas transicoes do FeV,normal para os outros.
xyouts,lambdac[l]+6,1.6e-10,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90
endif
if (sobc[l] eq 'FeV') then begin
xyouts,lambdac[l],1.2e-10,'!3'+string(45B),alignment=0.5,orientation=90
endif
if(sobc[l] eq 'FeVI') then begin
xyouts,lambdac[l],1.1e-10,'!3'+string(45B),alignment=0.5,orientation=90
endif
endif
endfor

;2nd panel
plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x2l,x2u],yrange=[0,1.1e-11],xtitle='wavelength (Angstrom)', ytitle='Flux (erg/s/cm^2/Angstrom)',charsize=1.0,charthick=2,/nodata
plots,lambdafuse,fluxfuse,noclip=0,clip=[x2l,0,x2u,2.4e-10],color=fsc_color('grey')
plots,lambdamod,1.00*fluxmodescd,color=fsc_color('black'), noclip=0,clip=[x2l,0,x2u,2.4e-10],thick=1.5
...
sobc[l]=strmid(sob[l],4,pos+0)
if ((sobc[l] ne 'FeV') && (sobc[l] ne 'FeVI')) then begin ;colocando apenas um traco nas transicoes do FeV,normal para os outros.
xyouts,lambdac[l]+11.0,0.8e-11,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90
endif
if (sobc[l] eq 'FeV') then begin
print,lambdac[l],sobc[l]
xyouts,lambdac[l],0.6e-11,'!3'+string(45B),alignment=0.5,orientation=90
endif
;if(sobc[l] eq 'FeVI') then begin
;xyouts,lambdac[l],0.5e-11,'!3'+string(45B),alignment=0.5,orientation=90
;endif
endif
endfor

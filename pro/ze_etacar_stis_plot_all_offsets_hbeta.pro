;PRO ZE_ETACAR_STIS_PLOT_ALL_OFFSETS_HBETA
;routine to create the interpolated mapping for the STIS data from Ted
;2010sep24

nslits=49
dir='/Users/jgroh/data/hst/stis/umn/hbeta_mapping/'

listfile=dir+'list'
listfile=dir+'list_ordered' ;list with ordered offset positions, 50 offset positions
...
noffset=49; total number
noffset=19;for neg positions
noffset=39 ; (+- 1.9 arcsec)
sizelam=2128
sizespat=1280
...
;file=list[j+30] ;for neg pos
file=list[j+0] ; for positive pos
...
;FOR index_lambda=0, index2-index1 , 10 DO BEGIN
;;i=index_lambda
;;index_lambda=29

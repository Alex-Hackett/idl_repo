...
;		* if set to '$APED', looks for /data/fubar/SCAR/atomdb_1.3.1/apec_coco.fits
;
;keywords
...
;	input file
filnam=cocofil[0]
if strmatch(strupcase(filnam),'$COCO') then filnam='/data/atomdb/apec_coco.fits'
if strmatch(strupcase(filnam),'$APED') then filnam='/data/fubar/SCAR/atomdb_1.3.1/apec_coco.fits'

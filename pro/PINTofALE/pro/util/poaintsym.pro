pro poaintsym, symb, psize=psize,pthick=pthick,pfill=pfill,$
	halftri=halftri,npoint=npoint,aspect=aspect,angle=angle,$
...
;	/halftri,npoint=npoint,aspect=aspect,angle=angle,adent=adent,$
;	verbose=verbose
;
;parameters
...
if ok ne 'ok' then begin
  ...
  print,'       /halftri,npoint=npoint,aspect=aspect,angle=angle,adent=adent,$

...
;	  	Z1 ION1 <sep> WAVE1 <sep> SOURCE1 <sep> DESCRIPTION1
;	  	Z2 ION2 <sep> WAVE2 <sep> SOURCE2 <sep> DESCRIPTION2
;	  	...
;	  	Zn IONn <sep> WAVEn <sep> SOURCEn <sep> DESCRIPTIONn
...
;	* of the IDs, Z is required, ION is useful, WAVE and SOURCE are
...
while not eof(ulst) do begin			;{read each line
  line='' & readf,ulst,line ;& print,line

...
ewdata='/home/groh/espectros/wr152/ewdata_18fined136'  
openu,1,ewdata     ; open file without writing

;defines observed FUSE file
obsfuse='/home/groh/espectros/wr152/wr152_hamn.txt' 
...
;defines model file
model='/home/groh/espectros/wr152/wr152_16_33a76.txt'  
...
if (lambdac[l] gt 3270) and (lambdac[l] lt 9280) and (abs(ew[l]) gt 1.00) then begin
...
;making psplots
set_plot,'ps'
device,filename='/home/groh/espectros/wr152/output_opt.eps',/encapsulated,/color,bit=8,xsize=6.48,ysize=8.48,/inches
!p.multi=[0, 1, 3, 0, 0]

;1st panel, 925--1160 Angstrom

plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x1l,x1u],yrange=[0,3.2],xtitle='wavelength (Angstrom)',$
...
for l=0, i-1 do begin
if (lambdac[l] gt x1l) and (lambdac[l] lt x1u) and (abs(ew[l]) gt 10.0) then begin
pos=strpos(strtrim(sob[l],1),'(')
...
xyouts,lambdac[l]+10,2.6,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90
endif
if (sobc[l] eq '  FeV') then begin
xyouts,lambdac[l],6,'!3'+string(45B),alignment=0.5,orientation=90
endif
...
plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x2l,x2u],yrange=[0,7],xtitle='wavelength (Angstrom)', ytitle='Normalized Flux',charsize=1.5,charthick=2,/nodata
...
for l=0, i-1 do begin
if (lambdac[l] gt x2l) and (lambdac[l] lt x2u) and (abs(ew[l]) gt 4.80) then begin
pos=strpos(strtrim(sob[l],1),'(')
sobc[l]=strmid(sob[l],4,pos)
if ((sobc[l] ne 'HeI') && (sobc[l] ne 'FeVI')) then begin ;colocando apenas um traco nas transicoes do FeV,normal para os outros.
...
plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x3l,x3u],yrange=[0.5,4.15],xtitle='wavelength (Angstrom)', ytitle='Normalized Flux',charsize=1.5,charthick=2,/nodata
...
for l=0, i-1 do begin
if (lambdac[l] gt x3l) and (lambdac[l] lt x3u) and (abs(ew[l]) gt 8.50) then begin
pos=strpos(strtrim(sob[l],1),'(')
sobc[l]=strmid(sob[l],4,pos)
if ((sobc[l] ne 'HeI') && (sobc[l] ne 'FeVI')) then begin ;colocando apenas um traco nas transicoes do FeV,normal para os outros.
xyouts,lambdac[l]+20,3.5,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90
endif
if (sobc[l] eq 'FeV') then begin
xyouts,lambdac[l],4,'!3'+string(45B),alignment=0.5,orientation=90
endif

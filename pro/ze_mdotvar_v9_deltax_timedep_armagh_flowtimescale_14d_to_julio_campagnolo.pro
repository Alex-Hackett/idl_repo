PRO ZE_MDOTVAR_V9_DELTAX_TIMEDEP_ARMAGH_FLOWTIMESCALE_14d_TO_JULIO_CAMPAGNOLO
;CLEANED VERSION
;14d uses reduction=0.7
...
;use the same Mdot or vary? Change here
mdot2=mdot1
...
;2010Nov10 rewrote to do interpolation for better accuracy

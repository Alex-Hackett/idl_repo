;PRO ZE_ETACAR_CMFGEN_MODEL_CUT_MOD43_GROH_COMPARE_MODELS_INC_WALL_V2_PAPER
close,/all
...
device,filename='/Users/jgroh/temp/etc_cmfgen_mod43groh_plus_cavity_compare_models_optical_inc.eps',/encapsulated,/color,bit=8,xsize=8.48,ysize=8.48,/inches
!p.multi=[0,2, 3, 0, 0]
!P.THICK=7
!X.THICK=8
!Y.THICK=8
...
x1l=-1300
x1u=1300
plot,lm00,fn00,xstyle=1,ystyle=1,xrange=[x1l,x1u],yrange=[0.05,20],ytickinterval=2,$
/nodata,xtitle='Velocity (km/s)', ytitle='Normalized Flux',/ylog
plots,ZE_LAMBDA_TO_VEL(lm00,lambda0),fn00,color=minc,linestyle=0,noclip=0
plots,ZE_LAMBDA_TO_VEL(lm30,lambda0),fn30,color=minc+3*((maxc-minc)/(nmodels-1)),linestyle=0,noclip=0
plots,ZE_LAMBDA_TO_VEL(lm49,lambda0),fn49,color=minc+4*((maxc-minc)/(nmodels-1)),linestyle=0,noclip=0
plots,ZE_LAMBDA_TO_VEL(lm70,lambda0),fn70,color=minc+7*((maxc-minc)/(nmodels-1)),linestyle=0,noclip=0
plots,ZE_LAMBDA_TO_VEL(lm90,lambda0),fn90,color=minc+9*((maxc-minc)/(nmodels-1)),linestyle=0,noclip=0
...
;labels
xyouts,8000,13500,TEXTOIDL('i=90^\circ'),color=minc,orientation=0,/DeVICE
xyouts,8000,13000,TEXTOIDL('i=120^\circ'),color=minc+3*((maxc-minc)/(nmodels-1)),orientation=0,/DEVICE
xyouts,8000,12500,TEXTOIDL('i=138^\circ'),color=minc+5*((maxc-minc)/(nmodels-1)),orientation=0,/DEVICE
xyouts,8000,12000,TEXTOIDL('i=160^\circ'),color=minc+7*((maxc-minc)/(nmodels-1)),orientation=0,/DEVICE
xyouts,8000,11500,TEXTOIDL('i=180^\circ'),color=minc+9*((maxc-minc)/(nmodels-1)),orientation=0,/DEVICE

lambda0=4862.683
x1l=-1300
x1u=1300
plot,lm00,fn00,xstyle=1,ystyle=1,xrange=[x1l,x1u],yrange=[0.05,50],ytickinterval=2,$
/nodata,xtitle='Velocity (km/s)', ytitle='Normalized Flux',/ylog
plots,ZE_LAMBDA_TO_VEL(lm00,lambda0),fn00,color=minc,linestyle=0,noclip=0
plots,ZE_LAMBDA_TO_VEL(lm30,lambda0),fn30,color=minc+3*((maxc-minc)/(nmodels-1)),linestyle=0,noclip=0
plots,ZE_LAMBDA_TO_VEL(lm49,lambda0),fn49,color=minc+4*((maxc-minc)/(nmodels-1)),linestyle=0,noclip=0
...
x1l=-1300
x1u=1300
plot,lm00,fn00,xstyle=1,ystyle=1,xrange=[x1l,x1u],yrange=[0.05,99],ytickinterval=2,$
/nodata,xtitle='Velocity (km/s)', ytitle='Normalized Flux',/ylog
plots,ZE_LAMBDA_TO_VEL(lm00,lambda0),fn00,color=minc,linestyle=0,noclip=0
plots,ZE_LAMBDA_TO_VEL(lm30,lambda0),fn30,color=minc+3*((maxc-minc)/(nmodels-1)),linestyle=0,noclip=0
plots,ZE_LAMBDA_TO_VEL(lm49,lambda0),fn49,color=minc+4*((maxc-minc)/(nmodels-1)),linestyle=0,noclip=0
...
x1l=4500
x1u=4600
plot,lm00,fm00,xstyle=1,ystyle=1,xrange=[x1l,x1u],yrange=[0.0,3],ytickinterval=1,$

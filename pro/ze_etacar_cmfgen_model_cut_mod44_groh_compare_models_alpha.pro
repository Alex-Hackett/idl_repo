;PRO ZE_ETACAR_CMFGEN_MODEL_CUT_MOD44_GROH_COMPARE_MODELS_ALPHA
close,/all
Angstrom = '!6!sA!r!u!9 %!6!n'
!P.Background = fsc_color('white')

dir2='/Users/jgroh/ze_models/2D_models/etacar/mod44_groh/cut_v4_vstream/'
model2='var_alpha_inc_49'   ;b,c,o,r,t,u,v don't cover the UV range
sufix2='36' ;opening angle 50.4
filename1='OBSFRAME1'
...
device,filename='/Users/jgroh/temp/etc_cmfgen_mod44groh_plus_cavity_compare_models_uv_optical_alpha.eps',/encapsulated,/color,bit=8,xsize=8.48,ysize=8.48,/inches
!p.multi=[0,2, 3, 0, 0]
!P.THICK=7
!X.THICK=8
!Y.THICK=8
...
device,filename='/Users/jgroh/temp/etc_cmfgen_mod44groh_plus_cavity_compare_models_halpha_emiss_alpha.eps',/encapsulated,/color,bit=8,xsize=8.48,ysize=3.48,/inches
!P.THICK=8
!X.THICK=6
!Y.THICK=6
!X.CHARSIZE=1.2
...
plots,ZE_LAMBDA_TO_VEL(lm72scl,lambda0),fn72scl*1.1,color=colorm5,linestyle=0,noclip=0
plots,ZE_LAMBDA_TO_VEL(lm57scl,lambda0),fn57scl*1.1,color=colorm1,linestyle=0,noclip=0
xyouts,-1100,60,TEXTOIDL('(a) H\alpha'),color=FSC_COLOR('black'),orientation=0,/DATA
;labels
xyouts,-1100,50,TEXTOIDL('\alpha=36^\circ'),color=colorm8,orientation=0,/DATA
xyouts,-1100,40,TEXTOIDL('\alpha=50^\circ'),color=colorm6,orientation=0,/data
xyouts,-1100,30,TEXTOIDL('\alpha=57^\circ'),color=colorm1,orientation=0,/data
xyouts,-1100,20,TEXTOIDL('\alpha=72^\circ'),color=colorm5,orientation=0,/data

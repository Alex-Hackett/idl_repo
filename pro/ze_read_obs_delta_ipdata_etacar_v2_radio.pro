...
nporig=np-1
np=np-3    ;selecting maximum value of p ( 21 FOR ETA CAR, DO NOT CHANGE!)
...
pa=313.   ;USE above PA=33 for cut_v4 spherical, use 130 for facvity cut_v4 
 ;pa=0.
...
lambda0=150000.
lambda_ini= 1.000934E+08   ;initial lambda to do calculations 21610
lambda_fin=1.005586E+08 
lambda_sampling=1e5     ;sampling in Angstrom ; use 1
...
circ_GridSpace_mas=[1.6,1.6];teset 20 AU
circ_GridSpace_mas=[4.6,4.6];teset 20 AU

PRO ZE_ETACAR_CRIRES_PLOT_SCOM_2011APR14_OFFSET_V1,grat_angle,det,pos,star_center_calib
...
xnodes_spec_Ext=0
ynodes_spec_ext=0
gratdet='2011apr14_'+strcompress(string(grat_angle, format='(I04)'))+'_'+strcompress(string(det, format='(I01)'))+'_offset'+strcompress(string(pos, format='(I01)'))
gratdet_orig=gratdet ;in order to keep info of the original gratdet, to write the files correctly.
gratdetonstar='2011apr14_'+strcompress(string(grat_angle, format='(I04)'))+'_'+strcompress(string(det, format='(I01)'))

PRO ZE_IRC10420_CREATE_INTENSITYIMAGE_EPS_V2,pa,rstar,dist,lambda_val,lambda0,lambda,np,ndelta1,nos,ipdelta,p,delta1_vec,x,y,model,model2d,sufix,dstr,inc_str,circ_GridSpace_mas,$
...
;convert to w
w_str=number_formatter(SQRT(float(omega_str)/100.0),decimals=2) ; OK rember the model directories and 2d model uses omega^2
print,w_str

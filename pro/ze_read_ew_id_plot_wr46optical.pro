...
obsfuse='/home/groh/espectros/wr46/wr46_alex_n.txt' 
...
;defines model file
model='/home/groh/espectros/wr46/wr46_102b_nar.txt'  
...
if (lambdac[l] gt 3770) and (lambdac[l] lt 9280) and (abs(ew[l]) gt 1.00) then begin
...
;making psplots
set_plot,'ps'
device,filename='/home/groh/espectros/wr46/output_opt.eps',/encapsulated,/color,bit=8,xsize=6.48,ysize=8.48,/inches
!p.multi=[0, 1, 3, 0, 0]
...
plots,lambdafuse,fluxfuse,color=fsc_color('black'),noclip=0,clip=[x1l,0,x1u,13]
plots,lambdamod,fluxmod,color=fsc_color('red',!d.table_size-10), noclip=0,clip=[x1l,0,x1u,13],linestyle=1,thick=4.0
...
plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x2l,x2u],yrange=[0,3],xtitle='wavelength (Angstrom)', ytitle='Normalized Flux',charsize=1.5,charthick=2,/nodata
plots,lambdafuse,fluxfuse,color=fsc_color('black'), noclip=0,clip=[x2l,0,x2u,7]
plots,lambdamod,fluxmod,color=fsc_color('red'), noclip=0,clip=[x2l,0,x2u,7],linestyle=1,thick=4.0
for l=0, i-1 do begin
...
plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x3l,x3u],yrange=[0,2.5],xtitle='wavelength (Angstrom)', ytitle='Normalized Flux',charsize=1.5,charthick=2,/nodata
plots,lambdafuse,fluxfuse,color=fsc_color('black'), noclip=0,clip=[x3l,0,x3u,7]
plots,lambdamod,fluxmod,color=fsc_color('red'), noclip=0,clip=[x3l,0,x3u,7],linestyle=1,thick=4.0
for l=0, i-1 do begin
if (lambdac[l] gt x3l) and (lambdac[l] lt x3u) and (abs(ew[l]) gt 1.50) then begin
pos=strpos(strtrim(sob[l],1),'(')
sobc[l]=strmid(sob[l],4,pos)
if ((sobc[l] ne 'FeV') && (sobc[l] ne 'FeVI')) then begin ;colocando apenas um traco nas transicoes do FeV,normal para os outros.

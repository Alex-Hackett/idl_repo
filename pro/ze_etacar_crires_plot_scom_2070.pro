...
dirsci='/Users/jgroh/data/eso_vlt/crires/Etacar/381D-0262A_C01/310720/sci_proc/'  ;for he i 20587
...
;for hei 20587
t=ZE_SHIFT_SPECTRA_VEL(swmpa2[*,i],f2cainormv,0.5)
...
plot,ZE_LAMBDA_TO_VEL(swmpa2[*,row]*10.,lambda0*10000.),dataa2[*,row]/dataa2[900,row],xstyle=1,ystyle=1,xrange=[-1050,250.], xtitle='velocity [km/s]',ytitle='F/Fc',$
...
POSITION=[0.09, 0.18, 0.96, 0.88],xtitle=TEXTOIDL('Wavelength [\mum]'), ytitle='Normalized flux',$
xstyle=1,ystyle=1,xrange=[-150.,0.], yrange=[0.0,10],/NODATA,charsize=2
;;plots,swmpa2[*,row]/1000.,dataa2[*,row]/max(dataa2[*,row])*5.8*f2cainormv,color=fsc_color('black'),noclip=0,linestyle=2,thick=1.9

...
rvsig1='/aux/pc20117a/jgroh/cmfgen_models/agcar/353/RVSIG_COL'  
...
;rvsig1='/aux/pc20117a/jgroh/cmfgen_models/agcar/348_copy_newversion9pr08/vel_r_correct.txt'
rvsigout='/aux/pc20117a/jgroh/cmfgen_models/agcar/353/RVSIG_COLout' 
...
readf,1,r1t,v1t,sigma1t
r1[k]=r1t & v1[k]=v1t & sigma1[k]=sigma1t 
endfor

rout=10^(r1)*r1[ND-1] & vout=v1 & sigmaout=sigma1

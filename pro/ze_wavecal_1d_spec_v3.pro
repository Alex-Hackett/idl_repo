;PRO ZE_WAVECAL_1D_SPEC_v3, lambda,flux,wl=wl,wr=wr,xc=xc,wc=wc,linelist=linelist,fit=fit,yfit=yfit,RMS=RMS
C=299792.

;ZE_READ_TELKPNO_AIR,lambdacut=lkpno,fluxcut=fkpno,min(swmpa2)*10.,max(swmpa2)*10.
;ZE_BUILD_TELURIC_LINELIST, lkpno,fkpno,grat_angle,det
...
restore,'/Users/jgroh/espectros/etc_poly_wavecal_2070_det1_template.sav'
...
save,yfit,wc,wl,wr,xc,linelist,fit,RMS,FILENAME='/Users/jgroh/espectros/etc_poly_wavecal_2070_det1_line_auto_'+strcompress(string(j, format='(I02)'))+'.sav'

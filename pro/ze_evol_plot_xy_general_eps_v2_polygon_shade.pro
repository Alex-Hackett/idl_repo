PRO ZE_EVOL_PLOT_XY_GENERAL_EPS_V2_POLYGON_SHADE,x,y,xtitle,ytitle,label,$
                                ...
                                factor=factor,$
                                plot_last=plot_last,polygon=polygon 
...
IF n_elements(factor_12) lt 1 THEN factor_12=factor

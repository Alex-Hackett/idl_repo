...
plots,lambda_vector_19asub,(phase_triplet_wavelength_cnvl_19asub[0,*]+4.22)*(-1.),noclip=0,color=FSC_COLOR('red'),linestyle=2
plots,lambda_vector_19a,(phase_triplet_wavelength_cnvl_19a[0,*]-2.22)*(-1.),noclip=0,color=FSC_COLOR('blue'),linestyle=3
...
plots,lambda_vector_19asub,(phase_triplet_wavelength_cnvl_19asub[1,*]+6.54)*(-1.),noclip=0,color=FSC_COLOR('red'),linestyle=2
plots,lambda_vector_19a,(phase_triplet_wavelength_cnvl_19a[1,*]-1.96)*(-1.),noclip=0,color=FSC_COLOR('blue'),linestyle=3
...
plots,lambda_vector_19asub,(phase_triplet_wavelength_cnvl_19asub[2,*]+7.87)*(-1.),noclip=0,color=FSC_COLOR('red'),linestyle=2
plots,lambda_vector_19a,(phase_triplet_wavelength_cnvl_19a[2,*]-3.83)*(-1.),noclip=0,color=FSC_COLOR('blue'),linestyle=3
xyouts,0.3,0.8,TEXTOIDL('B_{31}=128.95m, PA=60.6')+'!Eo!N',/NORMAL

...
plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x1l,x1u],yrange=[0,3],xtitle='wavelength (Angstrom)',$
...
for l=0, i-1 do begin
if (lambdac[l] gt x1l) and (lambdac[l] lt x1u) and (abs(ew[l]) gt 0.2) then begin
pos=strpos(strtrim(sob[l],1),'(')
...
xyouts,lambdac[l]+2,2.7,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90
endif
if (sobc[l] eq 'HeI+HI') then begin
xyouts,lambdac[l]+15,1.9,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=45
endif
if(sobc[l] eq '  FeVI') then begin
xyouts,lambdac[l],8,'!3'+string(45B),alignment=0.5,orientation=90
endif
...
pos=strpos(strtrim(sob[l],1),'(')
sobc[l]=strmid(sob[l],4,pos)
if ((sobc[l] ne 'HI') && (sobc[l] ne 'FeVI')) then begin ;colocando apenas um traco nas transicoes do FeV,normal para os outros.
xyouts,lambdac[l]+2,max2-0.4,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90
endif
if (sobc[l] eq 'HI') then begin
xyouts,lambdac[l]+5,max2-0.5,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=45
endif
if(sobc[l] eq 'FeVI') then begin
xyouts,lambdac[l],5,'!3'+string(45B),alignment=0.5,orientation=90
endif
...
;3rd panel
max3=5.3
plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x3l,x3u],yrange=[0,max3],xtitle='wavelength (Angstrom)', ytitle='Normalized Flux',/nodata,charsize=2
...
sobc[l]=strmid(sob[l],4,pos)
if ((sobc[l] ne 'HI') && (sobc[l] ne 'FeVI')) then begin ;colocando apenas um traco nas transicoes do FeV,normal para os outros.
xyouts,lambdac[l]+2,max3-0.9,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90
endif
if (sobc[l] eq 'HI') then begin
xyouts,lambdac[l]-5,max3-0.9,'!3'+string(45B)+'IH',alignment=0.5,orientation=135
endif
if(sobc[l] eq 'FeVI') then begin
xyouts,lambdac[l],5,'!3'+string(45B),alignment=0.5,orientation=90
endif

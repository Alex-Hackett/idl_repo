...
PRO ZE_COMPUTE_IMAGE_I_P_DELTA_LAMBDA,pa,rstar,fudge,dist,lambda_val,lambda0,lambda,np,ndelta1,nos,ipdelta,p,delta1_vec,x,y,circ_GridSpace_mas,intens2d_lambda=intens2d_lambda,$
...
fudge=2.5
rstar=700. ; in CMFGEN UNITS
;rstar=1500.4
;rstar=785.

dist=7.0/fudge ;in kpc
...
lambda_ini=21630   ;initial lambda to do calculations 21610
;lambda_fin=21685    ;initial lambda to do calculations 21720
;lambda_ini=21600   ;initial lambda to do calculations 21610
lambda_fin=21700    ;initial lambda to do calculations 21720
;
...
ZE_COMPUTE_IMAGE_I_P_DELTA_LAMBDA,pa,rstar,fudge,dist,lambda_val,lambda0,lambda,np,ndelta1,nos,ipdelta,p,delta1_vec,x,y,circ_GridSpace_mas,intens2d_lambda=intens2d_lambda,$
circxvector=circxvector,circyvector=circyvector,circ_griddedData=circ_griddedData
...
ZE_COMPUTE_IMAGE_I_P_DELTA_LAMBDA,pa,rstar,fudge,dist,lambda_val,lambda0,lambda,np,ndelta1,nos,ipdelta,p,delta1_vec,x,y,circ_GridSpace_mas_vis,intens2d_lambda=intens2d_lambda,$
circxvector=circxvector,circyvector=circyvector,circ_griddedData=circ_griddedData
;ZE_PLOT_IMAGE_I_P_DELTA_LAMBDA,rstar,dist,pa,inc_str,lambda_val,lambda0,lambda,np,ndelta1,nos,ipdelta,p,delta1_vec,x,y,intens2d_lambda, circxvector,circyvector,circ_griddedData,imginv=imginv,/VEL
...
save,/variables,FILENAME='/Users/jgroh/espectros/hrcar/hrcar_2d_variables_'+model+model2d+sufix+'_d'+dstr+'pa'+pa_str+'.sav'   

...
;plot,l00jul,fluxfuse,xstyle=1,ystyle=1,xrange=[x2l,x2u],yrange=[0,7],xtitle='wavelength (Angstrom)', ytitle='Normalized Flux',/nodata
...
;making psplots
set_plot,'ps'
device,filename='/Users/jgroh/temp/output_opt_2002.eps',/encapsulated,/color,bit=8,xsize=8.48,ysize=6.48,/inches
;!X.OMARGIN=[10,5]
!p.multi=[0, 1, 5, 0, 0]
...
plots,lambdamod,fluxmod,color=fsc_color('black'), noclip=0,clip=[x5cl,0.5,x5cu,7],linestyle=0,thick=1.5
for l=0, i-1 do begin

;PRO ZE_ETACAR_CMFGEN_MODEL_CUT_JOHN_COMPARE_MODELS_INCLINATION_WALL_ALPHA47
close,/all
...
;model1='cut_v4_var_inc'   
;sufix1='i00'
;extra_label1=TEXTOIDL(',i=0^\circ')
;filename1='OBSFRAME1'
...
;
;
;model2='cut_v4_var_inc'  
;sufix2='i41'
;extra_label2=TEXTOIDL(',i=41^\circ')
;filename2='OBSFRAME1'
...
;
;model3='cut_v4_var_inc'   ;b,c,o,r,t,u,v don't cover the UV range
;sufix3='i60'
;extra_label3=TEXTOIDL(',i=60^\circ')
;filename3='OBSFRAME1'
...
model00='cut_v4_var_inc_alpha47'   ;b,c,o,r,t,u,v don't cover the UV range
sufix00='i00'
...
model30='cut_v4_var_inc_alpha47'   ;b,c,o,r,t,u,v don't cover the UV range
sufix30='i30'
...
model36='cut_v4_var_inc_alpha47'   ;b,c,o,r,t,u,v don't cover the UV range
sufix36='i36'
...
model41='cut_v4_var_inc_alpha47'   ;b,c,o,r,t,u,v don't cover the UV range
sufix41='i41'
...
model50='cut_v4_var_inc_alpha47'   ;b,c,o,r,t,u,v don't cover the UV range
sufix50='i50'
...
model60='cut_v4_var_inc_alpha47'   ;b,c,o,r,t,u,v don't cover the UV range
sufix60='i60'
...
model75='cut_v4_var_inc_alpha47'   ;b,c,o,r,t,u,v don't cover the UV range
sufix75='i75'
filename75='OBSFRAME1'
extra_label75=TEXTOIDL(',i=75^\circ')
ZE_BH05_READ_OBS2D_GET_INC_NORMALIZE,dir,model00,sufix00,filename00,lm75,fm75,fn75,inc75,inc_str75,/FLAM

model90='cut_v4_var_inc_alpha47'   ;b,c,o,r,t,u,v don't cover the UV range
sufix90='i90'
...
/nodata,POSITION=[0.11,0.25,0.96,0.96]
plots,lm00,fn00,color=colorm1,linestyle=0,noclip=0,clip=[x1l,0,x1u,10],thick=b+1.5

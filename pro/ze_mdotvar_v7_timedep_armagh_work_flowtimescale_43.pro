;PRO ZE_MDOTVAR_V7_TIMEDEP_ARMAGH_WORK_FLOWTIMESCALE_43
; compute tflow by integrating the inverse of the velocity law
;uses as hydro structure model timedep_armagh/20
...
READCOL,'/Users/jgroh/ze_models/timedep_armagh/'+modelin+'/RVSIG_COL_NEW_v150',r1,v1,sigma1,depth1,COMMENT='!',F='D,D'
...
;write RVSIG_COL
ZE_WRITE_RVSIG_COL,routrev,voutrev,sigmaoutrev,ndrev,'/Users/jgroh/ze_models/timedep_armagh/'+modelout+'/RVSIG_COL_NEW' 
...
;write VM_FILE
ZE_WRITE_VM_FILE,routrev,voutrev,sigmaoutrev,denoutrev,clumpoutrev,ndrev,'/Users/jgroh/ze_models/timedep_armagh/'+modelout+'/VM_FILE_NEW' 

;PRO ZE_WORK_SN_PROGENITOR_RSG_OBSERVATIONS
;this is from the sample of Smartt et al. 2009, only [O/H] >= 8.4
;the idea is to determine the initial mass based on the relationships we find for the non-rotating and rotating models
;PROBLEM: reddening is being estimated for the V band in most cases, and absolute magnitude calculations are wrong
;OK solved

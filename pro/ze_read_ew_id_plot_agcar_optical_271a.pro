...
obsfuse='/aux/pc244a/jgroh/espectros/agcar/agc01apr12_35a90.txt'  
openu,2,obsfuse     ; open file without writing

;defines model continuum file
modelc='/aux/pc244a/jgroh/espectros/agcar/371_narv2.txt'  
openu,4,modelc    ; open file without writing

;defines model file
model='/aux/pc244a/jgroh/espectros/agcar/371_narv2.txt'  
...
;making psplots
set_plot,'ps'
device,filename='/aux/pc244a/jgroh/temp/output_opt_2001.eps',/encapsulated,/color,bit=8,xsize=6.48,ysize=8.48,/inches
!p.multi=[0, 1, 3, 0, 0]

;1st panel, 925--1160 Angstrom

plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x1l,x1u],yrange=[0,5.5],xtitle='wavelength (Angstrom)',$
...
if ((sobc[l] ne 'FeV') && (sobc[l] ne 'FeVI')) then begin ;colocando apenas um traco nas transicoes do FeV,normal para os outros.
xyouts,lambdac[l]+2,4.5,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90
endif
if (sobc[l] eq '  FeV') then begin
xyouts,lambdac[l],6,'!3'+string(45B),alignment=0.5,orientation=90
endif
...
plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x2l,x2u],yrange=[0,5.0],xtitle='wavelength (Angstrom)', ytitle='Normalized Flux',/nodata,charsize=2
...
sobc[l]=strmid(sob[l],4,pos)
if ((sobc[l] ne 'FeV') && (sobc[l] ne 'FeVI')) then begin ;colocando apenas um traco nas transicoes do FeV,normal para os outros.
xyouts,lambdac[l]+2,4.3,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90
endif
if (sobc[l] eq 'FeV') then begin
xyouts,lambdac[l],4e,'!3'+string(45B),alignment=0.5,orientation=90
endif
...
plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x3l,x3u],yrange=[0,8.6],xtitle='wavelength (Angstrom)', ytitle='Normalized Flux',/nodata,charsize=2
...
sobc[l]=strmid(sob[l],4,pos)
if ((sobc[l] ne 'FeV') && (sobc[l] ne 'FeVI')) then begin ;colocando apenas um traco nas transicoes do FeV,normal para os outros.
xyouts,lambdac[l]+2,7.0,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90
endif
if (sobc[l] eq 'FeV') then begin
xyouts,lambdac[l],4e,'!3'+string(45B),alignment=0.5,orientation=90
endif

;PRO ZE_ETACAR_CMFGEN_MODEL_CUT_JOHN_COMPARE_MODELS_OPTICAL_FULL_TED_PROPOSAL_HST_2013FEB20
close,/all
...
;CHANGED HERE TO ACTUALLY READ A SPHERICAL MODEL INSTEEAD OF CAVITY MODEL IN lambdamodopt1
ZE_CMFGEN_CREATE_OBSNORM,'/Users/jgroh/ze_models/etacar/mod7_groh/obs/obs_fin','/Users/jgroh/ze_models/etacar/mod7_groh/obscont/obs_fin',lambdamodopt1,fluxmodopt1n,LMIN=1000., LMAX=20000.
...
plots,lambdamodopt1,fluxmodopt1n*1.05,color=colorm1, noclip=0,linestyle=0,thick=b
for l=0., i-1. do begin
...
plots,lambdaobsopt,fluxobsopt,color=coloro, thick=a, noclip=0
plots,lmfull,fmfulln*1.1,color=colorm2, thick=a,noclip=0,linestyle=lm2
...
plots,lambdamodopt1,fluxmodopt1n*1.10,color=colorm1, noclip=0,clip=[x4l,0.5,x4u,7],linestyle=0,thick=b
for l=0., i-1. do begin
...
plots,lambdamodopt1,fluxmodopt1n*1.06,color=colorm1, noclip=0,clip=[x4cl,0.8,x4cu,7],linestyle=0,thick=b
for l=0., i-1. do begin
...
plots,lambdamodopt1,fluxmodopt1n/1.00,color=colorm1, noclip=0,clip=[x5cl,0.5,x5cu,7],linestyle=0,thick=b
for l=0., i-1. do begin

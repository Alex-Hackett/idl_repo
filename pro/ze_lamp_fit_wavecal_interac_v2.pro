...
;
pro ze_lamp_fit_wavecal_interac_v2_event,event
  common lamp_fit_line_common,info,xarray,yarray,lamparray,params_array,fitvalues,rsave,gsave,bsave,xn,yn,xnorm,fnorm
...
pro ze_lamp_fit_wavecal_interac_v2,line_centroids,lampline_ids,ny,xnodes,ynodes,xcen,ycen,lambda_fit_params,lambda_fit_values,tharlineid,lambda_allpix, $
...
;  fnorm = spline(xn,yn,xnorm,info.tension)
  line_norm_plot,info,xarray,yarray,xn,yn
  oplot,xn,yn,color=fsc_color('red'),symsize=1,psym=2,thick=2
  xmanager,'ze_lamp_fit_wavecal_interac_v2',main
...
;  
 ...
 ZE_COMPUTE_LAMBDA_FROM_POLYFIT_PARAMS,ny,lambda_fit_params,lambda_allpix

;PRO ZE_ETACAR_INTERFEROMETRY_VANBOEKEL03_BH05_COMPUTE_OMEGA_INC_CHISQ_V2
;V2 reads files as a function of PA and d
...
;RESTORE, FILENAME='/Users/jgroh/temp/ze_work_etacar_interferometry_results_bh05_'+model2d+'_d'+dstr+'_PA'+pa_str+'_omega_inc.var'
RESTORE, FILENAME='/Users/jgroh/temp/ze_work_etacar_interferometry_results_bh05_'+model2d+'_d'+dstr+'_PA'+pa_str+'_omega_inc_newdata.var'
...
imgname='chisq_image_'+model2d+'_d'+dstr+'_PA'+pa_str
...
imgname='cp_kband_image_'+model2d+'_d'+dstr+'_PA'+pa_str
...
imgname='chi-squared-selected_'+model2d+strcompress(string(thre, format='(I02)'))+'_d'+dstr+'_PA'+pa_str
...
imgname='omega_image_'+model2d+'_d'+dstr+'_PA'+pa_str
...
imgname='inc_image_'+model2d+'_d'+dstr+'_PA'+pa_str
...
imgname='omega_from_sufix_image_'+model2d+'_d'+dstr+'_PA'+pa_str
...
imgname='inc_from_sufix_image_'+model2d+'_d'+dstr+'_PA'+pa_str
...
LOADCT,42
data=chisq_imaget
SHADE_SURF, data, Shades=BYTSCL(data),charsize=2
END
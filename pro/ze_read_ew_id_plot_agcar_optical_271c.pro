...
;2nd panel
max2=12
plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x2l,x2u],yrange=[-1,max2],xtitle='wavelength (Angstrom)', ytitle='Normalized Flux',/nodata,charsize=2
plots,lambdafuse,fluxfuse,color=fsc_color('black'),noclip=0,clip=[x2l,-1,x2u,max2]
plots,lambdamod,fluxmod,color=fsc_color('red'), noclip=0,clip=[x2l,-1,x2u,max2],linestyle=1,thick=3.5
for l=0, i-1 do begin
if (lambdac[l] gt x2l) and (lambdac[l] lt x2u) and (abs(ew[l]) gt 0.30) then begin
pos=strpos(strtrim(sob[l],1),'(')
sobc[l]=strmid(sob[l],4,pos)
if ((sobc[l] ne 'NII') && (sobc[l] ne 'HI')) then begin ;colocando apenas um traco nas transicoes do FeV,normal para os outros.
xyouts,lambdac[l]+6,max2-2.9,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90
endif
if (sobc[l] eq 'NII') then begin
...
;3rd panel
max3=3.0
plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x3l,x3u],yrange=[0.3,max3],xtitle='wavelength (Angstrom)', ytitle='Normalized Flux',/nodata,charsize=2
plots,lambdafuse,fluxfuse,color=fsc_color('black'), noclip=0,clip=[x3l,0.3,x3u,max3]
plots,lambdamod,fluxmod,color=fsc_color('red'), noclip=0,clip=[x3l,0.3,x3u,max3],linestyle=1,thick=3.5
for l=0, i-1 do begin

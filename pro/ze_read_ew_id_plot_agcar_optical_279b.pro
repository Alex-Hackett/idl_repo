...
obsfuse='/home/groh/espectros/agcar/agc02jul04_36a65n.txt'  
...
;defines model file
model='/home/groh/espectros/agcar/279_narv2.txt'  
...
xyouts,lambdac[l]+4,max1-0.25,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90
endif
...
xyouts,lambdac[l]+4,max2-0.3,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90
endif
if (sobc[l] eq 'NII') then begin
xyouts,lambdac[l]+4,max2-0.8,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90
endif

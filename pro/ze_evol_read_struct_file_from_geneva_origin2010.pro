PRO ZE_EVOL_READ_STRUCT_FILE_FROM_GENEVA_ORIGIN2010,modeldir,model_name,timestep,data_structfile,header_structfile,modnb,age,mtot,nbshell,deltat,ncolumns,logteff,compress=compress

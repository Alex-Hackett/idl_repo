...
;temporary 28.07,2010 with Mairan to output centroid values
center_column=center
;subtract or divide by the continuum value?
FOR I=0, sizespat -1 DO dataa2[*,i]=dataa2[*,i]/dataa2[norm_line_val,i]
;FOR I=0, sizespat -1 DO dataa2[*,i]=dataa2[*,i]-dataa2[norm_line_val,i]
...
keywords.filename='/Users/jgroh/temp/etc_crires'+gratdet+'.eps'

;PRO ZE_EVOL_ANALYZE_WGFILE_generic_for_SN_progenitors
...
ZE_EVOL_OBTAIN_VARIABLE_FROM_WGFILE_CUT,'rapomm',data_wgfile_cut,rapomm60,index_varnamex_wgfile,return_valx
...
timesteps=[0,750,1500,2250,3000,3500,3800,4150,4700,5000,5100,5350,5820,6250,6551,6870,7201,8201,10131,11201,12551,14951,18950.,21950.,22251,22271,22532,23950,29446,(size(data_wgfile_cut))[2]-1]
...
ZE_EVOL_PLOT_XY_GENERAL_EPS_V2,xte60,xl60,'xte','xl',label,z1=xmdot60,pointsx2=alog10(tstar_array),pointsy2=alog10(lstar_array),labelz='xmdot',$
                              minz=-6,maxz=-3,rebin=1,xreverse=1,_EXTRA=extra,timesteps=timesteps;,YRANGE=[5.7,7.0],xrange=[5.45,3.75]                              
...
ZE_EVOL_PLOT_XY_GENERAL_EPS_V2,xte60,xl60,'xte','xl',label,xreverse=1,_EXTRA=extra,YRANGE=[5.4,7.0],xrange=[5.45,3.75]      

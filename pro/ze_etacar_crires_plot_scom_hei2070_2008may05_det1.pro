...
!P.CHARSIZE=0
!P.CHARTHICK=0
dirsci='/Users/jgroh/data/eso_vlt/crires/Etacar/381D-0262A_C01/310720/sci_proc/'
dircal='/Users/jgroh/data/eso_vlt/crires/Etacar/381D-0262A_C01/310719/cal_proc/'

scoma=dirsci+'CR_SCOM_310720_2008-05-04T23:51:56.388_DIT1_2076.6nm.fits'
 
;swmpa=dirscigroh+'crires_spec_jitter_wlmap_0002.fits'
swmpa=dirsci+'CR_SWMA_310720_2008-05-04T23:51:56.388_DIT1_2076.6nm.fits' ;SWMA files look better

cal2070=dircal+'CR_PEXT_080504A_DIT30_2076.6nm.fits'
...
star=249  ;(for HeI  2070 detector 1,2
;star=247 ; detector 3
...
for i=0, (size(dataa2))[2] - 1 do begin
norm_line_val=MEAN(dataa2[norm_sect[0]:norm_sect[1],i])
...
restore,'/Users/jgroh/espectros/etc_poly_wavecal_2070_det2_line_auto_tel.sav'
polycal_tel=dblarr(3)
polycal_tel[0]=yfit[0]
polycal_tel[1]=yfit[1]
polycal_tel[2]=yfit[2]
for i=0., sizespat - 1 do begin
restore,'/Users/jgroh/espectros/etc_poly_wavecal_2070_det2_line_auto_'+strcompress(string(i, format='(I02)'))+'.sav'
...
print,scl
;v=1.0
;fluxteli=ZE_SHIFT_SPECTRA_VEL(lambda_newcal,fluxtel,v)
fluxteli=cnvlgauss(fluxteli,fwhm=fwhm)
fluxteli_2d[*,i]=fluxteli
;dataa2[*,i]=cnvlgauss(dataa2[*,i],fwhm=fwhm)
dataa2[*,i]=dataa2[*,i]/(((fluxteli-1.)*scl)+1)
;dataa2[*,i]=dataa2[*,i]/dataa2[norm_col,i]
endfor
...
nd=2
colorbar_ticknames_str = [number_formatter(0.00,decimals=nd), number_formatter(b*.2,decimals=nd), number_formatter(b*.4,decimals=nd),$
number_formatter(b*.6,decimals=nd), number_formatter(b*.8,decimals=nd),number_formatter(b,decimals=nd)]
...
plot,ZE_LAMBDA_TO_VEL(swmpa2[*,row]*10.,lambda0*10000.),dataa2[*,row]/dataa2[900,row],xstyle=1,ystyle=1,$
xrange=[MIN(ZE_LAMBDA_TO_VEL(swmpa2[*,row]*10.,lambda0*10000.)),MAX(ZE_LAMBDA_TO_VEL(swmpa2[*,row]*10.,lambda0*10000.))], xtitle='velocity [km/s]',ytitle='F/Fc',$
...
;xyouts,420/aa,870/bb,TEXTOIDL('PA=325^o'),/NORMAL,color=fsc_color('black')
;
;save,/variables,FILENAME='/Users/jgroh/espectros/etc_2070_det2_allvar.sav'
END

;PRO ZE_ETACAR_CRIRES_PLOT_SCOM_2009JAN07_V3,scoma,swmpa,cal2070
...
scoma=dirsci+'CR_SCOM_200182818_2009-01-08T06_42_37.035_DIT1_1087.3nm.fits'
swmpa=dirsci+'CR_SWMP_200182818_2009-01-08T06_42_37.035_DIT1_1087.3nm.fits' ;SWMA files look better
...
swmpa=dirsci+'CR_SCOM_200182818_2009-01-08T07_20_38.529_DIT1_1090.4nm.fits' ;SWMA files look better
cal2070=dircal+'CR_PEXT_090107A_DIT30_1087.3nm.fits'
    END
...
;ZE_SELECT_NORM_SECTION,index,dataa2,row,norm_sect=norm_sect
...
;ZE_WAVECAL_1D_SPEC_V5,index,swmpa2,dataa2,f2canorm,row,grat_angle,det,minrow,numberrows
ZE_WAVECAL_1D_SPEC_V6,index,swmpa2,dataa2,f2canorm,row,grat_angle,det,minrow,numberrows,lkpno,fkpno,read_kpno=0,build_tel_list=0, create_ident_plot=0,build_templ=0,$
...
;fluxteli=ZE_SHIFT_SPECTRA_VEL(lambda_newcalt,fluxteli,0.24)

;PRO ZE_ETACAR_CMFGEN_MODEL_CUT_JOHN_COMPARE_SED
...
filename1='OBSFRAME1'
ZE_CMFGEN_READ_OBS_2D,filename1,dir+model1+'/'+sufix1+'/',lmuv,fmuv,nm1,/FLAM
...
sufix1='m15_uv2'
ZE_CMFGEN_READ_OBS_2D,filename1,dir+model1+'/'+sufix1+'/',lmuv2,fmuv2,nm1,/FLAM

sufix1='m15_uv3'
ZE_CMFGEN_READ_OBS_2D,filename1,dir+model1+'/'+sufix1+'/',lmuv3,fmuv3,nm1,/FLAM

sufix1='m15_ir'
ZE_CMFGEN_READ_OBS_2D,filename1,dir+model1+'/'+sufix1+'/',lmir,fmir,nm1,/FLAM
...
ZE_SPEC_CNVL,lmuv3,fmuv3,res,lambda_val,fluxcnvl=fmuv3conv
...
ymin=2e-11
plot,lmfull,fmfull/dist^2,xstyle=1,ystyle=1,xrange=[x1l-2,x1u+2],yrange=[ymin,1.5e-7/dist^2],/ylog,/xlog,xcharsize=2.0,ycharsize=2.0,thick=3.5,xthick=3.5,ythick=3.5,$
/nodata,POSITION=[0.08,0.13,0.97,0.99]
;plots,lambda_23mar00_e140m,flux_23mar00_e140mdereddencnvl,linestyle=0,noclip=0,thick=b+3.5,color=coloro
;plots,lambda_17apr01,flux_17apr01dereddencnvl,linestyle=0,noclip=0,thick=b+3.5,color=coloro
plots,lmfull,fmfullconv/dist^2,color=colorm2,linestyle=0,noclip=0,clip=[x1l,ymin,x1u,10],thick=b+3.5
plots,lmuv,fmuvconv/dist^2,color=colorm1,linestyle=0,noclip=0,clip=[x1l,ymin,x1u,10],thick=b+3.5
plots,lmuv2,fmuv2conv/dist^2,color=colorm1,linestyle=0,noclip=0,clip=[x1l,ymin,x1u,10],thick=b+3.5
plots,lmuv3,fmuv3conv/dist^2,color=colorm1,linestyle=0,noclip=0,clip=[x1l,ymin,x1u,10],thick=b+3.5
plots,lmopt,fmoptconv/dist^2,color=colorm1,linestyle=0,noclip=0,clip=[x1l,ymin,x1u,35],thick=b+3.5
plots,lmir,fmirconv/dist^2,color=colorm1,linestyle=0,noclip=0,clip=[x1l,ymin,x1u,35],thick=b+3.5
plots,lc1,fc1conv/dist^2,color=colorm4,linestyle=0,noclip=0,clip=[x1l,ymin,x1u,35],thick=b+3.5
xyouts,400,3000,'Normalized Flux',charthick=3.5,orientation=90,/DEVICE

PRO ZE_ETACAR_CMFGEN_VINF_MODEL44_GROH
close,/all
...
/nodata;,POSITION=[0.11,0.72,0.99,0.99]
plots,ZE_LAMBDA_TO_VEL(lambdaobs,lambda0)+8.,fluxobs/s,color=coloro,noclip=0,thick=a
plots,ZE_LAMBDA_TO_VEL(lmfull,lambda0),fmfulld23r/s/scale_full*1.93,color=colorm2,linestyle=lm, noclip=0,thick=b+1.5
plots,ZE_LAMBDA_TO_VEL(lambdamod2,lambda0),fluxmod2d23r/s/scale_full*1.93*1.0859,color=colorm,linestyle=lm2, noclip=0,thick=b+1.5
...
plots,ZE_LAMBDA_TO_VEL(lambdamod2,lambda0),fluxmod2d23r/s/scale_full*2.28*1.08549,color=colorm,linestyle=lm2, noclip=0,thick=b+1.5
...
plots,ZE_LAMBDA_TO_VEL(lambdamod2,lambda0),fluxmod2d23r/s/scale_full*5.86165,color=colorm,linestyle=lm2, noclip=0,thick=b+1.5

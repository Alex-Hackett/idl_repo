...
f372dcnvl=((f372ecnvl-1.0)*2.2) +1.0
f372ecnvl=((f372ecnvl-1.0)*2.2) +1.0
...
plots,l3722de,f372ecnvl,color=fsc_color('green'), noclip=0,clip=[x1l,0,x1u,13],linestyle=0,thick=1

PRO ZE_WORK_BOREHOLE_TO_TOM_INTEGRATE_ALONG_Y_v2
...
;artificially add narrow gaussians to simulate emission 'spikes' in the image
fwhm_spike_vel=10. ;in km/s
fwhm_spike_spat=15. ;in mas
peak_intens_spike=10*max(onedimage)
spike=peak_intens_spike*PSF_GAUSSIAN(NPIXEL=[dimy,nx],FWHM=[fwhm_spike_Vel/pixscale_vel,fwhm_spike_spat/pixscale_x],/NORMAL,/DOUBLE)
onedimage=onedimage+spike

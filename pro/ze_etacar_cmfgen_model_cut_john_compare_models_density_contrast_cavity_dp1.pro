;PRO ZE_ETACAR_CMFGEN_MODEL_CUT_JOHN_COMPARE_MODELS_DENSITY_CONTRAST_CAVITY_DP1
close,/all
...
model1='cut_v4_var_DP1'   
sufix1='1em6'
extra_label1=TEXTOIDL(',b=1.0e^{-6}')
filename1='OBSFRAME1'
...
model2='cut_v4_var_DP1'  
sufix2='1d6em3'
extra_label2=TEXTOIDL(',b=1.6e^{-3}')
filename2='OBSFRAME1'
...
model3='cut_v4_var_DP1'   ;b,c,o,r,t,u,v don't cover the UV range
sufix3='5d12em2'
extra_label3=TEXTOIDL(',b=5.12e^{-2}')
filename3='OBSFRAME1'
...
model4='cut_v4_var_DP1'   ;b,c,o,r,t,u,v don't cover the UV range
sufix4='1d02em1'
extra_label4=TEXTOIDL(',b=1.02e^{-1}')
filename4='OBSFRAME1'
...
model5='cut_v4_var_DP1'   ;b,c,o,r,t,u,v don't cover the UV range
sufix5='1e0'
extra_label5=TEXTOIDL(',b=1.0')
filename5='OBSFRAME1'
...
device,filename='/Users/jgroh/temp/etc_cmfgen_mod111_plus_cavity_compare_models_uv_density_contrast_cavity_'+model1+'_'+sufix1+'_'+filename1+'_i'+inc_str1+model2+'_'+sufix2+'_'+filename2+'_i'+inc_str2+'.eps',/encapsulated,/color,bit=8,xsize=8.48,ysize=3.48,/inches
...
device,filename='/Users/jgroh/temp/etc_cmfgen_mod111_plus_cavity_compare_models_halpha_emiss_density_contrast_cavity_'+model1+'_'+sufix1+'_'+filename1+'_i'+inc_str1+model2+'_'+sufix2+'_'+filename2+'_i'+inc_str2+'.eps',/encapsulated,/color,bit=8,xsize=8.48,ysize=3.48,/inches
...
device,filename='/Users/jgroh/temp/etc_cmfgen_mod111_plus_cavity_compare_models_halpha_abs_density_contrast_cavity_'+model1+'_'+sufix1+'_'+filename1+'_i'+inc_str1+model2+'_'+sufix2+'_'+filename2+'_i'+inc_str2+'.eps',/encapsulated,/color,bit=8,xsize=8.48,ysize=3.48,/inches
colorm=fsc_color('blue')
!X.thick=3.7
!Y.thick=3.7
!p.charthick=3.5

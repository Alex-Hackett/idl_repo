PRO ZE_CMFGEN_REV_RVSIG,rvsig_col_file,option,r,v,sigma,nd
...
READCOL,rvsig_col_file,OLD_R,OLD_V,OLD_SIGMA,OLD_DEPTH,COMMENT='!',F='D,D'
...
'NEW_ND': BEGIN
    ...
    v=dblarr(ND) & R=dblarr(ND) & sigma=dblarr(ND) & X1=DBLARR(ND) & X2=DBLARR(ND)

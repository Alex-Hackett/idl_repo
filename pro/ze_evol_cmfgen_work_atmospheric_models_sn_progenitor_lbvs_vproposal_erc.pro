PRO ZE_EVOL_CMFGEN_WORK_ATMOSPHERIC_MODELS_SN_PROGENITOR_LBVs_VPROPOSAL_ERC
...
;rebinning data
ze_evol_rebin_xyz,l11,f11,l11r,f11r,factor=20.0
ze_evol_rebin_xyz,l13,f13,l13r,f13r,factor=20.0
...
ZE_CMFGEN_PLOT_SPECTRA_GENERAL_STACKED_EPS_FOR_LBV_SN_PROGENITOR_PAPER_VPROPOSAL_ERC,l13r,f13r+6,'Wavelength (Angstrom)', 'Normalized Flux','',x4=l02julr,y4=f02julr-4,xrange=[4200,6060],yrange=[0,15],id_lambda=lambdac,id_text=sob,id_ew=ew

FUNCTION ZE_EVOL_COMPUTE_NUMBER_FRACTION_REL_HYD_12,mass_frac,hyd_mass_frac,element,numfrac
...
'Fe': atomwei=55.845
ENDCASE
numfrac=(12 + alog10(mass_frac/hyd_mass_frac/atomwei*hyd_atom_wei))

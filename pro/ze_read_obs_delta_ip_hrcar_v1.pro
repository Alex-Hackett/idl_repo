...
model='M1'
dir='/Users/jgroh/ze_models/2D_models/hrcar/'
dir='/Users/jgroh/ze_models/2D_models/NT32500_logg400/'
model='6'
model2d='200sph'
model='350s'
model2d=''
...
pa=108.          ;position angle in degrees; by definition PA=0 towards N, and increase eastwards. USE PA significantly different than 0 (e.g.50) for spherical models
;pa=227
pa_str=strcompress(string(pa, format='(I03)'))

;grep inclination angle info from OBS_INP
spawn,'grep ANG1 '+dir+model+'/'+model2d+'/OBS_INP' ,result,/sh
...
PA_obs_hd316_at_25mar11=[29.58, -72.6300, 262.100] ;in degress
...
lambda0=21126016    ; Br gamma
lambda_ini=21100.   ;initial lambda to do calculations 21610
lambda_fin=21130.    ;initial lambda to do calculations 21720
;lambda_ini=4084.0   ;initial lambda to do calculations 21610
;lambda_fin=4096.0    ;initial lambda to do calculations 21720
;
;filterwidth=200 ;in Angstroms
;lambda_ini=lambda0-filterwidth/2
;lambda_fin=lambda0+filterwidth/2

lambda_sampling=0.85     ;sampling in Angstrom ; use 1

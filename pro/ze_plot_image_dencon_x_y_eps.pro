PRO ZE_PLOT_IMAGE_DENCON_X_Y_EPS,img,a,b,imgname,rstar,dist,pa,inc_str,lambda_val,lambda0,lambda,np,ndelta1,nos,ipdelta,p,delta1_vec,x,y,intens2d_lambda,$

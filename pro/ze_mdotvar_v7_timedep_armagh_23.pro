;PRO ZE_MDOTVAR_V7_TIMEDEP_ARMAGH_23
;based on model 22
...
READCOL,'/Users/jgroh/ze_models/timedep_armagh/'+modelout+'/RVSIG_COL_SCLR_790',r1,v1,sigma1,depth1,COMMENT='!'

;r and v values of model 2
READCOL,'/Users/jgroh/ze_models/timedep_armagh/'+modelout+'/RVSIG_COL_SCLR_790',r2,v2,sigma2,depth2,COMMENT='!'
...
rrev[i2+1:i3]=r22[i2+1:i3]
vrev[i2+1:i3]=v22[i2+1:i3]
;

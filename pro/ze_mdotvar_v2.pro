...
close,2
den2=2.5*den2 ;re-scaling to increase Mdot by a factor of 2.5
...
;rvdenclump1.txt, which MAY BE NOT TRUE IF MODEL 1 is ALSO TIME-DEPENDENT! MAYBE IT'S RIGHT
; because we are interested in vinf(r), not in vinf(t).
...
plot,alog10(rout),v1,psym=1,symsize=1.5
plots,alog10(r2),v2,color=255,psym=2,symsize=1.5
;plots,alog10(rout),vorig,color=255,psym=5,symsize=1.5
...
;testing some interpolations
;t=[0,deltat]
;ya=[v1[0],v2[0]]
;results=POLY_FIT(t,ya,2,yfit=yfit)
;plot,t,yfit,color=255

;defines file VM_FILE ;
vmfile='/home/groh/var_mdot/var_191_regrid_223_mdot5_var222_2/VM_FILE'  
...
printf,5,'!**********************************************************************'
printf,5,'!'
printf,5,'! VM_FILE created by ZE_MDOTVAR_V2.PRO (IDL)'
printf,5,'!'
printf,5,'! Delta is either /\V or /\Tau (see type column)' 
printf,5,'!'
printf,5,'! Rstar (10^10 cm) = ',rout[i-1]  
printf,5,'! Rmax/ Rstar =   ',(rout[0]/rout[i-1])
printf,5,'!'
printf,5,'!**********************************************************************'
printf,5,'!**********************************************************************'
printf,5,'!'
...
printf,5,'!'
printf,5,i,'  !Number of depth points'
for k=0, i-1 do begin
...
rvsig='/home/groh/var_mdot/var_191_regrid_223_mdot5_var222_2/RVSIG_COL'  
...
printf,6,'!**********************************************************************'
printf,6,'!'
printf,6,'! RVSIG_COL created by ZE_MDOTVAR_V2.PRO (IDL)'
printf,6,'!'
printf,6,'! Delta is either /\V or /\Tau (see type column)' 
printf,6,'!'
printf,6,'! Rstar (10^10 cm) = ',rout[i-1]  
printf,6,'! Rmax/ Rstar =   ',(rout[0]/rout[i-1])
printf,6,'!'
printf,6,'!**********************************************************************'
printf,6,'!**********************************************************************'
printf,6,'!'
...
printf,6,'!'
printf,6,i,'  !Number of depth points'

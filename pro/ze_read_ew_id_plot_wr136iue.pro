...
obsfuse='/home/groh/espectros/wr136/wr136_iue_merge_all.txt'  
openu,2,obsfuse     ; open file without writing

;defines model continuum file
modelc='/home/groh/espectros/wr136/wr136_18_car'  
...
if (lambdac[l] gt 1170) and (lambdac[l] lt 3280) and (abs(ew[l]) gt 5.00) then begin
...
plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x1l,x1u],yrange=[0,6.3e-11],xtitle='wavelength (Angstrom)',$
ytitle='Flux (erg/s/cm^2/Angstrom)'
plots,lambdamod,0.55*fluxmodescd,color=255, noclip=0,clip=[x1l,0,x1u,6.3e-11]
plots,lambdacont,(0.55*fluxcontescd+0.0e-11),color=255, noclip=0,clip=[x1l,0,x1u,6.3e-11],linestyle=2
for l=0, i-1 do begin
if (lambdac[l] gt x1l) and (lambdac[l] lt x1u) and (abs(ew[l]) gt 5.0) then begin
...
xyouts,lambdac[l],58.0e-12,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90
endif
...
plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x2l,x2u],yrange=[0,2.1e-10],xtitle='wavelength (Angstrom)', ytitle='Flux (erg/s/cm^2/Angstrom)'
plots,lambdamod,0.61*fluxmodescd,color=255, noclip=0,clip=[x2l,0,x2u,2.1e-10]
for l=0, i-1 do begin
if (lambdac[l] gt x2l) and (lambdac[l] lt x2u) and (abs(ew[l]) gt 2.00) then begin
pos=strpos(strtrim(sob[l],1),'(')
sobc[l]=strmid(sob[l],2,pos+2)
if ((sobc[l] ne '  FeV') && (sobc[l] ne '  FeVI')) then begin ;colocando apenas um traco nas transicoes do FeV,normal para os outros.
xyouts,lambdac[l],1.8e-10,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90
endif
if (sobc[l] eq '  FeV') then begin
...
plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x3l,x3u],yrange=[0,3.6e-11],xtitle='wavelength (Angstrom)', ytitle='Flux (erg/s/cm^2/Angstrom)'
plots,lambdamod,0.66*fluxmodescd,color=255, noclip=0,clip=[x3l,0,x3u,3.6e-11]
for l=0, i-1 do begin
if (lambdac[l] gt x3l) and (lambdac[l] lt x3u) and (abs(ew[l]) gt 2.00) then begin
pos=strpos(strtrim(sob[l],1),'(')
sobc[l]=strmid(sob[l],2,pos+2)
if ((sobc[l] ne '  FeV') && (sobc[l] ne '  FeVI')) then begin ;colocando apenas um traco nas transicoes do FeV,normal para os outros.
xyouts,lambdac[l],3.0e-11,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90
endif
if (sobc[l] eq '  FeV') then begin
...
;making psplots
set_plot,'ps'
device,filename='/home/groh/espectros/wr136/output_iue.eps',/encapsulated,/color,bit=8,xsize=8.48,ysize=6.48,/inches
!p.multi=[0, 1, 3, 0, 0]

;1st panel, 925--1160 Angstrom
plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x1l,x1u],yrange=[0,8.4e-11],xtitle='wavelength (!3'+string(197B)+')',$
...
plots,lambdamod,0.55*fluxmodescd,color=fsc_color('black'), noclip=0,clip=[x1l,0,x1u,6.9e-11],thick=3
plots,lambdacont,(0.55*fluxcontescd+0.0e-11),color=fsc_color('red'), noclip=0,clip=[x1l,0,x1u,6.9e-11],linestyle=2
plots,[1319.41,1448.85],[5.3e-11,5.3e-11]
plots,[1228.95,1373.67],[6.0e-11,6.0e-11]
xyouts,1270.0,69.0e-12,'FeVI',alignment=0.5,orientation=90
xyouts,1425.0,62.0e-12,'FeV',alignment=0.5,orientation=90
for l=0, i-1 do begin
if (lambdac[l] gt x1l) and (lambdac[l] lt x1u) and (abs(ew[l]) gt 5.0) then begin
pos=strpos(strtrim(sob[l],1),'(')
sobc[l]=strmid(sob[l],4,pos+0)
if ((sobc[l] ne 'FeV') && (sobc[l] ne 'FeVI')) then begin ;colocando apenas um traco nas transicoes do FeV,normal para os outros.
xyouts,lambdac[l],72.0e-12,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90
endif
if (sobc[l] eq 'FeV') then begin
xyouts,lambdac[l],51.0e-12,'!3'+string(45B),alignment=0.5,orientation=90
endif
if(sobc[l] eq 'FeVI') then begin
xyouts,lambdac[l],58.0e-12,'!3'+string(45B),alignment=0.5,orientation=90
endif
endif
endfor

;2nd panel
plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x2l,x2u],yrange=[0,2.9e-10],xtitle='wavelength (Angstrom)', ytitle='Flux (erg/s/cm^2/Angstrom)',charsize=1.5,charthick=2,/nodata
plots,lambdafuse,fluxfuse,noclip=0,clip=[x2l,0,x2u,2.4e-10],color=fsc_color('grey')
plots,lambdamod,0.53*fluxmodescd,color=fsc_color('black'), noclip=0,clip=[x2l,0,x2u,2.4e-10],thick=3
plots,lambdacont,(0.53*fluxcontescd+0.0e-11),color=fsc_color('red'), noclip=0,clip=[x2l,0,x2u,2.4e-10],linestyle=2
plots,[1452.6,1624.07],[1.29e-10,1.29e-10]
xyouts,1530.0,1.7e-10,'FeV',alignment=0.5,orientation=90
plots,[1652.93,1674.83],[1.29e-10,1.29e-10]
xyouts,1665.0,1.7e-10,'FeV',alignment=0.5,orientation=90
for l=0, i-1 do begin
if (lambdac[l] gt x2l) and (lambdac[l] lt x2u) and (abs(ew[l]) gt 2.00) then begin
pos=strpos(strtrim(sob[l],1),'(')
sobc[l]=strmid(sob[l],4,pos+0)
if ((sobc[l] ne 'FeV') && (sobc[l] ne 'FeVI')) then begin ;colocando apenas um traco nas transicoes do FeV,normal para os outros.
xyouts,lambdac[l],2.3e-10,'!3'+string(45B)+sobc[l],alignment=0.5,orientation=90
endif
if (sobc[l] eq 'FeV') then begin
print,lambdac[l],sobc[l]
xyouts,lambdac[l],1.2e-10,'!3'+string(45B),alignment=0.5,orientation=90
...
;3rd panel, lwp
plot,lambdafuse,fluxfuse,xstyle=1,ystyle=1,xrange=[x3l,x3u],yrange=[0,3.8e-11],charsize=1.5,charthick=2,xtitle='wavelength (Angstrom)', ytitle='Flux (erg/s/cm^2/Angstrom)',/nodata
plots,lambdafuse,fluxfuse,noclip=0,clip=[x3l,0,x3u,3.6e-11],color=fsc_color('grey')
plots,lambdamod,0.66*fluxmodescd,color=fsc_color('black'), noclip=0,clip=[x3l,0,x3u,3.6e-11],thick=3

...
lambda_ini=21835.  ;initial lambda to do calculations 21610
lambda_fin=22200.    ;initial lambda to do calculations 21720

;filterwidth=200 ;in Angstroms
;lambda_ini=lambda0-filterwidth/2
;lambda_fin=lambda0+filterwidth/2

lambda_sampling=3.8     ;sampling in Angstrom ; use 1
...
plot,lambda_vector,vis_triplet_wavelength_cnvl[0,*],yrange=[0.7,1.02],XTITLE='Heliocentric vacuum wavelength (Angstrom)', YTITLE='Visibility',$

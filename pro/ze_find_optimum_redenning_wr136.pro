...
;le fits
flux=mrdfits('/home/groh/espectros/agcar/244_car.fits',0,header)
...
for minusebv=-0.50, -0.90, -0.01 do begin
...
mwrfits,flux6dfin,'/home/groh/espectros/agcar/244_car6r34ebv65.fits',header

; plot spectrum
window,0,xsize=600,ysize=600,retain=2
plot,alog10(lambda),alog10(flux6dfin),yrange=[-14,-10],xtitle='wavelength (Angstrom)', ytitle='Flux (erg/s/cm^2/Angstrom)'
